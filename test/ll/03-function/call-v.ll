...
8:
  ...
  %18 = call i8 addrspace(1)* @_bal_tagged_clear_exact_ptr(i8 addrspace(1)* %17), !dbg !19
...
8:
  ...
  %18 = call i8 addrspace(1)* @_bal_tagged_clear_exact_ptr(i8 addrspace(1)* %17), !dbg !23
...
!22 = !DILocation(line: 19, column: 10, scope: !9)
