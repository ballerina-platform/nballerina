...
@.mapping1 = internal constant {i32, i32, i64, {i32}*, [0 x i64]} {i32 1, i32 0, i64 ptrtoint({i32, i32, [1 x %UniformSubtype*]}* @.member1 to i64), {i32}* bitcast({i32, i32, i64, {i32}*, [0 x i64]}* @.mapping2 to {i32}*), [0 x i64] []}
...
@.mapping2 = internal constant {i32, i32, i64, {i32}*, [0 x i64]} {i32 2, i32 0, i64 257, {i32}* null, [0 x i64] []}
