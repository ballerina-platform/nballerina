...
%Type1 = type {ptr, i32}
%FillerDesc = type {ptr}
@_Bi04root0 = constant {i32, i32, i64, ptr, [0 x i64]} {i32 0, i32 0, i64 ptrtoint(ptr @.member0 to i64), ptr bitcast(ptr @.fillerDesc2 to ptr), [0 x i64] []}
...
@.mapping1 = constant {i32, i32, i64, ptr, [0 x i64]} {i32 1, i32 0, i64 ptrtoint(ptr @.member1 to i64), ptr bitcast(ptr @.fillerDesc1 to ptr), [0 x i64] []}
@.subtype1 = internal constant %Type1 {ptr @_bal_map_subtype_contains, i32 4}, align 8
@.member1 = internal constant {i32, i32, [1 x ptr]} {i32 0, i32 8192, [1 x ptr] [ptr bitcast(ptr @.subtype1 to ptr)]}
@.mapping2 = constant {i32, i32, i64, ptr, [0 x i64]} {i32 2, i32 0, i64 9, ptr bitcast(ptr @_bal_int_zero_filler_desc to ptr), [0 x i64] []}
@_bal_int_zero_filler_desc = external global %FillerDesc
@.fillerDesc1 = global {ptr, ptr} {ptr @_bal_mapping_filler_create, ptr bitcast(ptr @.mapping2 to ptr)}
@.fillerDesc2 = global {ptr, ptr} {ptr @_bal_mapping_filler_create, ptr bitcast(ptr @.mapping1 to ptr)}
