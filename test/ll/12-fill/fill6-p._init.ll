...
@.subtype0 = internal constant %Type0 {ptr @_bal_record_subtype_contains, i32 1, [1 x {ptr addrspace(1), i32}] [{ptr addrspace(1), i32} {ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261432), i32 4}]}, align 8
