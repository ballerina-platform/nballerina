...
%FillerDesc = type {ptr}
@_Bi04root0 = constant {i32, i32, i64, ptr, [0 x i64]} {i32 0, i32 0, i64 ptrtoint(ptr @.member0 to i64), ptr null, [0 x i64] []}
...
@_Bi04root1 = constant {i32, i32, i64, ptr, [1 x i64]} {i32 1, i32 1, i64 1, ptr null, [1 x i64] [i64 9]}
