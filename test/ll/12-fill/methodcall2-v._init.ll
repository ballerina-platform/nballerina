...
@_Bi04root1 = constant {i32, i32, i64, {i32}*, [1 x i64]} {i32 0, i32 1, i64 1, {i32}* null, [1 x i64] [i64 ptrtoint({i32, i32, [1 x %UniformSubtype*]}* @.member0 to i64)]}
...
@_Bi04root2 = constant {i32, i32, i64, {i32}*, [1 x i64]} {i32 1, i32 1, i64 1, {i32}* null, [1 x i64] [i64 ptrtoint({i32, i32, [1 x %UniformSubtype*]}* @.member1 to i64)]}
...
@_Bi04root3 = constant {i32, i32, i64, {i32}*, [1 x i64]} {i32 2, i32 1, i64 1, {i32}* null, [1 x i64] [i64 ptrtoint({i32, i32, [1 x %UniformSubtype*]}* @.member2 to i64)]}
...
@.member2 = internal constant {i32, i32, [1 x %UniformSubtype*]} {i32 0, i32 524288, [1 x %UniformSubtype*] [%UniformSubtype* bitcast(%Type2* @.subtype2 to %UniformSubtype*)]}
