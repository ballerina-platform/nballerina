...
@.mapping1 = constant {i32, i32, i64, ptr, [0 x i64]} {i32 1, i32 0, i64 9, ptr bitcast(ptr @_bal_int_zero_filler_desc to ptr), [0 x i64] []}
@_bal_int_zero_filler_desc = external global %FillerDesc
@.fillerDesc1 = global {ptr, ptr} {ptr @_bal_mapping_filler_create, ptr bitcast(ptr @.mapping1 to ptr)}
