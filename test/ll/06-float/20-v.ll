...
50:
  %51 = call double @_B_floatMul(double 3.0, double 2.0), !dbg !10
  ...
  %54 = call double @_B_floatMul(double 1.0, double 0.0), !dbg !12
  ...
  %57 = call double @_B_floatMul(double 0.0, double -1.0), !dbg !14
  ...
  %60 = call double @_B_floatMul(double 0.0, double -0.0), !dbg !16
  ...
  %64 = call double @_B_floatMul(double %63, double 1.0), !dbg !18
  ...
  %69 = call double @_B_floatMul(double %67, double %68), !dbg !20
  ...
  %73 = call double @_B_floatMul(double %72, double 20.0), !dbg !22
  ...
  %78 = call double @_B_floatMul(double %76, double %77), !dbg !24
  ...
  %82 = call double @_B_floatMul(double %81, double 0.0), !dbg !26
  ...
  %85 = call i8 addrspace(1)* @_bal_float_to_tagged(double 6.0), !dbg !28
  ...
  store double 0xFFF0000000000000, double* %36
