...
58:
  ...
  %71 = call double @_B_floatMul(double 1.0, double 0.0), !dbg !15
  ...
  %83 = call double @_B_floatMul(double 0.0, double -1.0), !dbg !19
  ...
  %171 = call ptr addrspace(1) @_bal_float_to_tagged(double 6.0), !dbg !48
  ...
  %241 = call ptr addrspace(1) @_bal_float_to_tagged(double 0xFFF0000000000000), !dbg !69
  ...
  %251 = call ptr addrspace(1) @_bal_float_to_tagged(double 0x7FF8000000000000), !dbg !72
