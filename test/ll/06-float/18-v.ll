...
57:
  %58 = call double @_B_floatAdd(double 1.0, double 2.0), !dbg !10
  ...
  %61 = call double @_B_floatAdd(double -1.0, double 1.0), !dbg !12
  ...
  %64 = call double @_B_floatAdd(double -0.0, double -0.0), !dbg !14
  ...
  %67 = call double @_B_floatAdd(double -0.0, double 0.0), !dbg !16
  ...
  %71 = call double @_B_floatAdd(double %70, double 1.0), !dbg !18
  ...
  %76 = call double @_B_floatAdd(double %74, double %75), !dbg !20
  ...
  %80 = call double @_B_floatAdd(double %79, double 20.0), !dbg !22
  ...
  %85 = call double @_B_floatAdd(double %83, double %84), !dbg !24
  ...
  %89 = call double @_B_floatAdd(double %88, double 100.0), !dbg !26
  ...
  %92 = call i8 addrspace(1)* @_bal_float_to_tagged(double 3.0), !dbg !28
  ...
  %101 = load double, double* %34
  %102 = fadd double %100, %101
  store double %102, double* %35
  %103 = load double, double* %35, !dbg !33
  %104 = call i8 addrspace(1)* @_bal_float_to_tagged(double %103), !dbg !33
  call void @_Bb02ioprintln(i8 addrspace(1)* %104), !dbg !33
  store i8 addrspace(1)* null, i8 addrspace(1)** %36, !dbg !33
  store double 0x7FF0000000000000, double* %37
  %105 = load double, double* %37
  %106 = fadd double %105, 20.0
  store double %106, double* %38
  %107 = load double, double* %38, !dbg !34
  %108 = call i8 addrspace(1)* @_bal_float_to_tagged(double %107), !dbg !34
  call void @_Bb02ioprintln(i8 addrspace(1)* %108), !dbg !34
  store i8 addrspace(1)* null, i8 addrspace(1)** %39, !dbg !34
  store double 0xFFF0000000000000, double* %40
  store double 0x7FF0000000000000, double* %41
  %109 = load double, double* %40
  %110 = load double, double* %41
  %111 = fadd double %109, %110
  store double %111, double* %42
  %112 = load double, double* %42, !dbg !35
  %113 = call i8 addrspace(1)* @_bal_float_to_tagged(double %112), !dbg !35
  call void @_Bb02ioprintln(i8 addrspace(1)* %113), !dbg !35
  store i8 addrspace(1)* null, i8 addrspace(1)** %43, !dbg !35
  store double 0xFFF0000000000000, double* %44
  %114 = load double, double* %44
  %115 = fadd double %114, 100.0
  store double %115, double* %45
  %116 = load double, double* %45, !dbg !36
  %117 = call i8 addrspace(1)* @_bal_float_to_tagged(double %116), !dbg !36
  call void @_Bb02ioprintln(i8 addrspace(1)* %117), !dbg !36
  store i8 addrspace(1)* null, i8 addrspace(1)** %46, !dbg !36
  store double 4.0, double* %f1
  %118 = load double, double* %f1
  %119 = fadd double 38.0, %118
  store double %119, double* %47
  %120 = load double, double* %47, !dbg !37
  %121 = call i8 addrspace(1)* @_bal_float_to_tagged(double %120), !dbg !37
  call void @_Bb02ioprintln(i8 addrspace(1)* %121), !dbg !37
  store i8 addrspace(1)* null, i8 addrspace(1)** %48, !dbg !37
  store double 38.42, double* %f2
  %122 = load double, double* %f1
  %123 = load double, double* %f2
  %124 = fadd double %122, %123
  store double %124, double* %49
  %125 = load double, double* %49, !dbg !38
  %126 = call i8 addrspace(1)* @_bal_float_to_tagged(double %125), !dbg !38
  call void @_Bb02ioprintln(i8 addrspace(1)* %126), !dbg !38
  store i8 addrspace(1)* null, i8 addrspace(1)** %50, !dbg !38
  store double 0xFFF0000000000000, double* %51
  %127 = load double, double* %51
  store double %127, double* %f2
  %128 = load double, double* %f2
  %129 = fadd double %128, 2.0
  store double %129, double* %52
  %130 = load double, double* %52, !dbg !39
  %131 = call i8 addrspace(1)* @_bal_float_to_tagged(double %130), !dbg !39
  call void @_Bb02ioprintln(i8 addrspace(1)* %131), !dbg !39
  store i8 addrspace(1)* null, i8 addrspace(1)** %53, !dbg !39
  ret void
132:
  %133 = call i8 addrspace(1)* @_bal_panic_construct(i64 1284), !dbg !9
  call void @_bal_panic(i8 addrspace(1)* %133)
  unreachable
}
