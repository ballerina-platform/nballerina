...
58:
  %59 = call double @_B_floatAdd(double 1.0, double 2.0), !dbg !11
  ...
  %71 = call double @_B_floatAdd(double -1.0, double 1.0), !dbg !15
  ...
  %83 = call double @_B_floatAdd(double -0.0, double -0.0), !dbg !19
  ...
  %95 = call double @_B_floatAdd(double -0.0, double 0.0), !dbg !23
  ...
  %107 = call double @_B_floatAdd(double 0x7FF8000000000000, double 1.0), !dbg !27
  ...
  %119 = call double @_B_floatAdd(double 0x7FF8000000000000, double 0x7FF8000000000000), !dbg !31
  ...
  %131 = call double @_B_floatAdd(double 0x7FF0000000000000, double 20.0), !dbg !35
  ...
  %143 = call double @_B_floatAdd(double 0xFFF0000000000000, double 0x7FF0000000000000), !dbg !39
  ...
  %155 = call double @_B_floatAdd(double 0xFFF0000000000000, double 100.0), !dbg !43
  ...
  %171 = call ptr addrspace(1) @_bal_float_to_tagged(double 3.0), !dbg !48
  ...
  %181 = call ptr addrspace(1) @_bal_float_to_tagged(double 0.0), !dbg !51
  ...
  %191 = call ptr addrspace(1) @_bal_float_to_tagged(double -0.0), !dbg !54
  ...
  %201 = call ptr addrspace(1) @_bal_float_to_tagged(double 0.0), !dbg !57
