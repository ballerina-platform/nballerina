...
@_Bi04root1 = constant {i32, i32, i64, ptr, [0 x i64]} {i32 0, i32 0, i64 262015, ptr bitcast(ptr @_bal_nil_filler_desc to ptr), [0 x i64] []}
...
@.subtype0 = internal constant {ptr, i32} {ptr @_bal_array_subtype_contains, i32 131007}, align 8
@_Bt04root0 = constant {i32, i32, [1 x ptr]} {i32 0, i32 4096, [1 x ptr] [ptr bitcast(ptr @.subtype0 to ptr)]}
@.subtype1 = internal constant {ptr, i32} {ptr @_bal_map_subtype_contains, i32 131007}, align 8
@_Bt04root1 = constant {i32, i32, [1 x ptr]} {i32 0, i32 8192, [1 x ptr] [ptr bitcast(ptr @.subtype1 to ptr)]}
