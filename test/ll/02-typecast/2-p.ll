...
9:
  %10 = call i8 addrspace(1)* @_B_ifElse(i1 1, i1 1, i64 17), !dbg !10
...
define internal i8 addrspace(1)* @_B_ifElse(i1 %0, i1 %1, i64 %2) !dbg !7 {
  %t = alloca i1
  %b = alloca i1
  %n = alloca i64
  %4 = alloca i8
...
17:
  %18 = call i8 addrspace(1)* @_bal_panic_construct(i64 2308), !dbg !12
