...
12:
  %13 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 1), !dbg !14
  call void @_Bb02ioprintln(i8 addrspace(1)* %13), !dbg !14
...
16:
  ret void
17:
  %18 = call i8 addrspace(1)* @_bal_panic_construct(i64 2564), !dbg !13
