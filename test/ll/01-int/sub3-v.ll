...
42:
  ...
  ret void
100:
  %101 = call i8 addrspace(1)* @_bal_panic_construct(i64 1028)
...
13:
  ...
  unreachable
15:
  %16 = call i8 addrspace(1)* @_bal_panic_construct(i64 7684)
...
17:
  ...
  ret i64 %19
20:
  %21 = call i8 addrspace(1)* @_bal_panic_construct(i64 7937)
