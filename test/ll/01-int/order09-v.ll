...
54:
  %55 = call i1 @_B_gte(i64 9223372036854775806, i64 9223372036854775806), !dbg !12
  ...
  %57 = call i1 @_B_gte(i64 9223372036854775806, i64 1), !dbg !14
  ...
  %59 = call i1 @_B_gte(i64 9223372036854775806, i64 0), !dbg !16
  ...
  %61 = call i1 @_B_gte(i64 9223372036854775806, i64 -1), !dbg !18
  ...
  %63 = call i1 @_B_gte(i64 9223372036854775806, i64 -9223372036854775806), !dbg !20
  ...
  %65 = call i1 @_B_gte(i64 1, i64 9223372036854775806), !dbg !22
  ...
  %67 = call i1 @_B_gte(i64 1, i64 1), !dbg !24
  ...
  %69 = call i1 @_B_gte(i64 1, i64 0), !dbg !26
  ...
  %71 = call i1 @_B_gte(i64 1, i64 -1), !dbg !28
  ...
  %73 = call i1 @_B_gte(i64 1, i64 -9223372036854775806), !dbg !30
  ...
  %75 = call i1 @_B_gte(i64 0, i64 9223372036854775806), !dbg !32
  ...
  %77 = call i1 @_B_gte(i64 0, i64 1), !dbg !34
  ...
  %79 = call i1 @_B_gte(i64 0, i64 0), !dbg !36
  ...
  %81 = call i1 @_B_gte(i64 0, i64 -1), !dbg !38
  ...
  %83 = call i1 @_B_gte(i64 0, i64 -9223372036854775806), !dbg !40
  ...
  %85 = call i1 @_B_gte(i64 -1, i64 9223372036854775806), !dbg !42
  ...
  %87 = call i1 @_B_gte(i64 -1, i64 1), !dbg !44
  ...
  %89 = call i1 @_B_gte(i64 -1, i64 0), !dbg !46
  ...
  %91 = call i1 @_B_gte(i64 -1, i64 -1), !dbg !48
  ...
  %93 = call i1 @_B_gte(i64 -1, i64 -9223372036854775806), !dbg !50
  ...
  %95 = call i1 @_B_gte(i64 -9223372036854775806, i64 9223372036854775806), !dbg !52
  ...
  %97 = call i1 @_B_gte(i64 -9223372036854775806, i64 1), !dbg !54
  ...
  %99 = call i1 @_B_gte(i64 -9223372036854775806, i64 0), !dbg !56
  ...
  %101 = call i1 @_B_gte(i64 -9223372036854775806, i64 -1), !dbg !58
  ...
  %103 = call i1 @_B_gte(i64 -9223372036854775806, i64 -9223372036854775806), !dbg !60
...
define internal i1 @_B_gte(i64 %0, i64 %1) !dbg !7 {
  %a = alloca i64
  %b = alloca i64
  %3 = alloca i1
  %4 = alloca i8
...
!1 = !DIFile(filename:"../../../compiler/testSuite/01-int/order09-v.bal", directory:"")
!2 = distinct !DICompileUnit(language: DW_LANG_C99, file: !1, isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, splitDebugInlining: false)
!3 = !DISubroutineType(types: !4)
!4 = !{}
!5 = distinct !DISubprogram(name:"main", linkageName:"_B04rootmain", scope: !1, file: !1, line: 4, type: !3, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !6)
!6 = !{}
!7 = distinct !DISubprogram(name:"gte", linkageName:"_B_gte", scope: !1, file: !1, line: 36, type: !3, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !8)
!8 = !{}
