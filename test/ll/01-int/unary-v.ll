...
11:
  %12 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 3), !dbg !10
  call void @_Bb02ioprintln(i8 addrspace(1)* %12), !dbg !10
  store i8 addrspace(1)* null, i8 addrspace(1)** %1, !dbg !10
  %13 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 3), !dbg !11
  call void @_Bb02ioprintln(i8 addrspace(1)* %13), !dbg !11
  store i8 addrspace(1)* null, i8 addrspace(1)** %2, !dbg !11
  %14 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 -1), !dbg !12
...
9:
  %10 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 1), !dbg !18
  call void @_Bb02ioprintln(i8 addrspace(1)* %10), !dbg !18
  store i8 addrspace(1)* null, i8 addrspace(1)** %2, !dbg !18
  br label %13
11:
  %12 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 0), !dbg !19
  call void @_Bb02ioprintln(i8 addrspace(1)* %12), !dbg !19
  store i8 addrspace(1)* null, i8 addrspace(1)** %3, !dbg !19
  br label %13
13:
  ret void
14:
  %15 = call i8 addrspace(1)* @_bal_panic_construct(i64 3844), !dbg !17
...
!1 = !DIFile(filename:"../../../compiler/testSuite/01-int/unary-v.bal", directory:"")
...
!12 = !DILocation(line: 7, column: 2, scope: !5)
!13 = !DILocation(line: 8, column: 2, scope: !5)
!14 = !DILocation(line: 9, column: 2, scope: !5)
!15 = !DILocation(line: 10, column: 2, scope: !5)
!16 = !DILocation(line: 11, column: 2, scope: !5)
!17 = !DILocation(line: 0, column: 0, scope: !7)
!18 = !DILocation(line: 17, column: 4, scope: !7)
!19 = !DILocation(line: 19, column: 4, scope: !7)
