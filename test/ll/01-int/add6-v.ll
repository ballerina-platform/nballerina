...
39:
  ...
  ret void
103:
  %104 = call i8 addrspace(1)* @_bal_panic_construct(i64 516)
...
13:
  ...
  unreachable
15:
  %16 = call i8 addrspace(1)* @_bal_panic_construct(i64 3076)
...
17:
  ...
  ret i64 %19
20:
  %21 = call i8 addrspace(1)* @_bal_panic_construct(i64 3329)
