...
6:
  ...
  %7 = load i64, i64* %INT_MAX, !dbg !10
  %8 = call i64 @_B_add(i64 %7, i64 1), !dbg !10
...
13:
  ...
  unreachable
15:
  %16 = call i8 addrspace(1)* @_bal_panic_construct(i64 2308), !dbg !12
...
17:
  ...
  ret i64 %19
20:
  %21 = call i8 addrspace(1)* @_bal_panic_construct(i64 2561), !dbg !12
