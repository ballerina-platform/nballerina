...
20:
  ...
  store i1 %23, ptr %1
  %24 = load i1, ptr %1
  call void @_B_printBoolean(i1 %24), !dbg !15
  store ptr addrspace(1) null, ptr %2
  %25 = call i1 @_B_greaterThan(i64 1, i64 2), !dbg !16
  store i1 %25, ptr %3
  %26 = load i1, ptr %3
  call void @_B_printBoolean(i1 %26), !dbg !17
  store ptr addrspace(1) null, ptr %4
  %27 = call i1 @_B_greaterThan(i64 2, i64 1), !dbg !18
  store i1 %27, ptr %5
  %28 = load i1, ptr %5
  call void @_B_printBoolean(i1 %28), !dbg !19
  store ptr addrspace(1) null, ptr %6
  %29 = call i1 @_B_greaterThan(i64 2, i64 -1), !dbg !20
  store i1 %29, ptr %7
  %30 = load i1, ptr %7
  call void @_B_printBoolean(i1 %30), !dbg !21
  store ptr addrspace(1) null, ptr %8
  %31 = call i1 @_B_lessThan(i64 1, i64 2), !dbg !22
  store i1 %31, ptr %9
  %32 = load i1, ptr %9
  call void @_B_printBoolean(i1 %32), !dbg !23
  store ptr addrspace(1) null, ptr %10
  %33 = call i1 @_B_lessThan(i64 0, i64 0), !dbg !24
  store i1 %33, ptr %11
  %34 = load i1, ptr %11
  call void @_B_printBoolean(i1 %34), !dbg !25
  store ptr addrspace(1) null, ptr %12
  %35 = call i1 @_B_lessThan(i64 2, i64 1), !dbg !26
  store i1 %35, ptr %13
  %36 = load i1, ptr %13
  call void @_B_printBoolean(i1 %36), !dbg !27
  store ptr addrspace(1) null, ptr %14
  %37 = call i1 @_B_lessThan(i64 -1, i64 17), !dbg !28
  store i1 %37, ptr %15
  %38 = load i1, ptr %15
  call void @_B_printBoolean(i1 %38), !dbg !29
  store ptr addrspace(1) null, ptr %16
  ret void
39:
  %40 = call ptr addrspace(1) @_bal_panic_construct(i64 1028), !dbg !13
  call void @_bal_panic(ptr addrspace(1) %40), !dbg !14
  unreachable
}
...
11:
  %12 = call ptr addrspace(1) @_bal_list_construct_8(ptr @_Bi04root0, i64 1), !dbg !34
  ...
  call void @_Bb02ioprintln(ptr addrspace(1) %23), !dbg !35
  store ptr addrspace(1) null, ptr %3
  br label %37
24:
  %25 = call ptr addrspace(1) @_bal_list_construct_8(ptr @_Bi04root0, i64 1), !dbg !32
  ...
  call void @_Bb02ioprintln(ptr addrspace(1) %36), !dbg !33
  store ptr addrspace(1) null, ptr %5
  br label %37
37:
  ret void
38:
  %39 = call ptr addrspace(1) @_bal_panic_construct(i64 4356), !dbg !30
  call void @_bal_panic(ptr addrspace(1) %39), !dbg !31
  unreachable
}
...
7:
  ...
  ret i1 %11
12:
  %13 = call ptr addrspace(1) @_bal_panic_construct(i64 6660), !dbg !36
...
7:
  ...
  ret i1 %11
12:
  %13 = call ptr addrspace(1) @_bal_panic_construct(i64 7684), !dbg !38
  call void @_bal_panic(ptr addrspace(1) %13), !dbg !39
  unreachable
}
!llvm.module.flags = !{!0}
!llvm.dbg.cu = !{!2}
...
!33 = !DILocation(line: 22, column: 8, scope: !7)
!34 = !DILocation(line: 19, column: 19, scope: !7)
!35 = !DILocation(line: 19, column: 8, scope: !7)
!36 = !DILocation(line: 0, column: 0, scope: !9)
!37 = !DILocation(line: 26, column: 9, scope: !9)
!38 = !DILocation(line: 0, column: 0, scope: !11)
!39 = !DILocation(line: 30, column: 9, scope: !11)
