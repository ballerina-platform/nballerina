...
6:
  %7 = call i64 @_B_div(i64 672, i64 0), !dbg !10
...
22:
  ...
  ret i64 %24
25:
  %26 = call i8 addrspace(1)* @_bal_panic_construct(i64 2305), !dbg !12
...
!1 = !DIFile(filename:"../../../compiler/testSuite/01-int/div3-p.bal", directory:"")
