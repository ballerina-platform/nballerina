...
10:
  %11 = call i64 @_B_add(i64 2, i64 3), !dbg !11
  store i64 %11, ptr %1
  %12 = load i64, ptr %1
  store i64 %12, ptr %add1
  ...
  %24 = call i64 @_B_add(i64 20, i64 30), !dbg !15
  store i64 %24, ptr %4
  ...
  %29 = load i64, ptr %4
  %30 = call ptr addrspace(1) @_bal_int_to_tagged(i64 %29), !dbg !17
  ...
  ret void
36:
  %37 = call ptr addrspace(1) @_bal_panic_construct(i64 772), !dbg !9
...
13:
  ...
  unreachable
15:
  %16 = call ptr addrspace(1) @_bal_panic_construct(i64 2308), !dbg !19
...
17:
  ...
  ret i64 %19
20:
  %21 = call ptr addrspace(1) @_bal_panic_construct(i64 2561), !dbg !19
...
!16 = !DILocation(line: 6, column: 13, scope: !5)
!17 = !DILocation(line: 6, column: 13, scope: !5)
!18 = !DILocation(line: 6, column: 2, scope: !5)
!19 = !DILocation(line: 0, column: 0, scope: !7)
!20 = !DILocation(line: 9, column: 9, scope: !7)
!21 = !DILocation(line: 11, column: 0, scope: !7)
