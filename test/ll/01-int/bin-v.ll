...
24:
  %25 = call i8 addrspace(1)* @_bal_panic_construct(i64 2305)
  store i8 addrspace(1)* %25, i8 addrspace(1)** %6
  br label %15
26:
  %27 = call i8 addrspace(1)* @_bal_panic_construct(i64 2306)
...
32:
  ...
  ret i64 %34
35:
  %36 = call i8 addrspace(1)* @_bal_panic_construct(i64 2305)
