...
54:
  ...
  ret void
105:
  %106 = call i8 addrspace(1)* @_bal_panic_construct(i64 772)
  call void @_bal_panic(i8 addrspace(1)* %106)
  unreachable
}
define internal i1 @_B_lt(i64 %0, i64 %1) {
  %a = alloca i64
  %b = alloca i64
  %3 = alloca i1
  %4 = alloca i8
...
13:
  ret void
14:
  %15 = call i8 addrspace(1)* @_bal_panic_construct(i64 9988)
