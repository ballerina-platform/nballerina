...
5:
  call void @_B_foo(i64 21), !dbg !11
  store ptr addrspace(1) null, ptr %1
  ret void
6:
  %7 = call ptr addrspace(1) @_bal_panic_construct(i64 1796), !dbg !9
...
7:
  ...
  ret void
19:
  %20 = call ptr addrspace(1) @_bal_panic_construct(i64 2820), !dbg !12
...
!1 = !DIFile(filename:"../../../compiler/testSuite/future/types2-o.bal", directory:"")
...
!13 = !DILocation(line: 11, column: 9, scope: !7)
