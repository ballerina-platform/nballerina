...
5:
  %6 = zext i1 0 to i64, !dbg !8
  %7 = or i64 %6, 72057594037927936, !dbg !8
  %8 = getelementptr i8, i8 addrspace(1)* null, i64 %7, !dbg !8
  call void @_Bb02ioprintln(i8 addrspace(1)* %8), !dbg !8
  store i8 addrspace(1)* null, i8 addrspace(1)** %1, !dbg !8
  ret void
9:
  %10 = call i8 addrspace(1)* @_bal_panic_construct(i64 1540), !dbg !7
...
!1 = !DIFile(filename:"../../../compiler/testSuite/06-const/05-v.bal", directory:"")
