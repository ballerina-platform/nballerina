...
15:
  ...
  %25 = call ptr addrspace(1) @_bal_mapping_indexed_get(ptr addrspace(1) %24, i64 0), !dbg !12
  %26 = call i64 @_bal_tagged_to_int(ptr addrspace(1) %25), !dbg !13
  store i64 %26, ptr %2
  %27 = load ptr addrspace(1), ptr %p
  %28 = call ptr addrspace(1) @_bal_mapping_indexed_get(ptr addrspace(1) %27, i64 1), !dbg !14
  ...
  %36 = call i64 @_bal_mapping_indexed_set(ptr addrspace(1) %33, i64 0, ptr addrspace(1) %35), !dbg !17
  %37 = icmp eq i64 %36, 0
...
42:
  ...
  %44 = call ptr addrspace(1) @_bal_mapping_indexed_get(ptr addrspace(1) %43, i64 0), !dbg !18
  ...
  %58 = call ptr addrspace(1) @_bal_mapping_indexed_get(ptr addrspace(1) %57, i64 1), !dbg !23
...
!1 = !DIFile(filename:"../../../compiler/testSuite/09-record/fieldlvalue5-v.bal", directory:"")
