...
9:
  ...
  %22 = call i64 @_bal_mapping_indexed_set(ptr addrspace(1) %18, i64 0, ptr addrspace(1) %21), !dbg !12
  %23 = icmp eq i64 %22, 0
...
28:
  ...
  %30 = call ptr addrspace(1) @_bal_mapping_indexed_get(ptr addrspace(1) %29, i64 0), !dbg !13
