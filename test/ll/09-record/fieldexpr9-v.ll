...
8:
  ...
  %11 = call ptr addrspace(1) @_bal_mapping_indexed_get(ptr addrspace(1) %10, i64 0), !dbg !12
  ...
  ret void
25:
  %26 = call ptr addrspace(1) @_bal_panic_construct(i64 2308), !dbg !9
...
15:
  %16 = call ptr addrspace(1) @_bal_panic_construct(i64 3588), !dbg !17
...
!10 = !DILocation(line: 9, column: 16, scope: !5)
!11 = !DILocation(line: 10, column: 12, scope: !5)
!12 = !DILocation(line: 10, column: 20, scope: !5)
!13 = !DILocation(line: 10, column: 20, scope: !5)
...
!19 = !DILocation(line: 15, column: 14, scope: !7)
!20 = !DILocation(line: 15, column: 14, scope: !7)
