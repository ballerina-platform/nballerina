...
10:
  ...
  %25 = load double, double* %y
  %26 = fadd double %25, 0.5
  store double %26, double* %5
  %27 = load double, double* %5, !dbg !9
  %28 = call i8 addrspace(1)* @_bal_float_to_tagged(double %27), !dbg !9
  call void @_Bb02ioprintln(i8 addrspace(1)* %28), !dbg !9
  store i8 addrspace(1)* null, i8 addrspace(1)** %6, !dbg !9
  ret void
29:
  %30 = call i8 addrspace(1)* @_bal_panic_construct(i64 2052), !dbg !7
