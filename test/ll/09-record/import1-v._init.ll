...
%FillerDesc = type {ptr}
@_Bi04root0 = constant {i32, i32, i64, ptr, [2 x i64]} {i32 0, i32 2, i64 1, ptr null, [2 x i64] [i64 17, i64 9]}
...
@_Bi04root2 = constant {i32, i32, i64, ptr, [2 x i64]} {i32 1, i32 2, i64 1, ptr null, [2 x i64] [i64 19, i64 11]}
...
@.subtype0 = internal constant {ptr, i32, [2 x {ptr addrspace(1), i32}]} {ptr @_bal_record_subtype_contains, i32 2, [2 x {ptr addrspace(1), i32}] [{ptr addrspace(1), i32} {ptr addrspace(1) getelementptr(i8, ptr addrspace(1) addrspacecast(ptr bitcast(ptr @.str0 to ptr) to ptr addrspace(1)), i64 360287970189639680), i32 8}, {ptr addrspace(1), i32} {ptr addrspace(1) getelementptr(i8, ptr addrspace(1) addrspacecast(ptr bitcast(ptr @.str1 to ptr) to ptr addrspace(1)), i64 360287970189639680), i32 4}]}, align 8
@_Bt04root0 = constant {i32, i32, [1 x ptr]} {i32 0, i32 8192, [1 x ptr] [ptr bitcast(ptr @.subtype0 to ptr)]}
@_Bi0m4root6types20 = alias {i32, i32, i64, ptr, [2 x i64]}, ptr @_Bi04root0
@_Bi0m4root6types10 = alias {i32, i32, i64, ptr, [2 x i64]}, ptr @_Bi04root0
@_Bt0m4root6types20 = alias {i32, i32, [1 x ptr]}, ptr @_Bt04root0
