...
@_Bt0m4root6types11 = external constant %TypeTestVTable
...
6:
  ...
  %8 = getelementptr %TypeTestVTable, %TypeTestVTable* @_Bt0m4root6types11, i64 0, i32 0
  %9 = load i1(%TypeTestVTable*, i8 addrspace(1)*)*, i1(%TypeTestVTable*, i8 addrspace(1)*)** %8, align 8
  %10 = call i1 %9(%TypeTestVTable* @_Bt0m4root6types11, i8 addrspace(1)* %7)
  store i1 %10, i1* %2
  %11 = load i1, i1* %2
  ret i1 %11
12:
