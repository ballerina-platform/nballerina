...
40:
  ...
  %171 = call i1 @_bal_type_contains(ptr @_Bt04root5, ptr addrspace(1) %170), !dbg !45
  store i1 %171, ptr %25
  ...
  %203 = call i1 @_bal_type_contains(ptr @_Bt04root5, ptr addrspace(1) %202), !dbg !52
  store i1 %203, ptr %31
...
!13 = !DILocation(line: 21, column: 22, scope: !5)
