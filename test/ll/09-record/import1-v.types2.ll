...
@_Bi0m4root6types20 = external constant {i32, i32}
...
@_Bt0m4root6types21 = external constant {i32, i32, [0 x i8*]}
...
7:
  ...
  %8 = call i8 addrspace(1)* @_bal_mapping_construct({i32, i32}* @_Bi0m4root6types20, i64 2)
...
6:
  ...
  %8 = call i1 @_bal_type_contains({i32, i32, [0 x i8*]}* @_Bt0m4root6types21, i8 addrspace(1)* %7)
  store i1 %8, i1* %2
  %9 = load i1, i1* %2
  ret i1 %9
10:
