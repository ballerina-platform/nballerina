...
@_Bt0m4root6types21 = external constant %TypeTestVTable
...
define i8 addrspace(1)* @_B0m4root6types2create(i64 %0, double %1) !dbg !5 {
  %i = alloca i64
  %f = alloca double
...
7:
  ...
  %8 = call i8 addrspace(1)* @_bal_mapping_construct({i32}* @_Bi0m4root6types20, i64 2)
...
define i1 @_B0m4root6types2test(i8 addrspace(1)* %0) !dbg !7 {
...
6:
  ...
  %8 = getelementptr %TypeTestVTable, %TypeTestVTable* @_Bt0m4root6types21, i64 0, i32 0
  %9 = load i1(%TypeTestVTable*, i8 addrspace(1)*)*, i1(%TypeTestVTable*, i8 addrspace(1)*)** %8, align 8
  %10 = call i1 %9(%TypeTestVTable* @_Bt0m4root6types21, i8 addrspace(1)* %7)
  store i1 %10, i1* %2
  %11 = load i1, i1* %2
  ret i1 %11
12:
  %13 = call i8 addrspace(1)* @_bal_panic_construct(i64 2564), !dbg !10
...
!1 = !DIFile(filename:"../../../compiler/testSuite/09-record/import1-v.modules/types2/types.bal", directory:"../../../compiler/testSuite/09-record/import1-v.modules/types2")
