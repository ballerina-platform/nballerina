...
16:
  ...
  %24 = call ptr addrspace(1) @_bal_mapping_indexed_get(ptr addrspace(1) %23, i64 1), !dbg !13
  ...
  %31 = call i64 @_bal_mapping_indexed_set(ptr addrspace(1) %28, i64 1, ptr addrspace(1) %30), !dbg !16
  %32 = icmp eq i64 %31, 0
...
37:
  ...
  %39 = call ptr addrspace(1) @_bal_mapping_indexed_get(ptr addrspace(1) %38, i64 0), !dbg !17
...
47:
  ...
  %52 = call i64 @_bal_mapping_indexed_set(ptr addrspace(1) %49, i64 0, ptr addrspace(1) %51), !dbg !20
  %53 = icmp eq i64 %52, 0
...
56:
  ...
  %58 = call ptr addrspace(1) @_bal_mapping_indexed_get(ptr addrspace(1) %57, i64 1), !dbg !21
  ...
  %72 = call ptr addrspace(1) @_bal_mapping_indexed_get(ptr addrspace(1) %71, i64 0), !dbg !26
...
!1 = !DIFile(filename:"../../../compiler/testSuite/09-record/compoundassign1-v.bal", directory:"")
