...
@_Bi04root2 = constant {i32, i32, i64, ptr, [1 x i64]} {i32 1, i32 1, i64 1, ptr null, [1 x i64] [i64 9]}
@_Bi04root3 = constant {i32, i32, i64, ptr, [2 x i64]} {i32 2, i32 2, i64 1, ptr null, [2 x i64] [i64 9, i64 ptrtoint(ptr @.member0 to i64)]}
@.subtype0 = internal constant %Type0 {ptr @_bal_record_subtype_contains, i32 1, [1 x {ptr addrspace(1), i32}] [{ptr addrspace(1), i32} {ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261411), i32 4}]}, align 8
