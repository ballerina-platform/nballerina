...
8:
  ...
  call void @_bal_mapping_init_member(ptr addrspace(1) %9, ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261410), ptr addrspace(1) %15), !dbg !11
  %16 = and i64 72057594037927935, 3
  %17 = or i64 2449958197289549824, %16
  %18 = getelementptr i8, ptr addrspace(1) null, i64 %17
  call void @_bal_mapping_init_member(ptr addrspace(1) %9, ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261411), ptr addrspace(1) %18), !dbg !12
  store ptr addrspace(1) %9, ptr %1
  %19 = load ptr addrspace(1), ptr %1
  %20 = call ptr addrspace(1) @_bal_mapping_indexed_get(ptr addrspace(1) %19, i64 2), !dbg !13
...
!1 = !DIFile(filename:"../../../compiler/testSuite/14-mapping/5-v.bal", directory:"")
...
!13 = !DILocation(line: 3, column: 37, scope: !5)
!14 = !DILocation(line: 3, column: 37, scope: !5)
