...
%FillerDesc = type {ptr}
%Type0 = type {ptr, i32, [2 x {ptr addrspace(1), i32}]}
%Type1 = type {ptr, i32, [2 x {ptr addrspace(1), i32}]}
@_Bi04root0 = constant {i32, i32, i64, ptr, [2 x i64]} {i32 0, i32 2, i64 1, ptr null, [2 x i64] [i64 9, i64 9]}
...
@_Bi04root2 = constant {i32, i32, i64, ptr, [2 x i64]} {i32 1, i32 2, i64 1, ptr null, [2 x i64] [i64 9, i64 9]}
@_Bi04root3 = constant {i32, i32, i64, ptr, [2 x i64]} {i32 2, i32 2, i64 1, ptr null, [2 x i64] [i64 ptrtoint(ptr @.member0 to i64), i64 9]}
@.subtype0 = internal constant %Type0 {ptr @_bal_record_subtype_contains, i32 2, [2 x {ptr addrspace(1), i32}] [{ptr addrspace(1), i32} {ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261432), i32 4}, {ptr addrspace(1), i32} {ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261433), i32 4}]}, align 8
@.member0 = internal constant {i32, i32, [1 x ptr]} {i32 0, i32 8192, [1 x ptr] [ptr bitcast(ptr @.subtype0 to ptr)]}
@_Bi04root4 = constant {i32, i32, i64, ptr, [2 x i64]} {i32 3, i32 2, i64 1, ptr null, [2 x i64] [i64 65, i64 9]}
@_Bi04root5 = constant {i32, i32, i64, ptr, [2 x i64]} {i32 4, i32 2, i64 1, ptr null, [2 x i64] [i64 65, i64 9]}
@_Bi04root6 = constant {i32, i32, i64, ptr, [2 x i64]} {i32 5, i32 2, i64 1, ptr null, [2 x i64] [i64 ptrtoint(ptr @.member1 to i64), i64 9]}
@.subtype1 = internal constant %Type1 {ptr @_bal_record_subtype_contains, i32 2, [2 x {ptr addrspace(1), i32}] [{ptr addrspace(1), i32} {ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261432), i32 32}, {ptr addrspace(1), i32} {ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261433), i32 4}]}, align 8
