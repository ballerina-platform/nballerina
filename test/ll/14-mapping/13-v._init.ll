...
@_Bi04root2 = constant {i32, i32, i64, ptr, [1 x i64]} {i32 1, i32 1, i64 1, ptr null, [1 x i64] [i64 ptrtoint(ptr @.member0 to i64)]}
@.subtype0 = internal constant %Type0 {ptr @_bal_record_subtype_contains, i32 2, [2 x {ptr addrspace(1), i32}] [{ptr addrspace(1), i32} {ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261409), i32 4}, {ptr addrspace(1), i32} {ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261410), i32 8}]}, align 8
