...
L1:
  ...
  %_75 = load i64, i64* %_8
  %_76 = call i8 addrspace (1)* @_bal_alloc (i64 8)
  %_77 = bitcast i8 addrspace (1)* %_76 to i64 addrspace (1)*
  store i64 %_75, i64 addrspace (1)* %_77, align 8
  %_78 = getelementptr i8, i8 addrspace (1)* %_76, i64 504403158265495552
  call void @_Bio__println (i8 addrspace (1)* %_78)
...
L6:
  ...
  store i64 %_93, i64 addrspace (1)* %_95, align 8
  ...
  %_104 = call i8 addrspace (1)* @_bal_alloc (i64 8)
  %_105 = bitcast i8 addrspace (1)* %_104 to i64 addrspace (1)*
  store i64 %_103, i64 addrspace (1)* %_105, align 8
  %_106 = getelementptr i8, i8 addrspace (1)* %_104, i64 504403158265495552
  ...
  %_109 = call i8 addrspace (1)* @_bal_alloc (i64 8)
  %_110 = bitcast i8 addrspace (1)* %_109 to i64 addrspace (1)*
  store i64 %_108, i64 addrspace (1)* %_110, align 8
  %_111 = getelementptr i8, i8 addrspace (1)* %_109, i64 504403158265495552
...
L10:
  ...
  %_123 = bitcast i8 addrspace (1)* %_122 to i64 addrspace (1)*
  store i64 %_121, i64 addrspace (1)* %_123, align 8
  %_124 = getelementptr i8, i8 addrspace (1)* %_122, i64 504403158265495552
...
L14:
  ...
  %_135 = call i8 addrspace (1)* @_bal_alloc (i64 8)
  %_136 = bitcast i8 addrspace (1)* %_135 to i64 addrspace (1)*
  store i64 %_134, i64 addrspace (1)* %_136, align 8
  %_137 = getelementptr i8, i8 addrspace (1)* %_135, i64 504403158265495552
  call void @_Bio__println (i8 addrspace (1)* %_137)
...
L16:
  ...
  %_145 = bitcast i8 addrspace (1)* %_144 to i64 addrspace (1)*
  store i64 %_143, i64 addrspace (1)* %_145, align 8
  %_146 = getelementptr i8, i8 addrspace (1)* %_144, i64 504403158265495552
...
L18:
  ...
  %_153 = call i8 addrspace (1)* @_bal_alloc (i64 8)
  %_154 = bitcast i8 addrspace (1)* %_153 to i64 addrspace (1)*
  store i64 %_152, i64 addrspace (1)* %_154, align 8
  %_155 = getelementptr i8, i8 addrspace (1)* %_153, i64 504403158265495552
...
L20:
  ...
  %_162 = call i8 addrspace (1)* @_bal_alloc (i64 8)
  %_163 = bitcast i8 addrspace (1)* %_162 to i64 addrspace (1)*
  store i64 %_161, i64 addrspace (1)* %_163, align 8
  %_164 = getelementptr i8, i8 addrspace (1)* %_162, i64 504403158265495552
  call void @_Bio__println (i8 addrspace (1)* %_164)
...
L26:
  ...
  %_179 = call i8 addrspace (1)* @_bal_alloc (i64 8)
  %_180 = bitcast i8 addrspace (1)* %_179 to i64 addrspace (1)*
  store i64 %_178, i64 addrspace (1)* %_180, align 8
  %_181 = getelementptr i8, i8 addrspace (1)* %_179, i64 504403158265495552
  call void @_Bio__println (i8 addrspace (1)* %_181)
  ...
  %_184 = call i8 addrspace (1)* @_bal_alloc (i64 8)
  %_185 = bitcast i8 addrspace (1)* %_184 to i64 addrspace (1)*
  store i64 %_183, i64 addrspace (1)* %_185, align 8
  %_186 = getelementptr i8, i8 addrspace (1)* %_184, i64 504403158265495552
  ...
  %_189 = call i8 addrspace (1)* @_bal_alloc (i64 8)
  %_190 = bitcast i8 addrspace (1)* %_189 to i64 addrspace (1)*
  store i64 %_188, i64 addrspace (1)* %_190, align 8
  %_191 = getelementptr i8, i8 addrspace (1)* %_189, i64 504403158265495552
