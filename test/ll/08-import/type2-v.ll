...
8:
  store i64 1, ptr %local
  store i64 2, ptr %foreign
  %9 = load i64, ptr %foreign
  store i64 %9, ptr %local
  ...
  %14 = load i64, ptr %local
  %15 = call ptr addrspace(1) @_bal_int_to_tagged(i64 %14), !dbg !10
