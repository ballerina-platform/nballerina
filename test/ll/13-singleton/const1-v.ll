...
6:
  store ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573431063922), ptr %c
  store ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738187948077183591), ptr %c
  store ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738187948077183591), ptr %c
  store ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188570848488546), ptr %c
  ...
  %11 = load ptr addrspace(1), ptr %c
  %12 = getelementptr inbounds [0 x ptr addrspace(1)], ptr addrspace(1) %10, i64 0, i64 0
  store ptr addrspace(1) %11, ptr addrspace(1) %12
  %13 = getelementptr inbounds {ptr, i64, i64, ptr addrspace(1)}, ptr addrspace(1) %7, i64 0, i32 1
  store i64 1, ptr addrspace(1) %13
  %14 = bitcast ptr addrspace(1) %7 to ptr addrspace(1)
  %15 = getelementptr i8, ptr addrspace(1) %14, i64 864691128455135236
  store ptr addrspace(1) %15, ptr %1
  %16 = load ptr addrspace(1), ptr %1
  call void @_Bb02ioprintln(ptr addrspace(1) %16), !dbg !10
  store ptr addrspace(1) null, ptr %2
  ret void
17:
  %18 = call ptr addrspace(1) @_bal_panic_construct(i64 2052), !dbg !7
