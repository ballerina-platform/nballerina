...
8:
  ...
  store i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098475965646206329), i8 addrspace(1)** %s
...
!1 = !DIFile(filename:"../../../compiler/testSuite/13-singleton/stringtest1-v.bal", directory:"")
