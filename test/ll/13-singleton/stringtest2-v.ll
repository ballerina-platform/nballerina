...
10:
  store ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261426), ptr %c
  %11 = load ptr addrspace(1), ptr %c
  store ptr addrspace(1) %11, ptr %s
  %12 = load ptr addrspace(1), ptr %s
  %13 = call i1 @_bal_type_contains(ptr @_Bt04root0, ptr addrspace(1) %12), !dbg !9
  store i1 %13, ptr %1
  %14 = call ptr addrspace(1) @_bal_list_construct_8(ptr @_Bi04root1, i64 1), !dbg !10
  ...
  %22 = getelementptr inbounds [0 x ptr addrspace(1)], ptr addrspace(1) %17, i64 0, i64 0
  store ptr addrspace(1) %21, ptr addrspace(1) %22
  %23 = getelementptr inbounds {ptr, i64, i64, ptr addrspace(1)}, ptr addrspace(1) %14, i64 0, i32 1
  store i64 1, ptr addrspace(1) %23
  %24 = bitcast ptr addrspace(1) %14 to ptr addrspace(1)
  ...
  %27 = load ptr addrspace(1), ptr %s
  %28 = call i1 @_bal_type_contains(ptr @_Bt04root0, ptr addrspace(1) %27), !dbg !12
  store i1 %28, ptr %4
  ...
  ret void
42:
  %43 = call ptr addrspace(1) @_bal_panic_construct(i64 1284), !dbg !7
