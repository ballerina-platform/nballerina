...
@.subtype0 = internal constant {ptr, i32, i16, i16, [3 x ptr addrspace(1)]} {ptr @_bal_string_subtype_contains, i32 3, i16 1, i16 1, [3 x ptr addrspace(1)] [ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188570848488546), ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738187948077183591), ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573431063922)]}, align 8
