%FillerDesc = type {ptr}
@_Bi04root0 = constant {i32, i32, i64, ptr, [3 x i64]} {i32 0, i32 3, i64 1, ptr null, [3 x i64] [i64 9, i64 9, i64 65]}
...
@_Bi04root2 = constant {i32, i32, i64, ptr, [2 x i64]} {i32 1, i32 2, i64 17, ptr bitcast(ptr @_bal_float_zero_filler_desc to ptr), [2 x i64] [i64 9, i64 9]}
