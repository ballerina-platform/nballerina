...
@.subtype0 = internal constant {ptr, i32, i32, [4 x double]} {ptr @_bal_float_subtype_contains, i32 4, i32 1, [4 x double] [double 0x7FF8000000000000, double 0xFFF0000000000000, double 0.0, double 0x7FF0000000000000]}, align 8
@_Bt04root0 = constant {i32, i32, [1 x ptr]} {i32 0, i32 8, [1 x ptr] [ptr bitcast(ptr @.subtype0 to ptr)]}
