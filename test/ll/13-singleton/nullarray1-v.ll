...
8:
  ...
  %15 = bitcast {{i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*}*, i64, i64, i8* addrspace(1)*} addrspace(1)* %9 to i8 addrspace(1)*
  ...
  %25 = call i64 %24(i8 addrspace(1)* %18, i64 0, i8 addrspace(1)* null)
  %26 = icmp eq i64 %25, 0
...
41:
  ...
  ret void
51:
  %52 = call i8 addrspace(1)* @_bal_panic_construct(i64 1541), !dbg !7
