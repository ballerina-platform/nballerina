...
9:
  ...
  %26 = call i64 %25(i8 addrspace(1)* %19, i64 0, i8 addrspace(1)* null)
  %27 = icmp eq i64 %26, 0
...
42:
  ...
  %47 = call i8 addrspace(1)* %46(i8 addrspace(1)* %33, i64 0)
  store i8 addrspace(1)* %47, i8 addrspace(1)** %2
  %48 = load i8 addrspace(1)*, i8 addrspace(1)** %2
  store i8 addrspace(1)* %48, i8 addrspace(1)** %n
  store i1 1, i1* %3
  %49 = load i1, i1* %3, !dbg !8
  %50 = zext i1 %49 to i64, !dbg !8
  %51 = or i64 %50, 72057594037927936, !dbg !8
  %52 = getelementptr i8, i8 addrspace(1)* null, i64 %51, !dbg !8
