...
@_Bt04root0 = constant {i32, i32, [1 x ptr]} {i32 0, i32 2, [1 x ptr] [ptr bitcast(ptr @.subtype0 to ptr)]}
@.subtype1 = internal constant {ptr} {ptr @_bal_false_subtype_contains}, align 8
...
declare i1 @_bal_false_subtype_contains(ptr, ptr addrspace(1))
