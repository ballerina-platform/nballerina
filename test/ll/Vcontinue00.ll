...
L6:
  %_19 = load i64, i64* %i
  %_20 = call i8 addrspace (1)* @_bal_alloc (i64 8)
  %_21 = bitcast i8 addrspace (1)* %_20 to i64 addrspace (1)*
  store i64 %_19, i64 addrspace (1)* %_21, align 8
  %_22 = getelementptr i8, i8 addrspace (1)* %_20, i64 504403158265495552
