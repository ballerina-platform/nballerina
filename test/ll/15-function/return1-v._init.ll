...
@.subtype0 = internal constant {ptr, i32, i16, i16, [1 x ptr addrspace(1)]} {ptr @_bal_string_subtype_contains, i32 1, i16 1, i16 1, [1 x ptr addrspace(1)] [ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573432049520)]}, align 8
