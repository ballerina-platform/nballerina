...
define void @_B_main () {
  ...
  %_15 = icmp eq i1 1, 1
  store i1 %_15, i1* %_0, align 8
  %_16 = load i1, i1* %_0, align 8
...
L3:
  %_17 = icmp eq i1 0, 0
  store i1 %_17, i1* %_3, align 8
  %_18 = load i1, i1* %_3, align 8
...
L6:
  %_19 = icmp ne i1 1, 1
  store i1 %_19, i1* %_6, align 8
  %_20 = load i1, i1* %_6, align 8
...
L9:
  ...
  %_21 = load i1, i1* %b, align 8
  %_22 = icmp eq i1 %_21, 1
  store i1 %_22, i1* %_9, align 8
  %_23 = load i1, i1* %_9, align 8
...
L12:
  ...
  %_24 = load i1, i1* %b, align 8
  %_25 = icmp eq i1 1, %_24
  store i1 %_25, i1* %_12, align 8
  %_26 = load i1, i1* %_12, align 8
