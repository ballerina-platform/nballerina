...
36:
  ...
  unreachable
38:
  %39 = call i8 addrspace(1)* @_bal_panic_construct(i64 3332)
...
47:
  %48 = call i8 addrspace(1)* @_bal_panic_construct(i64 4097)
...
54:
  %55 = call i8 addrspace(1)* @_bal_panic_construct(i64 4353)
