...
11:
  ...
  %21 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 0), !dbg !8
  call void @_Bb0m4lang5arraypush(i8 addrspace(1)* %20, i8 addrspace(1)* %21), !dbg !8
  store i8 addrspace(1)* null, i8 addrspace(1)** %2, !dbg !8
  %22 = load i8 addrspace(1)*, i8 addrspace(1)** %v, !dbg !9
  %23 = zext i1 1 to i64, !dbg !9
  %24 = or i64 %23, 72057594037927936, !dbg !9
  %25 = getelementptr i8, i8 addrspace(1)* null, i64 %24, !dbg !9
  call void @_Bb0m4lang5arraypush(i8 addrspace(1)* %22, i8 addrspace(1)* %25), !dbg !9
  store i8 addrspace(1)* null, i8 addrspace(1)** %3, !dbg !9
  %26 = load i8 addrspace(1)*, i8 addrspace(1)** %v, !dbg !10
  %27 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 2), !dbg !10
  call void @_Bb0m4lang5arraypush(i8 addrspace(1)* %26, i8 addrspace(1)* %27), !dbg !10
  store i8 addrspace(1)* null, i8 addrspace(1)** %4, !dbg !10
  %28 = load i8 addrspace(1)*, i8 addrspace(1)** %v, !dbg !11
  call void @_Bb0m4lang5arraypush(i8 addrspace(1)* %28, i8 addrspace(1)* null), !dbg !11
  store i8 addrspace(1)* null, i8 addrspace(1)** %5, !dbg !11
  %29 = load i8 addrspace(1)*, i8 addrspace(1)** %v, !dbg !12
  %30 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 4), !dbg !12
  call void @_Bb0m4lang5arraypush(i8 addrspace(1)* %29, i8 addrspace(1)* %30), !dbg !12
  store i8 addrspace(1)* null, i8 addrspace(1)** %6, !dbg !12
  %31 = load i8 addrspace(1)*, i8 addrspace(1)** %v, !dbg !13
  %32 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %31, i64 -5), !dbg !13
