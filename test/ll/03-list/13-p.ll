...
8:
  ...
  %22 = call i64 %20(i8 addrspace(1)* %13, i64 %16, i8 addrspace(1)* %21)
  %23 = icmp eq i64 %22, 0
...
28:
  ...
  %31 = call i64 @_Bb0m4lang5arraylength(i8 addrspace(1)* %30), !dbg !8
  store i64 %31, i64* %2, !dbg !8
  %32 = load i64, i64* %2, !dbg !9
  %33 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 %32), !dbg !9
...
!8 = !DILocation(line: 7, column: 17, scope: !5)
