...
7:
  ...
  store i8 addrspace(1)* %11, i8 addrspace(1)** %v
...
20:
  ...
  %22 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %21, i64 -5), !dbg !8
...
!1 = !DIFile(filename:"../../../compiler/testSuite/03-list/23-v.bal", directory:"")
