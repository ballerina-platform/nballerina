...
9:
  ...
  %15 = load i64, ptr %i
  %16 = call ptr addrspace(1) @llvm.ptrmask.p1.i64(ptr addrspace(1) %14, i64 72057594037927928)
  %17 = bitcast ptr addrspace(1) %16 to ptr addrspace(1)
  %18 = getelementptr {ptr, i64, i64, ptr addrspace(1)}, ptr addrspace(1) %17, i64 0, i32 1
  %19 = load i64, ptr addrspace(1) %18, align 8
  %20 = icmp ult i64 %15, %19
  br i1 %20, label %25, label %42
21:
...
23:
  ...
  unreachable
25:
  %26 = getelementptr {ptr, i64, i64, ptr addrspace(1)}, ptr addrspace(1) %17, i64 0, i32 0
  %27 = load ptr, ptr addrspace(1) %26, align 8
  %28 = getelementptr {i32, i32, i64, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, i64, ptr, [0 x i64]}, ptr %27, i64 0, i32 3
  %29 = load ptr, ptr %28, align 8
  %30 = call ptr addrspace(1) %29(ptr addrspace(1) %14, i64 %15)
  %31 = call ptr addrspace(1) @_bal_tagged_member_clear_exact_any(ptr addrspace(1) %14, ptr addrspace(1) %30), !dbg !10
  ...
  ret void
42:
  %43 = call ptr addrspace(1) @_bal_panic_construct(i64 1541), !dbg !7
