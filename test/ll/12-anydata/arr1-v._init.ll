...
%Type0 = type {i1(%UniformSubtype*, i8 addrspace(1)*)*, i32, [2 x i32]}
...
@.subtype0 = internal constant %Type0 {i1(%UniformSubtype*, i8 addrspace(1)*)* @_bal_precomputed_subtype_contains, i32 2, [2 x i32] [i32 0, i32 1]}, align 8
