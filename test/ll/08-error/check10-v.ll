...
6:
  %7 = call i8 addrspace(1)* @_B_passAlong()
...
define internal i8 addrspace(1)* @_B_passAlong() {
  %1 = alloca i8 addrspace(1)*
  %2 = alloca i1
...
8:
  %9 = call i8 addrspace(1)* @_B_alwaysErr()
...
21:
  %22 = call i8 addrspace(1)* @_bal_panic_construct(i64 1540)
