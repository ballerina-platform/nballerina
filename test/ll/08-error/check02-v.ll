...
7:
  %8 = call ptr addrspace(1) @_B_catch(), !dbg !13
...
define internal ptr addrspace(1) @_B_catch() !dbg !7 {
  %1 = alloca ptr addrspace(1)
  %2 = alloca ptr addrspace(1)
  %3 = alloca ptr addrspace(1)
  %4 = alloca i8
...
7:
  %8 = call ptr addrspace(1) @_B_neverErr(), !dbg !18
  store ptr addrspace(1) %8, ptr %1
...
22:
  %23 = call ptr addrspace(1) @_bal_panic_construct(i64 1796), !dbg !16
  call void @_bal_panic(ptr addrspace(1) %23), !dbg !17
  unreachable
}
define internal ptr addrspace(1) @_B_neverErr() !dbg !9 {
  %1 = alloca i8
...
5:
  %6 = call ptr addrspace(1) @_bal_panic_construct(i64 3076), !dbg !19
  call void @_bal_panic(ptr addrspace(1) %6), !dbg !20
  unreachable
}
!llvm.module.flags = !{!0}
!llvm.dbg.cu = !{!2}
