...
37:
  ...
  unreachable
39:
  %40 = call i8 addrspace(1)* @_bal_panic_construct(i64 2564)
...
41:
  ...
  br label %36
45:
  %46 = call i8 addrspace(1)* @_bal_panic_construct(i64 3073)
...
47:
  ...
  br label %35
51:
  %52 = call i8 addrspace(1)* @_bal_panic_construct(i64 3585)
