...
18:
  ...
  ret void
32:
  %33 = call ptr addrspace(1) @_bal_panic_construct(i64 1283), !dbg !7
...
!1 = !DIFile(filename:"../../../compiler/testSuite/10-null/cast2-v.bal", directory:"")
...
!11 = !DILocation(line: 7, column: 0, scope: !5)
