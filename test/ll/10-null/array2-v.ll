...
7:
  ...
  %12 = getelementptr inbounds [0 x i8 addrspace(1)*], [0 x i8 addrspace(1)*] addrspace(1)* %10, i64 0, i64 1
  store i8 addrspace(1)* null, i8 addrspace(1)* addrspace(1)* %12
  %13 = getelementptr inbounds [0 x i8 addrspace(1)*], [0 x i8 addrspace(1)*] addrspace(1)* %10, i64 0, i64 2
  store i8 addrspace(1)* null, i8 addrspace(1)* addrspace(1)* %13
  %14 = getelementptr inbounds {{i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i32}*, i64, i64, [0 x i8 addrspace(1)*] addrspace(1)*}, {{i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i32}*, i64, i64, [0 x i8 addrspace(1)*] addrspace(1)*} addrspace(1)* %8, i64 0, i32 1
  store i64 3, i64 addrspace(1)* %14
  %15 = bitcast {{i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i32}*, i64, i64, [0 x i8 addrspace(1)*] addrspace(1)*} addrspace(1)* %8 to i8 addrspace(1)*
  ...
  store i8 addrspace(1)* %17, i8 addrspace(1)** %moreOfNothings
  %18 = load i8 addrspace(1)*, i8 addrspace(1)** %moreOfNothings, !dbg !8
  %19 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %18, i64 -5), !dbg !8
  %20 = call i64 @_Bb0m4lang5arraylength(i8 addrspace(1)* %19), !dbg !8
  store i64 %20, i64* %2, !dbg !8
  %21 = load i64, i64* %2, !dbg !9
...
!1 = !DIFile(filename:"../../../compiler/testSuite/10-null/array2-v.bal", directory:"")
...
!8 = !DILocation(line: 5, column: 36, scope: !5)
