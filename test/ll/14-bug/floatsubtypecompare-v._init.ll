...
%Type0 = type {ptr, i32, i32, [3 x double]}
%FillerDesc = type {ptr}
...
@.subtype0 = internal constant %Type0 {ptr @_bal_float_subtype_contains, i32 3, i32 1, [3 x double] [double 1.0, double 2.0, double 3.0]}, align 8
