...
%Type0 = type {ptr, i64, [2 x {i64, i64}]}
%FillerDesc = type {ptr}
...
@.subtype0 = internal constant %Type0 {ptr @_bal_int_subtype_contains, i64 2, [2 x {i64, i64}] [{i64, i64} {i64 -1, i64 -1}, {i64, i64} {i64 1, i64 1}]}, align 8
