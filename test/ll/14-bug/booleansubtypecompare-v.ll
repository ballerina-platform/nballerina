...
30:
  ...
  %65 = call i64 @_bal_array_boolean_compare(ptr addrspace(1) %63, ptr addrspace(1) %64), !dbg !11
  %66 = icmp eq i64 %65, 0
  store i1 %66, ptr %3
  ...
  %82 = call i64 @_bal_array_boolean_compare(ptr addrspace(1) %80, ptr addrspace(1) %81), !dbg !14
  ...
  %99 = call i64 @_bal_array_boolean_compare(ptr addrspace(1) %97, ptr addrspace(1) %98), !dbg !17
  ...
  %116 = call i64 @_bal_array_boolean_compare(ptr addrspace(1) %114, ptr addrspace(1) %115), !dbg !20
  ...
  %133 = call i64 @_bal_array_boolean_compare(ptr addrspace(1) %131, ptr addrspace(1) %132), !dbg !23
  ...
  %150 = call i64 @_bal_array_boolean_compare(ptr addrspace(1) %148, ptr addrspace(1) %149), !dbg !26
  ...
  %167 = call i64 @_bal_array_boolean_compare(ptr addrspace(1) %165, ptr addrspace(1) %166), !dbg !29
  ...
  %184 = call i64 @_bal_array_boolean_compare(ptr addrspace(1) %182, ptr addrspace(1) %183), !dbg !32
  ...
  ret void
199:
  %200 = call ptr addrspace(1) @_bal_panic_construct(i64 1028), !dbg !7
...
!1 = !DIFile(filename:"../../../compiler/testSuite/14-bug/booleansubtypecompare-v.bal", directory:"")
...
!10 = !DILocation(line: 6, column: 18, scope: !5)
