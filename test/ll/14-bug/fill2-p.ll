...
9:
  ...
  %21 = call i64 %20(ptr addrspace(1) %14, i64 1, i64 1)
  %22 = icmp eq i64 %21, 0
...
37:
  ...
  %42 = call i64 %41(ptr addrspace(1) %28, i64 0)
  store i64 %42, ptr %2
  ...
  call void @_Bb02ioprintln(ptr addrspace(1) %55), !dbg !12
  store ptr addrspace(1) null, ptr %4
  ret void
56:
  %57 = call ptr addrspace(1) @_bal_panic_construct(i64 2053), !dbg !7
...
!1 = !DIFile(filename:"../../../compiler/testSuite/14-bug/fill2-p.bal", directory:"")
