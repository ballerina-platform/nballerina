...
%Type0 = type {ptr, i32, i16, i16, [3 x ptr addrspace(1)]}
%FillerDesc = type {ptr}
@_Bi04root0 = constant {i32, i32, i64, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, i64, ptr, [0 x i64]} {i32 0, i32 0, i64 0, ptr @_bal_list_generic_get_tagged, ptr @_bal_list_generic_set_tagged, ptr @_bal_list_generic_inexact_set_tagged, ptr @_bal_list_generic_get_int, ptr @_bal_list_generic_set_int, ptr @_bal_list_generic_inexact_set_int, ptr @_bal_list_generic_get_float, ptr @_bal_list_generic_set_float, ptr @_bal_list_generic_inexact_set_float, i64 ptrtoint(ptr @.member0 to i64), ptr bitcast(ptr @_bal_string_empty_filler_desc to ptr), [0 x i64] []}
@.subtype0 = internal constant %Type0 {ptr @_bal_string_subtype_contains, i32 3, i16 1, i16 1, [3 x ptr addrspace(1)] [ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261567), ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261355), ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261357)]}, align 8
