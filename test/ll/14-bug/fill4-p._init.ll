...
@.subtype0 = internal constant %Type0 {ptr @_bal_string_subtype_contains, i32 2, i16 1, i16 1, [2 x ptr addrspace(1)] [ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261355), ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261357)]}, align 8
