...
define void @_B_main () {
  ...
  %_18 = call i1 @_B_gte (i64 1, i64 2)
  store i1 %_18, i1* %_0, align 8
  %_19 = load i1, i1* %_0, align 8
  call void @_B_printBoolean (i1 %_19)
  store i1 0, i1* %_1, align 8
  %_20 = call i1 @_B_gte (i64 2, i64 1)
  store i1 %_20, i1* %_2, align 8
  %_21 = load i1, i1* %_2, align 8
  call void @_B_printBoolean (i1 %_21)
  store i1 0, i1* %_3, align 8
  %_22 = call i1 @_B_gte (i64 2, i64 -1)
  store i1 %_22, i1* %_5, align 8
  %_23 = load i1, i1* %_5, align 8
  call void @_B_printBoolean (i1 %_23)
  store i1 0, i1* %_6, align 8
  %_24 = call i1 @_B_gte (i64 42, i64 42)
  store i1 %_24, i1* %_7, align 8
  %_25 = load i1, i1* %_7, align 8
  call void @_B_printBoolean (i1 %_25)
  store i1 0, i1* %_8, align 8
  %_26 = call i1 @_B_lte (i64 1, i64 2)
  store i1 %_26, i1* %_9, align 8
  %_27 = load i1, i1* %_9, align 8
  call void @_B_printBoolean (i1 %_27)
  store i1 0, i1* %_10, align 8
  %_28 = call i1 @_B_lte (i64 0, i64 0)
  store i1 %_28, i1* %_11, align 8
  %_29 = load i1, i1* %_11, align 8
  call void @_B_printBoolean (i1 %_29)
  store i1 0, i1* %_12, align 8
  %_30 = call i1 @_B_lte (i64 2, i64 1)
  store i1 %_30, i1* %_13, align 8
  %_31 = load i1, i1* %_13, align 8
  call void @_B_printBoolean (i1 %_31)
  store i1 0, i1* %_14, align 8
  %_32 = call i1 @_B_lte (i64 -1, i64 17)
  store i1 %_32, i1* %_16, align 8
  %_33 = load i1, i1* %_16, align 8
