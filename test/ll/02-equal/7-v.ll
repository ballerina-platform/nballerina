...
39:
  %40 = call ptr addrspace(1) @_B_mkInt(i64 0), !dbg !15
  ...
  %58 = call ptr addrspace(1) @_B_mkNil(), !dbg !20
  ...
  %63 = icmp ne ptr addrspace(1) %59, %62
  store i1 %63, ptr %7
  ...
  %77 = call ptr addrspace(1) @_B_mkBoolean(i1 0), !dbg !23
  store ptr addrspace(1) %77, ptr %10
  %78 = call ptr addrspace(1) @_B_mkNil(), !dbg !24
  ...
  store ptr addrspace(1) %93, ptr %13
  %94 = load ptr addrspace(1), ptr %13
  call void @_Bb02ioprintln(ptr addrspace(1) %94), !dbg !27
  store ptr addrspace(1) null, ptr %14
  %95 = call ptr addrspace(1) @_B_mkBoolean(i1 1), !dbg !28
  store ptr addrspace(1) %95, ptr %15
  %96 = call ptr addrspace(1) @_B_mkNil(), !dbg !29
  store ptr addrspace(1) %96, ptr %16
  %97 = load ptr addrspace(1), ptr %15
  %98 = load ptr addrspace(1), ptr %16
  %99 = call i1 @_bal_exact_eq(ptr addrspace(1) %97, ptr addrspace(1) %98), !dbg !30
  %100 = xor i1 %99, 1
  store i1 %100, ptr %17
  %101 = call ptr addrspace(1) @_bal_list_construct_8(ptr @_Bi04root0, i64 1), !dbg !31
  ...
  call void @_Bb02ioprintln(ptr addrspace(1) %113), !dbg !32
  store ptr addrspace(1) null, ptr %19
  %114 = call ptr addrspace(1) @_B_mkNil(), !dbg !33
  ...
  %119 = icmp ne ptr addrspace(1) %115, %118
  store i1 %119, ptr %21
  %120 = call ptr addrspace(1) @_bal_list_construct_8(ptr @_Bi04root0, i64 1), !dbg !34
  ...
  call void @_Bb02ioprintln(ptr addrspace(1) %151), !dbg !38
  store ptr addrspace(1) null, ptr %27
  %152 = call ptr addrspace(1) @_B_mkBoolean(i1 1), !dbg !39
  ...
  store i1 %157, ptr %29
  %158 = call ptr addrspace(1) @_bal_list_construct_8(ptr @_Bi04root0, i64 1), !dbg !40
  ...
  call void @_Bb02ioprintln(ptr addrspace(1) %170), !dbg !41
  store ptr addrspace(1) null, ptr %31
  %171 = call ptr addrspace(1) @_B_mkBoolean(i1 0), !dbg !42
  ...
  store i1 %176, ptr %33
  %177 = call ptr addrspace(1) @_bal_list_construct_8(ptr @_Bi04root0, i64 1), !dbg !43
  ...
  call void @_Bb02ioprintln(ptr addrspace(1) %189), !dbg !44
  store ptr addrspace(1) null, ptr %35
  ret void
190:
  %191 = call ptr addrspace(1) @_bal_panic_construct(i64 1028), !dbg !13
  call void @_bal_panic(ptr addrspace(1) %191), !dbg !14
  unreachable
}
...
5:
  %6 = call ptr addrspace(1) @_bal_panic_construct(i64 3844), !dbg !45
  call void @_bal_panic(ptr addrspace(1) %6), !dbg !46
  unreachable
}
...
5:
  store i64 %0, ptr %n
  %6 = load i64, ptr %n
  %7 = call ptr addrspace(1) @_bal_int_to_tagged(i64 %6), !dbg !49
  ret ptr addrspace(1) %7
8:
  %9 = call ptr addrspace(1) @_bal_panic_construct(i64 4868), !dbg !47
  call void @_bal_panic(ptr addrspace(1) %9), !dbg !48
  unreachable
}
...
10:
  %11 = call ptr addrspace(1) @_bal_panic_construct(i64 5892), !dbg !50
  call void @_bal_panic(ptr addrspace(1) %11), !dbg !51
  unreachable
}
!llvm.module.flags = !{!0}
!llvm.dbg.cu = !{!2}
