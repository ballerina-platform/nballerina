...
31:
  ...
  store i8 addrspace(1)* %32, i8 addrspace(1)** %2, !dbg !12
  %33 = call i8 addrspace(1)* @_B_mkBoolean(i1 1), !dbg !13
  store i8 addrspace(1)* %33, i8 addrspace(1)** %3, !dbg !13
  ...
  store i8 addrspace(1)* %41, i8 addrspace(1)** %6, !dbg !15
  %42 = call i8 addrspace(1)* @_B_mkBoolean(i1 0), !dbg !16
  store i8 addrspace(1)* %42, i8 addrspace(1)** %7, !dbg !16
  ...
  store i8 addrspace(1)* %51, i8 addrspace(1)** %10, !dbg !18
  %52 = call i8 addrspace(1)* @_B_mkInt(i64 1), !dbg !19
  store i8 addrspace(1)* %52, i8 addrspace(1)** %11, !dbg !19
  ...
  store i8 addrspace(1)* %60, i8 addrspace(1)** %14, !dbg !21
  ...
  store i8 addrspace(1)* %70, i8 addrspace(1)** %17, !dbg !23
...
82:
  ...
  store i8 addrspace(1)* %87, i8 addrspace(1)** %20, !dbg !25
...
97:
  ...
  store i8 addrspace(1)* %102, i8 addrspace(1)** %23, !dbg !27
  ...
  store i8 addrspace(1)* %112, i8 addrspace(1)** %26, !dbg !29
