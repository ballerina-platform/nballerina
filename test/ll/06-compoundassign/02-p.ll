...
6:
  ...
  %8 = call {i64, i1} @llvm.ssub.with.overflow.i64.i64(i64 %7, i64 1)
...
!1 = !DIFile(filename:"../../../compiler/testSuite/06-compoundassign/02-p.bal", directory:"")
