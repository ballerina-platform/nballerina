...
66:
  ...
  unreachable
68:
  %69 = call i8 addrspace(1)* @_bal_panic_construct(i64 772)
...
79:
  %80 = call i8 addrspace(1)* @_bal_panic_construct(i64 1285)
...
88:
  %89 = call i8 addrspace(1)* @_bal_panic_construct(i64 1281)
...
97:
  %98 = or i64 %86, 1280
  %99 = call i8 addrspace(1)* @_bal_panic_construct(i64 %98)
...
114:
  %115 = call i8 addrspace(1)* @_bal_panic_construct(i64 1541)
...
125:
  %126 = call i8 addrspace(1)* @_bal_panic_construct(i64 1797)
...
134:
  %135 = call i8 addrspace(1)* @_bal_panic_construct(i64 1793)
  store i8 addrspace(1)* %135, i8 addrspace(1)** %42
  br label %66
136:
  %137 = load i8 addrspace(1)*, i8 addrspace(1)** %x
  %138 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %137, i64 72057594037927935)
...
143:
  %144 = or i64 %132, 1792
  %145 = call i8 addrspace(1)* @_bal_panic_construct(i64 %144)
...
146:
  ...
  store i64 %151, i64* %8
  %152 = load i64, i64* %8
  %153 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 %152)
  call void @_Bio__println(i8 addrspace(1)* %153)
  store i8 addrspace(1)* null, i8 addrspace(1)** %9
  %154 = load i8 addrspace(1)*, i8 addrspace(1)** %x
  %155 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %154, i64 72057594037927935)
...
160:
  %161 = call i8 addrspace(1)* @_bal_panic_construct(i64 2053)
...
171:
  %172 = call i8 addrspace(1)* @_bal_panic_construct(i64 2309)
...
180:
  %181 = call i8 addrspace(1)* @_bal_panic_construct(i64 2305)
  store i8 addrspace(1)* %181, i8 addrspace(1)** %42
  br label %66
182:
  %183 = load i8 addrspace(1)*, i8 addrspace(1)** %x
  %184 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %183, i64 72057594037927935)
...
189:
  %190 = or i64 %178, 2304
  %191 = call i8 addrspace(1)* @_bal_panic_construct(i64 %190)
...
192:
  ...
  %198 = load i64, i64* %12
  %199 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 %198)
  call void @_Bio__println(i8 addrspace(1)* %199)
  store i8 addrspace(1)* null, i8 addrspace(1)** %13
  %200 = load i8 addrspace(1)*, i8 addrspace(1)** %x
  %201 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %200, i64 72057594037927935)
...
206:
  %207 = call i8 addrspace(1)* @_bal_panic_construct(i64 2565)
...
216:
  %217 = call i8 addrspace(1)* @_bal_panic_construct(i64 2821)
  store i8 addrspace(1)* %217, i8 addrspace(1)** %42
  br label %66
218:
  %219 = call i8 addrspace(1)* @_bal_panic_construct(i64 2818)
...
231:
  %232 = call i8 addrspace(1)* @_bal_panic_construct(i64 2817)
  store i8 addrspace(1)* %232, i8 addrspace(1)** %42
  br label %66
233:
  %234 = load i8 addrspace(1)*, i8 addrspace(1)** %x
  %235 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %234, i64 72057594037927935)
...
240:
  %241 = or i64 %229, 2816
  %242 = call i8 addrspace(1)* @_bal_panic_construct(i64 %241)
...
243:
  ...
  %252 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %251, i64 72057594037927935)
...
257:
  %258 = call i8 addrspace(1)* @_bal_panic_construct(i64 3077)
...
272:
  %273 = call i8 addrspace(1)* @_bal_panic_construct(i64 3333)
  store i8 addrspace(1)* %273, i8 addrspace(1)** %42
  br label %66
274:
  %275 = load i8 addrspace(1)*, i8 addrspace(1)** %x
  %276 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %275, i64 72057594037927935)
...
281:
  %282 = or i64 %270, 3328
  %283 = call i8 addrspace(1)* @_bal_panic_construct(i64 %282)
...
284:
  ...
  %290 = load i64, i64* %20
  %291 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 %290)
  ...
  %293 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %292, i64 72057594037927935)
...
298:
  %299 = call i8 addrspace(1)* @_bal_panic_construct(i64 3589)
...
313:
  %314 = call i8 addrspace(1)* @_bal_panic_construct(i64 3845)
  store i8 addrspace(1)* %314, i8 addrspace(1)** %42
  br label %66
315:
  %316 = load i8 addrspace(1)*, i8 addrspace(1)** %x
  %317 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %316, i64 72057594037927935)
...
322:
  %323 = or i64 %311, 3840
  %324 = call i8 addrspace(1)* @_bal_panic_construct(i64 %323)
...
325:
  ...
  %331 = load i64, i64* %24
  %332 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 %331)
  ...
  %334 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %333, i64 72057594037927935)
...
339:
  %340 = call i8 addrspace(1)* @_bal_panic_construct(i64 4101)
...
354:
  %355 = call i8 addrspace(1)* @_bal_panic_construct(i64 4357)
  store i8 addrspace(1)* %355, i8 addrspace(1)** %42
  br label %66
356:
  %357 = load i8 addrspace(1)*, i8 addrspace(1)** %x
  %358 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %357, i64 72057594037927935)
...
363:
  %364 = or i64 %352, 4352
  %365 = call i8 addrspace(1)* @_bal_panic_construct(i64 %364)
...
366:
  ...
  %372 = load i64, i64* %28
  %373 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 %372)
  ...
  %375 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %374, i64 72057594037927935)
...
380:
  %381 = call i8 addrspace(1)* @_bal_panic_construct(i64 4613)
...
396:
  %397 = call i8 addrspace(1)* @_bal_panic_construct(i64 4869)
  store i8 addrspace(1)* %397, i8 addrspace(1)** %42
  br label %66
398:
  %399 = load i8 addrspace(1)*, i8 addrspace(1)** %x
  %400 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %399, i64 72057594037927935)
...
405:
  %406 = or i64 %394, 4864
  %407 = call i8 addrspace(1)* @_bal_panic_construct(i64 %406)
...
408:
  ...
  %414 = load i64, i64* %32
  %415 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 %414)
  ...
  %417 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %416, i64 72057594037927935)
...
422:
  %423 = call i8 addrspace(1)* @_bal_panic_construct(i64 5125)
...
438:
  %439 = call i8 addrspace(1)* @_bal_panic_construct(i64 5381)
  store i8 addrspace(1)* %439, i8 addrspace(1)** %42
  br label %66
440:
  %441 = load i8 addrspace(1)*, i8 addrspace(1)** %x
  %442 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %441, i64 72057594037927935)
...
447:
  %448 = or i64 %436, 5376
  %449 = call i8 addrspace(1)* @_bal_panic_construct(i64 %448)
...
450:
  ...
  %456 = load i64, i64* %36
  %457 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 %456)
  call void @_Bio__println(i8 addrspace(1)* %457)
  store i8 addrspace(1)* null, i8 addrspace(1)** %37
  %458 = load i8 addrspace(1)*, i8 addrspace(1)** %x
  %459 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %458, i64 72057594037927935)
...
464:
  %465 = call i8 addrspace(1)* @_bal_panic_construct(i64 5637)
...
480:
  %481 = call i8 addrspace(1)* @_bal_panic_construct(i64 5893)
  store i8 addrspace(1)* %481, i8 addrspace(1)** %42
  br label %66
482:
  %483 = load i8 addrspace(1)*, i8 addrspace(1)** %x
  %484 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %483, i64 72057594037927935)
...
489:
  %490 = or i64 %478, 5888
  %491 = call i8 addrspace(1)* @_bal_panic_construct(i64 %490)
...
492:
  ...
  %498 = load i64, i64* %40
  %499 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 %498)
  call void @_Bio__println(i8 addrspace(1)* %499)
  store i8 addrspace(1)* null, i8 addrspace(1)** %41
  ret void
500:
  %501 = call i8 addrspace(1)* @_bal_panic_construct(i64 6149)
