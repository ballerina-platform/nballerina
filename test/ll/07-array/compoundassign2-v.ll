...
43:
  ...
  %57 = getelementptr i8, i8 addrspace(1)* %51, i64 1297036692682702848
...
65:
  ...
  unreachable
67:
  %68 = call i8 addrspace(1)* @_bal_panic_construct(i64 772)
...
101:
  %102 = call i8 addrspace(1)* @_bal_panic_construct(i64 1285)
...
110:
  %111 = or i64 %99, 1280
  %112 = call i8 addrspace(1)* @_bal_panic_construct(i64 %111)
...
113:
  ...
  %122 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %121, i64 72057594037927935)
...
127:
  %128 = call i8 addrspace(1)* @_bal_panic_construct(i64 1541)
...
138:
  %139 = call i8 addrspace(1)* @_bal_panic_construct(i64 1797)
...
147:
  %148 = call i8 addrspace(1)* @_bal_panic_construct(i64 1793)
...
156:
  %157 = or i64 %145, 1792
  %158 = call i8 addrspace(1)* @_bal_panic_construct(i64 %157)
...
159:
  ...
  %168 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %167, i64 72057594037927935)
...
173:
  %174 = call i8 addrspace(1)* @_bal_panic_construct(i64 2053)
...
175:
  ...
  %182 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %181, i64 72057594037927935)
...
187:
  %188 = call i8 addrspace(1)* @_bal_panic_construct(i64 2309)
...
189:
  ...
  %196 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %195, i64 72057594037927935)
...
201:
  %202 = call i8 addrspace(1)* @_bal_panic_construct(i64 2309)
...
213:
  %214 = call i8 addrspace(1)* @_bal_panic_construct(i64 2309)
...
221:
  %222 = call i8 addrspace(1)* @_bal_panic_construct(i64 2305)
...
230:
  %231 = call i8 addrspace(1)* @_bal_panic_construct(i64 2305)
  store i8 addrspace(1)* %231, i8 addrspace(1)** %39
  br label %65
232:
  %233 = load i8 addrspace(1)*, i8 addrspace(1)** %x
  %234 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %233, i64 72057594037927935)
...
239:
  %240 = or i64 %228, 2304
  %241 = call i8 addrspace(1)* @_bal_panic_construct(i64 %240)
...
242:
  ...
  %260 = getelementptr i8, i8 addrspace(1)* %254, i64 1297036692682702848
  ...
  %263 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %262, i64 72057594037927935)
...
268:
  %269 = call i8 addrspace(1)* @_bal_panic_construct(i64 2565)
...
281:
  %282 = call i8 addrspace(1)* @_bal_panic_construct(i64 3077)
  store i8 addrspace(1)* %282, i8 addrspace(1)** %39
  br label %65
283:
  %284 = load i8 addrspace(1)*, i8 addrspace(1)** %s
  %285 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %284, i64 72057594037927935)
...
290:
  %291 = or i64 %279, 3072
  %292 = call i8 addrspace(1)* @_bal_panic_construct(i64 %291)
...
293:
  ...
  %298 = load i8 addrspace(1)*, i8 addrspace(1)** %22
...
303:
  %304 = call i8 addrspace(1)* @_bal_panic_construct(i64 3333)
  store i8 addrspace(1)* %304, i8 addrspace(1)** %39
  br label %65
305:
  %306 = call i64 @_B_func1()
  store i64 %306, i64* %24
  %307 = load i64, i64* %24
  %308 = load i8 addrspace(1)*, i8 addrspace(1)** %x
  %309 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %308, i64 72057594037927935)
...
314:
  %315 = or i64 %301, 3584
  %316 = call i8 addrspace(1)* @_bal_panic_construct(i64 %315)
...
326:
  %327 = call i8 addrspace(1)* @_bal_panic_construct(i64 3845)
...
336:
  %337 = call i8 addrspace(1)* @_bal_panic_construct(i64 3841)
  store i8 addrspace(1)* %337, i8 addrspace(1)** %39
  br label %65
338:
  %339 = load i8 addrspace(1)*, i8 addrspace(1)** %x
  %340 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %339, i64 72057594037927935)
...
345:
  %346 = or i64 %334, 3840
  %347 = call i8 addrspace(1)* @_bal_panic_construct(i64 %346)
...
348:
  ...
  %354 = load i64, i64* %27
  %355 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 %354)
  ...
  %357 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %356, i64 72057594037927935)
...
362:
  %363 = call i8 addrspace(1)* @_bal_panic_construct(i64 4101)
...
373:
  %374 = call i8 addrspace(1)* @_bal_panic_construct(i64 4357)
...
382:
  %383 = call i8 addrspace(1)* @_bal_panic_construct(i64 4353)
  store i8 addrspace(1)* %383, i8 addrspace(1)** %39
  br label %65
384:
  %385 = load i8 addrspace(1)*, i8 addrspace(1)** %x
  %386 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %385, i64 72057594037927935)
...
391:
  %392 = or i64 %380, 4352
  %393 = call i8 addrspace(1)* @_bal_panic_construct(i64 %392)
...
394:
  ...
  %400 = load i64, i64* %31
  %401 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 %400)
  call void @_Bio__println(i8 addrspace(1)* %401)
  store i8 addrspace(1)* null, i8 addrspace(1)** %32
  %402 = call i64 @_B_func1()
  store i64 %402, i64* %33
  %403 = load i64, i64* %33
  %404 = load i8 addrspace(1)*, i8 addrspace(1)** %x
  %405 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %404, i64 72057594037927935)
...
410:
  %411 = call i8 addrspace(1)* @_bal_panic_construct(i64 4613)
...
412:
  ...
  %418 = call i64 @_B_func2()
  store i64 %418, i64* %35
  %419 = load i64, i64* %34
  %420 = load i64, i64* %35
...
423:
  %424 = call i8 addrspace(1)* @_bal_panic_construct(i64 4869)
...
433:
  %434 = call i8 addrspace(1)* @_bal_panic_construct(i64 4865)
  store i8 addrspace(1)* %434, i8 addrspace(1)** %39
  br label %65
435:
  %436 = load i8 addrspace(1)*, i8 addrspace(1)** %x
  %437 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %436, i64 72057594037927935)
...
442:
  %443 = or i64 %431, 4864
  %444 = call i8 addrspace(1)* @_bal_panic_construct(i64 %443)
...
445:
  ...
  %451 = load i64, i64* %37
  %452 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 %451)
  call void @_Bio__println(i8 addrspace(1)* %452)
  store i8 addrspace(1)* null, i8 addrspace(1)** %38
  ret void
453:
  %454 = call i8 addrspace(1)* @_bal_panic_construct(i64 5381)
  store i8 addrspace(1)* %454, i8 addrspace(1)** %39
  br label %65
}
define internal i64 @_B_func1() {
  %1 = alloca i8 addrspace(1)*
  %2 = alloca i8
...
5:
  call void @_Bio__println(i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098475656240854374))
  store i8 addrspace(1)* null, i8 addrspace(1)** %1
  ret i64 1
6:
  %7 = call i8 addrspace(1)* @_bal_panic_construct(i64 6148)
  call void @_bal_panic(i8 addrspace(1)* %7)
  unreachable
}
define internal i64 @_B_func2() {
  %1 = alloca i8 addrspace(1)*
  %2 = alloca i8
  %3 = load i8*, i8** @_bal_stack_guard
  %4 = icmp ult i8* %2, %3
  br i1 %4, label %6, label %5
5:
  call void @_Bio__println(i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098475660535821670))
  store i8 addrspace(1)* null, i8 addrspace(1)** %1
  ret i64 2
6:
  %7 = call i8 addrspace(1)* @_bal_panic_construct(i64 7428)
  call void @_bal_panic(i8 addrspace(1)* %7)
  unreachable
}
