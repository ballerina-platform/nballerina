...
7:
  ...
  %22 = call i64 %18(i8 addrspace(1)* %12, i64 1, i8 addrspace(1)* %21)
  %23 = icmp eq i64 %22, 0
...
41:
  ...
  br label %24
44:
  %45 = load i8 addrspace(1)*, i8 addrspace(1)** %x, !dbg !8
