...
48:
  %49 = call i8 addrspace(1)* @_bal_panic_construct(i64 1541)
...
60:
  %61 = call i8 addrspace(1)* @_bal_panic_construct(i64 1541)
...
62:
  ...
  ret void
66:
  %67 = call i8 addrspace(1)* @_bal_panic_construct(i64 1537)
