...
9:
  ...
  %20 = call i64 @_bal_list_set(i8 addrspace(1)* %19, i64 0, i8 addrspace(1)* null)
  %21 = icmp eq i64 %20, 0
...
26:
  ...
  %28 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %27, i64 72057594037927935)
