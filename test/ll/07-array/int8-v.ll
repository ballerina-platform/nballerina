...
10:
  %11 = call {{i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*}*, i64, i64, i8* addrspace(1)*} addrspace(1)* @_bal_list_construct({i32}* @_Bi04root0, i64 3)
  ...
  store i64 2, i64 addrspace(1)* %16
  %17 = getelementptr inbounds [0 x i64], [0 x i64] addrspace(1)* %14, i64 0, i64 2
  ...
  %19 = bitcast {{i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*}*, i64, i64, i8* addrspace(1)*} addrspace(1)* %11 to i8 addrspace(1)*
  ...
  store i8 addrspace(1)* %21, i8 addrspace(1)** %iv
  %22 = load i8 addrspace(1)*, i8 addrspace(1)** %iv
  %23 = call i8 addrspace(1)* @_bal_tagged_clear_exact_ptr(i8 addrspace(1)* %22)
  store i8 addrspace(1)* %23, i8 addrspace(1)** %v
  %24 = load i8 addrspace(1)*, i8 addrspace(1)** %v
  %25 = call i1 @_bal_type_contains({i32, i32, [0 x i8*]}* @_Bt04root1, i8 addrspace(1)* %24)
  br i1 %25, label %30, label %42
26:
  %27 = load i8 addrspace(1)*, i8 addrspace(1)** %6
...
28:
  ...
  unreachable
30:
  %31 = call i8 addrspace(1)* @_bal_structure_exactify(i8 addrspace(1)* %24, i32* @_Be04root0)
  store i8 addrspace(1)* %31, i8 addrspace(1)** %2
  %32 = load i8 addrspace(1)*, i8 addrspace(1)** %2
  store i8 addrspace(1)* %32, i8 addrspace(1)** %iv2
  %33 = load i8 addrspace(1)*, i8 addrspace(1)** %iv2, !dbg !8
  %34 = call i8 addrspace(1)* @_bal_tagged_clear_exact_ptr(i8 addrspace(1)* %33), !dbg !8
  call void @_Bb02ioprintln(i8 addrspace(1)* %34), !dbg !8
  store i8 addrspace(1)* null, i8 addrspace(1)** %3, !dbg !8
  %35 = load i8 addrspace(1)*, i8 addrspace(1)** %iv
  %36 = load i8 addrspace(1)*, i8 addrspace(1)** %iv2
  %37 = call i1 @_bal_exact_eq(i8 addrspace(1)* %35, i8 addrspace(1)* %36)
  store i1 %37, i1* %4
  %38 = load i1, i1* %4, !dbg !9
  ...
  ret void
42:
  %43 = call i8 addrspace(1)* @_bal_panic_construct(i64 1795), !dbg !7
