...
9:
  ...
  %13 = bitcast i8* addrspace(1)* %12 to [0 x double] addrspace(1)*
  %14 = getelementptr inbounds [0 x double], [0 x double] addrspace(1)* %13, i64 0, i64 0
  store double 1.0, double addrspace(1)* %14
...
27:
  ...
  unreachable
29:
  %30 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %19, i64 4)
  %31 = icmp ne i8 addrspace(1)* %30, null
...
34:
  ...
  %37 = bitcast i8* addrspace(1)* %36 to [0 x double] addrspace(1)*
  %38 = getelementptr inbounds [0 x double], [0 x double] addrspace(1)* %37, i64 0, i64 0
  %39 = load double, double addrspace(1)* %38, align 8
