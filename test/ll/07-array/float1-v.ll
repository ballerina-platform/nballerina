...
52:
  %53 = call i8 addrspace(1)* @_bal_panic_construct(i64 1541)
...
69:
  %70 = call i8 addrspace(1)* @_bal_panic_construct(i64 1541)
...
71:
  ...
  ret void
82:
  %83 = call i8 addrspace(1)* @_bal_panic_construct(i64 1541)
