...
9:
  ...
  %19 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 17), !dbg !8
  call void @_Bb0m4lang5arraypush(i8 addrspace(1)* %18, i8 addrspace(1)* %19), !dbg !8
  store i8 addrspace(1)* null, i8 addrspace(1)** %2, !dbg !8
  %20 = load i8 addrspace(1)*, i8 addrspace(1)** %v, !dbg !9
  call void @_Bb0m4lang5arraypush(i8 addrspace(1)* %20, i8 addrspace(1)* null), !dbg !9
  store i8 addrspace(1)* null, i8 addrspace(1)** %3, !dbg !9
  %21 = load i8 addrspace(1)*, i8 addrspace(1)** %v, !dbg !10
  %22 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 21), !dbg !10
  call void @_Bb0m4lang5arraypush(i8 addrspace(1)* %21, i8 addrspace(1)* %22), !dbg !10
  store i8 addrspace(1)* null, i8 addrspace(1)** %4, !dbg !10
  %23 = load i8 addrspace(1)*, i8 addrspace(1)** %v, !dbg !11
  %24 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %23, i64 -5), !dbg !11
