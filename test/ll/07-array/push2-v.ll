...
9:
  ...
  %15 = and i64 72057594037927935, 17
  %16 = or i64 2449958197289549824, %15
  %17 = getelementptr i8, ptr addrspace(1) null, i64 %16
  call void @_Bb0m4lang5arraypush(ptr addrspace(1) %14, ptr addrspace(1) %17), !dbg !10
  store ptr addrspace(1) null, ptr %2
  %18 = load ptr addrspace(1), ptr %v
  %19 = and i64 72057594037927935, 21
  %20 = or i64 2449958197289549824, %19
  %21 = getelementptr i8, ptr addrspace(1) null, i64 %20
  call void @_Bb0m4lang5arraypush(ptr addrspace(1) %18, ptr addrspace(1) %21), !dbg !11
  store ptr addrspace(1) null, ptr %3
  %22 = call ptr addrspace(1) @_bal_list_construct_8(ptr @_Bi04root1, i64 1), !dbg !12
  ...
  %27 = call ptr addrspace(1) @_bal_tagged_clear_exact_ptr(ptr addrspace(1) %26), !dbg !13
