...
6:
  ...
  %11 = getelementptr inbounds [0 x i64], ptr addrspace(1) %10, i64 0, i64 0
  store i64 1, ptr addrspace(1) %11
  %12 = getelementptr inbounds [0 x i64], ptr addrspace(1) %10, i64 0, i64 1
  store i64 2, ptr addrspace(1) %12
  %13 = getelementptr inbounds [0 x i64], ptr addrspace(1) %10, i64 0, i64 2
  store i64 3, ptr addrspace(1) %13
  ...
  call void @_B_foo(ptr addrspace(1) %17), !dbg !12
...
7:
  ...
  ret void
19:
  %20 = call ptr addrspace(1) @_bal_panic_construct(i64 1796), !dbg !13
