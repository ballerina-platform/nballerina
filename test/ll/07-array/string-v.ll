...
7:
  ...
  %13 = call i64 @_bal_list_set(i8 addrspace(1)* %12, i64 1, i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098476543630901112))
  %14 = icmp eq i64 %13, 0
...
15:
  ...
  unreachable
17:
  %18 = call i8 addrspace(1)* @_bal_panic_construct(i64 1028), !dbg !7
  call void @_bal_panic(i8 addrspace(1)* %18)
  unreachable
19:
  %20 = load i8 addrspace(1)*, i8 addrspace(1)** %x
  %21 = call i64 @_bal_list_set(i8 addrspace(1)* %20, i64 3, i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098476543630901113))
  %22 = icmp eq i64 %21, 0
  br i1 %22, label %26, label %29
23:
  %24 = or i64 %13, 1536
  %25 = call i8 addrspace(1)* @_bal_panic_construct(i64 %24), !dbg !7
  store i8 addrspace(1)* %25, i8 addrspace(1)** %3
  br label %15
26:
  %27 = load i8 addrspace(1)*, i8 addrspace(1)** %x, !dbg !8
