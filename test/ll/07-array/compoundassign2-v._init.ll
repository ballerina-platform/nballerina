...
@_Bi04root1 = constant {i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i32} {i32 1, i8 addrspace(1)*(i8 addrspace(1)*, i64)* @_bal_list_get, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)* @_bal_list_set, i32 1024}
