...
@_Bt0m4root6types10 = external constant {i32, i32, [0 x ptr]}
...
define ptr addrspace(1) @_B0m4root6types1create(i64 %0, double %1) !dbg !5 {
  %i = alloca i64
  %f = alloca double
...
7:
  ...
  %8 = call ptr addrspace(1) @_bal_mapping_construct(ptr @_Bi0m4root6types10, i64 2), !dbg !11
  %9 = load double, ptr %f
...
define i1 @_B0m4root6types1test(ptr addrspace(1) %0) !dbg !7 {
...
6:
  ...
  %8 = call i1 @_bal_type_contains(ptr @_Bt0m4root6types10, ptr addrspace(1) %7), !dbg !18
  store i1 %8, ptr %2
  %9 = load i1, ptr %2
  ret i1 %9
10:
...
!1 = !DIFile(filename:"../../../compiler/testSuite/12-inclusive/import1-v.modules/types1/types.bal", directory:"../../../compiler/testSuite/12-inclusive/import1-v.modules/types1")
