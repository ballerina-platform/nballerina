...
7:
  ...
  %10 = call i8 addrspace(1)* @_bal_mapping_get(i8 addrspace(1)* %9, i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098476543630901112))
  ...
  ret void
15:
  %16 = call i8 addrspace(1)* @_bal_panic_construct(i64 2052), !dbg !9
...
11:
  %12 = call i8 addrspace(1)* @_bal_panic_construct(i64 3332), !dbg !12
