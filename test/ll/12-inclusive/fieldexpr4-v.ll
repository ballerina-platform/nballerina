...
7:
  ...
  %11 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 48)
  call void @_bal_mapping_init_member(i8 addrspace(1)* %8, i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098476543630901114), i8 addrspace(1)* %11)
  ...
  %14 = call i8 addrspace(1)* @_bal_mapping_get(i8 addrspace(1)* %13, i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098476543630901114))
  store i8 addrspace(1)* %14, i8 addrspace(1)** %2
  %15 = load i8 addrspace(1)*, i8 addrspace(1)** %2
  store i8 addrspace(1)* %15, i8 addrspace(1)** %z
  %16 = load i8 addrspace(1)*, i8 addrspace(1)** %z, !dbg !8
  call void @_Bb02ioprintln(i8 addrspace(1)* %16), !dbg !8
  store i8 addrspace(1)* null, i8 addrspace(1)** %3, !dbg !8
  ret void
17:
  %18 = call i8 addrspace(1)* @_bal_panic_construct(i64 2308), !dbg !7
...
!1 = !DIFile(filename:"../../../compiler/testSuite/12-inclusive/fieldexpr4-v.bal", directory:"")
