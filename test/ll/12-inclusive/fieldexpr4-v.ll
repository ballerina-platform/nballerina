...
8:
  ...
  %16 = and i64 72057594037927935, 48
  ...
  %21 = call ptr addrspace(1) @_bal_mapping_get(ptr addrspace(1) %20, ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261434)), !dbg !13
  store ptr addrspace(1) %21, ptr %2
  %22 = load ptr addrspace(1), ptr %2
  store ptr addrspace(1) %22, ptr %z
...
!10 = !DILocation(line: 10, column: 14, scope: !5)
!11 = !DILocation(line: 10, column: 14, scope: !5)
!12 = !DILocation(line: 10, column: 14, scope: !5)
!13 = !DILocation(line: 11, column: 14, scope: !5)
