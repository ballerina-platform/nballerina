...
8:
  ...
  %15 = call i8 addrspace(1)* @_bal_mapping_get(i8 addrspace(1)* %14, i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* addrspacecast(i8* bitcast({i16, i16, [12 x i8]}* @.str3 to i8*) to i8 addrspace(1)*), i64 720575940379279360))
  %16 = call i8 addrspace(1)* @_bal_tagged_member_clear_exact_any(i8 addrspace(1)* %14, i8 addrspace(1)* %15)
  store i8 addrspace(1)* %16, i8 addrspace(1)** %3
  %17 = load i8 addrspace(1)*, i8 addrspace(1)** %3, !dbg !11
...
6:
  ...
  %8 = call i64 @_bal_mapping_set(i8 addrspace(1)* %7, i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* addrspacecast(i8* bitcast({i16, i16, [12 x i8]}* @.str3 to i8*) to i8 addrspace(1)*), i64 720575940379279360), i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* addrspacecast(i8* bitcast({i16, i16, [12 x i8]}* @.str4 to i8*) to i8 addrspace(1)*), i64 720575940379279360))
  %9 = icmp eq i64 %8, 0
