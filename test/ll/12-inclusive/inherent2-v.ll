...
@.str3 = internal unnamed_addr constant {i16, i16, [12 x i8]} {i16 11, i16 11, [12 x i8] c"dateOfBirth\00"}, align 8
@_Bi04root1 = external constant {i32}
@.str4 = internal unnamed_addr constant {i16, i16, [12 x i8]} {i16 8, i16 8, [12 x i8] c"long ago\00\00\00\00"}, align 8
...
9:
  ...
  %18 = call ptr addrspace(1) @_bal_mapping_get(ptr addrspace(1) %17, ptr addrspace(1) getelementptr(i8, ptr addrspace(1) addrspacecast(ptr bitcast(ptr @.str3 to ptr) to ptr addrspace(1)), i64 360287970189639680)), !dbg !16
  %19 = call ptr addrspace(1) @_bal_tagged_member_clear_exact_any(ptr addrspace(1) %17, ptr addrspace(1) %18), !dbg !17
  ...
  %25 = call ptr addrspace(1) @_bal_tagged_clear_exact_any(ptr addrspace(1) %24), !dbg !19
...
6:
  ...
  %8 = call i64 @_bal_mapping_set(ptr addrspace(1) %7, ptr addrspace(1) getelementptr(i8, ptr addrspace(1) addrspacecast(ptr bitcast(ptr @.str3 to ptr) to ptr addrspace(1)), i64 360287970189639680), ptr addrspace(1) getelementptr(i8, ptr addrspace(1) addrspacecast(ptr bitcast(ptr @.str4 to ptr) to ptr addrspace(1)), i64 360287970189639680)), !dbg !23
  %9 = icmp eq i64 %8, 0
...
!1 = !DIFile(filename:"../../../compiler/testSuite/12-inclusive/inherent2-v.bal", directory:"")
