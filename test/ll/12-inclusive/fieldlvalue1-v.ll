...
9:
  ...
  %22 = call i64 @_bal_mapping_set(ptr addrspace(1) %18, ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261432), ptr addrspace(1) %21), !dbg !12
  %23 = icmp eq i64 %22, 0
...
28:
  ...
  %30 = call ptr addrspace(1) @_bal_mapping_get(ptr addrspace(1) %29, ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261432)), !dbg !13
  %31 = call i64 @_bal_tagged_to_int(ptr addrspace(1) %30), !dbg !14
  store i64 %31, ptr %2
  ...
  %36 = load i64, ptr %2
  %37 = call ptr addrspace(1) @_bal_int_to_tagged(i64 %36), !dbg !16
...
!1 = !DIFile(filename:"../../../compiler/testSuite/12-inclusive/fieldlvalue1-v.bal", directory:"")
