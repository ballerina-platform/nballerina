...
@_Bi04root0 = constant {i32, i32, i64, {i32}*, [2 x i64]} {i32 0, i32 2, i64 ptrtoint({i32, i32, [2 x %UniformSubtype*]}* @.member0 to i64), {i32}* null, [2 x i64] [i64 257, i64 513]}
...
@_Bi04root4 = constant {i32, i32, i64, {i32}*, [2 x i64]} {i32 1, i32 2, i64 ptrtoint({i32, i32, [2 x %UniformSubtype*]}* @.member0 to i64), {i32}* null, [2 x i64] [i64 259, i64 515]}
@_Bi04root5 = constant {i32, i32, i64, {i32}*, [0 x i64]} {i32 2, i32 0, i64 16773119, {i32}* null, [0 x i64] []}
