...
%FillerDesc = type {ptr}
@_Bi04root0 = constant {i32, i32, i64, ptr, [2 x i64]} {i32 0, i32 2, i64 ptrtoint(ptr @.member0 to i64), ptr bitcast(ptr @_bal_nil_filler_desc to ptr), [2 x i64] [i64 9, i64 17]}
...
@_Bi04root2 = constant {i32, i32, i64, ptr, [2 x i64]} {i32 1, i32 2, i64 ptrtoint(ptr @.member0 to i64), ptr bitcast(ptr @_bal_nil_filler_desc to ptr), [2 x i64] [i64 11, i64 19]}
@_Bi04root4 = constant {i32, i32, i64, ptr, [0 x i64]} {i32 2, i32 0, i64 262015, ptr bitcast(ptr @_bal_nil_filler_desc to ptr), [0 x i64] []}
@.subtype2 = internal constant {ptr, i32, [1 x i32]} {ptr @_bal_precomputed_subtype_contains, i32 1, [1 x i32] [i32 0]}, align 8
@_Bt04root0 = constant {i32, i32, [1 x ptr]} {i32 0, i32 8192, [1 x ptr] [ptr bitcast(ptr @.subtype2 to ptr)]}
@.subtype3 = internal constant {ptr, i32, [2 x i32]} {ptr @_bal_precomputed_subtype_contains, i32 2, [2 x i32] [i32 0, i32 1]}, align 8
@_Bt04root2 = constant {i32, i32, [1 x ptr]} {i32 0, i32 8192, [1 x ptr] [ptr bitcast(ptr @.subtype3 to ptr)]}
@.subtype4 = internal constant {ptr, i32, [0 x i32]} {ptr @_bal_precomputed_subtype_contains, i32 0, [0 x i32] []}, align 8
@_Bt04root3 = constant {i32, i32, [1 x ptr]} {i32 0, i32 8192, [1 x ptr] [ptr bitcast(ptr @.subtype4 to ptr)]}
@.subtype5 = internal constant {ptr, i32} {ptr @_bal_map_subtype_contains, i32 131007}, align 8
