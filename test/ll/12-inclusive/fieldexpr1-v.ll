...
7:
  ...
  %12 = load i8 addrspace(1)*, i8 addrspace(1)** %p
  %13 = call i8 addrspace(1)* @_bal_mapping_get(i8 addrspace(1)* %12, i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098476543630901112))
  %14 = call i64 @_bal_tagged_to_int(i8 addrspace(1)* %13)
  store i64 %14, i64* %2
  %15 = load i64, i64* %2
  store i64 %15, i64* %x
  %16 = load i64, i64* %x, !dbg !8
  %17 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 %16), !dbg !8
  call void @_Bb02ioprintln(i8 addrspace(1)* %17), !dbg !8
  store i8 addrspace(1)* null, i8 addrspace(1)** %3, !dbg !8
  ret void
18:
  %19 = call i8 addrspace(1)* @_bal_panic_construct(i64 2052), !dbg !7
...
!1 = !DIFile(filename:"../../../compiler/testSuite/12-inclusive/fieldexpr1-v.bal", directory:"")
