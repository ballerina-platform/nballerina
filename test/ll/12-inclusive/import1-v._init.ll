...
@_Bi04root0 = constant {i32, i32, i64, [2 x i64]} {i32 0, i32 2, i64 ptrtoint({i32, i32, [2 x %UniformSubtype*]}* @.member0 to i64), [2 x i64] [i64 513, i64 257]}
...
@_Bi04root3 = constant {i32, i32, i64, [2 x i64]} {i32 1, i32 2, i64 ptrtoint({i32, i32, [2 x %UniformSubtype*]}* @.member1 to i64), [2 x i64] [i64 515, i64 259]}
...
@_Bi0m4root6types20 = constant {i32, i32, i64, [2 x i64]} {i32 2, i32 2, i64 ptrtoint({i32, i32, [2 x %UniformSubtype*]}* @.member2 to i64), [2 x i64] [i64 513, i64 257]}
...
@_Bi0m4root6types10 = alias {i32, i32, i64, [2 x i64]}, {i32, i32, i64, [2 x i64]}* @_Bi04root0
