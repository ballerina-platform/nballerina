...
8:
  ...
  %15 = call ptr addrspace(1) @_bal_mapping_get(ptr addrspace(1) %14, ptr addrspace(1) getelementptr(i8, ptr addrspace(1) addrspacecast(ptr bitcast(ptr @.str1 to ptr) to ptr addrspace(1)), i64 360287970189639680)), !dbg !12
...
!1 = !DIFile(filename:"../../../compiler/testSuite/12-inclusive/inline1-v.bal", directory:"")
