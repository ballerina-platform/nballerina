...
@_Bi04root0 = constant {i32, i32, i64, {i32}*, [3 x i64]} {i32 0, i32 3, i64 ptrtoint({i32, i32, [2 x %UniformSubtype*]}* @.member0 to i64), {i32}* null, [3 x i64] [i64 257, i64 257, i64 259]}
