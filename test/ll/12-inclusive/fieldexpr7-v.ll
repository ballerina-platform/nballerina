...
5:
  %6 = call i8 addrspace(1)* @_bal_mapping_construct({i32}* @_Bi04root0, i64 3)
  ...
  %9 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 10)
  call void @_bal_mapping_init_member(i8 addrspace(1)* %6, i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098476543630901114), i8 addrspace(1)* %9)
  store i8 addrspace(1)* %6, i8 addrspace(1)** %1
  %10 = load i8 addrspace(1)*, i8 addrspace(1)** %1
  store i8 addrspace(1)* %10, i8 addrspace(1)** %p
  %11 = load i8 addrspace(1)*, i8 addrspace(1)** %p
  ret i8 addrspace(1)* %11
12:
  %13 = call i8 addrspace(1)* @_bal_panic_construct(i64 3076), !dbg !12
