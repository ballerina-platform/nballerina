...
18:
  ...
  %29 = call ptr addrspace(1) @_bal_mapping_get(ptr addrspace(1) %28, ptr addrspace(1) getelementptr(i8, ptr addrspace(1) addrspacecast(ptr bitcast(ptr @.str1 to ptr) to ptr addrspace(1)), i64 360287970189639680)), !dbg !14
  ...
  %45 = call ptr addrspace(1) @_bal_mapping_get(ptr addrspace(1) %44, ptr addrspace(1) getelementptr(i8, ptr addrspace(1) addrspacecast(ptr bitcast(ptr @.str0 to ptr) to ptr addrspace(1)), i64 360287970189639680)), !dbg !19
  ...
  %65 = call ptr addrspace(1) @_bal_mapping_get(ptr addrspace(1) %64, ptr addrspace(1) getelementptr(i8, ptr addrspace(1) addrspacecast(ptr bitcast(ptr @.str2 to ptr) to ptr addrspace(1)), i64 360287970189639680)), !dbg !22
...
!1 = !DIFile(filename:"../../../compiler/testSuite/12-inclusive/fieldexpr5-v.bal", directory:"")
...
!9 = !DILocation(line: 8, column: 10, scope: !5)
