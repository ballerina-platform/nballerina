...
9:
  ...
  %17 = call i8 addrspace(1)* @_bal_tagged_member_clear_exact_any(i8 addrspace(1)* %15, i8 addrspace(1)* %16)
  store i8 addrspace(1)* %17, i8 addrspace(1)** %2
  %18 = load i8 addrspace(1)*, i8 addrspace(1)** %2, !dbg !8
  %19 = call i8 addrspace(1)* @_bal_tagged_clear_exact_any(i8 addrspace(1)* %18), !dbg !8
  ...
  %22 = call i8 addrspace(1)* @_bal_mapping_get(i8 addrspace(1)* %21, i8 addrspace(1)* %20)
  %23 = call i8 addrspace(1)* @_bal_tagged_member_clear_exact_any(i8 addrspace(1)* %21, i8 addrspace(1)* %22)
  store i8 addrspace(1)* %23, i8 addrspace(1)** %4
  %24 = load i8 addrspace(1)*, i8 addrspace(1)** %4, !dbg !9
  %25 = call i8 addrspace(1)* @_bal_tagged_clear_exact_any(i8 addrspace(1)* %24), !dbg !9
  call void @_Bb02ioprintln(i8 addrspace(1)* %25), !dbg !9
  store i8 addrspace(1)* null, i8 addrspace(1)** %5, !dbg !9
  ret void
26:
  %27 = call i8 addrspace(1)* @_bal_panic_construct(i64 2052), !dbg !7
