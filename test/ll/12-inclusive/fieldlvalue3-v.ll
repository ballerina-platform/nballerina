...
30:
  ...
  %35 = call i64 @_bal_mapping_set(ptr addrspace(1) %32, ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261432), ptr addrspace(1) %34), !dbg !15
  %36 = icmp eq i64 %35, 0
...
39:
  ...
  %41 = call ptr addrspace(1) @_bal_mapping_get(ptr addrspace(1) %40, ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261432)), !dbg !16
...
!1 = !DIFile(filename:"../../../compiler/testSuite/12-inclusive/fieldlvalue3-v.bal", directory:"")
