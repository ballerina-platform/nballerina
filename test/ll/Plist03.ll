...
44:
  %45 = call i8 addrspace(1)* @_bal_panic_construct(i64 2049)
...
46:
  ...
  br label %20
49:
  %50 = call i8 addrspace(1)* @_bal_panic_construct(i64 2305)
...
62:
  ...
  ret void
68:
  %69 = call i8 addrspace(1)* @_bal_panic_construct(i64 3077)
