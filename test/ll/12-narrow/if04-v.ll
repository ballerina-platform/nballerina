...
31:
  ...
  store double %33, double* %x.4
  %34 = load double, double* %x.4
  store double %34, double* %f
  %35 = load double, double* %f, !dbg !8
  %36 = call i8 addrspace(1)* @_bal_float_to_tagged(double %35), !dbg !8
...
!1 = !DIFile(filename:"../../../compiler/testSuite/12-narrow/if04-v.bal", directory:"")
