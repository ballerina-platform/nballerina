...
6:
  store i1 1, ptr %b
  %7 = and i64 72057594037927935, 84
...
18:
  ...
  %20 = call double @_bal_tagged_to_float(ptr addrspace(1) %19), !dbg !11
  store double %20, ptr %x.1
  ret void
21:
  %22 = load ptr addrspace(1), ptr %x
  store ptr addrspace(1) %22, ptr %x.2
  %23 = load ptr addrspace(1), ptr %x.2
  store ptr addrspace(1) %23, ptr %_
  %24 = load ptr addrspace(1), ptr %x.2
  store ptr addrspace(1) %24, ptr %ib
  ...
  %29 = load ptr addrspace(1), ptr %ib
  %30 = getelementptr inbounds [0 x ptr addrspace(1)], ptr addrspace(1) %28, i64 0, i64 0
  store ptr addrspace(1) %29, ptr addrspace(1) %30
  %31 = getelementptr inbounds {ptr, i64, i64, ptr addrspace(1)}, ptr addrspace(1) %25, i64 0, i32 1
  store i64 1, ptr addrspace(1) %31
  %32 = bitcast ptr addrspace(1) %25 to ptr addrspace(1)
...
!11 = !DILocation(line: 16, column: 0, scope: !5)
