...
32:
  ret i64 -1
33:
  %34 = call i8 addrspace(1)* @_bal_panic_construct(i64 2308)
...
5:
  ...
  ret i64 %6
7:
  %8 = call i8 addrspace(1)* @_bal_panic_construct(i64 5380)
...
5:
  ...
  ret i64 %6
7:
  %8 = call i8 addrspace(1)* @_bal_panic_construct(i64 6404)
  call void @_bal_panic(i8 addrspace(1)* %8)
  unreachable
}
