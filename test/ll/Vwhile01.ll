...
20:
  ret void
21:
  %22 = call i8 addrspace(1)* @_bal_panic_construct(i64 3076)
...
11:
  ...
  unreachable
13:
  %14 = call i8 addrspace(1)* @_bal_panic_construct(i64 5124)
...
15:
  ...
  ret i64 %17
18:
  %19 = call i8 addrspace(1)* @_bal_panic_construct(i64 5377)
