...
%Type0 = type {ptr, i32, [2 x i32]}
%Type1 = type {ptr, i32, [1 x i32]}
%FillerDesc = type {ptr}
%Type2 = type {ptr, i32, [1 x i32]}
@_Bi04root0 = constant {i32, i32, i64, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, i64, ptr, [0 x i64]} {i32 0, i32 0, i64 0, ptr @_bal_list_generic_get_tagged, ptr @_bal_list_generic_set_tagged, ptr @_bal_list_generic_inexact_set_tagged, ptr @_bal_list_generic_get_int, ptr @_bal_list_generic_set_int, ptr @_bal_list_generic_inexact_set_int, ptr @_bal_list_generic_get_float, ptr @_bal_list_generic_set_float, ptr @_bal_list_generic_inexact_set_float, i64 ptrtoint(ptr @.member0 to i64), ptr bitcast(ptr @.fillerDesc2 to ptr), [0 x i64] []}
@.subtype0 = internal constant %Type0 {ptr @_bal_precomputed_subtype_contains, i32 2, [2 x i32] [i32 1, i32 5]}, align 8
@.member0 = internal constant {i32, i32, [1 x ptr]} {i32 0, i32 4096, [1 x ptr] [ptr bitcast(ptr @.subtype0 to ptr)]}
@.list1 = constant {i32, i32, i64, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, i64, ptr, [0 x i64]} {i32 1, i32 0, i64 0, ptr @_bal_list_generic_get_tagged, ptr @_bal_list_generic_set_tagged, ptr @_bal_list_generic_inexact_set_tagged, ptr @_bal_list_generic_get_int, ptr @_bal_list_generic_set_int, ptr @_bal_list_generic_inexact_set_int, ptr @_bal_list_generic_get_float, ptr @_bal_list_generic_set_float, ptr @_bal_list_generic_inexact_set_float, i64 ptrtoint(ptr @.member1 to i64), ptr bitcast(ptr @.fillerDesc1 to ptr), [0 x i64] []}
@.subtype1 = internal constant %Type1 {ptr @_bal_precomputed_subtype_contains, i32 1, [1 x i32] [i32 2]}, align 8
@.member1 = internal constant {i32, i32, [1 x ptr]} {i32 0, i32 4096, [1 x ptr] [ptr bitcast(ptr @.subtype1 to ptr)]}
@.list2 = constant {i32, i32, i64, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, i64, ptr, [2 x i64]} {i32 2, i32 2, i64 2, ptr @_bal_list_generic_get_tagged, ptr @_bal_list_generic_set_tagged, ptr @_bal_list_generic_inexact_set_tagged, ptr @_bal_list_generic_get_int, ptr @_bal_list_generic_set_int, ptr @_bal_list_generic_inexact_set_int, ptr @_bal_list_generic_get_float, ptr @_bal_list_generic_set_float, ptr @_bal_list_generic_inexact_set_float, i64 1, ptr null, [2 x i64] [i64 9, i64 5]}
@_bal_int_zero_filler_desc = external global %FillerDesc
@_bal_boolean_false_filler_desc = external global %FillerDesc
@.fillerDesc1 = global {ptr, ptr, i64, [2 x ptr]} {ptr @_bal_fixed_length_list_filler_create, ptr bitcast(ptr @.list2 to ptr), i64 2, [2 x ptr] [ptr bitcast(ptr @_bal_int_zero_filler_desc to ptr), ptr bitcast(ptr @_bal_boolean_false_filler_desc to ptr)]}
@.fillerDesc2 = global {ptr, ptr} {ptr @_bal_list_filler_create, ptr bitcast(ptr @.list1 to ptr)}
...
@_Bi04root4 = constant {i32, i32, i64, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, i64, ptr, [0 x i64]} {i32 4, i32 0, i64 0, ptr @_bal_list_generic_get_tagged, ptr @_bal_list_generic_set_tagged, ptr @_bal_list_generic_inexact_set_tagged, ptr @_bal_list_generic_get_int, ptr @_bal_list_generic_set_int, ptr @_bal_list_generic_inexact_set_int, ptr @_bal_list_generic_get_float, ptr @_bal_list_generic_set_float, ptr @_bal_list_generic_inexact_set_float, i64 ptrtoint(ptr @.member2 to i64), ptr bitcast(ptr @.fillerDesc3 to ptr), [0 x i64] []}
@.subtype2 = internal constant %Type2 {ptr @_bal_precomputed_subtype_contains, i32 1, [1 x i32] [i32 5]}, align 8
@.member2 = internal constant {i32, i32, [1 x ptr]} {i32 0, i32 4096, [1 x ptr] [ptr bitcast(ptr @.subtype2 to ptr)]}
@.list5 = constant {i32, i32, i64, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, i64, ptr, [1 x i64]} {i32 5, i32 1, i64 2, ptr @_bal_list_generic_get_tagged, ptr @_bal_list_generic_set_tagged, ptr @_bal_list_generic_inexact_set_tagged, ptr @_bal_list_generic_get_int, ptr @_bal_list_generic_set_int, ptr @_bal_list_generic_inexact_set_int, ptr @_bal_list_generic_get_float, ptr @_bal_list_generic_set_float, ptr @_bal_list_generic_inexact_set_float, i64 1, ptr null, [1 x i64] [i64 ptrtoint(ptr @.member1 to i64)]}
@.fillerDesc4 = global {ptr, ptr, i64, [2 x ptr]} {ptr @_bal_fixed_length_list_filler_create, ptr bitcast(ptr @.list2 to ptr), i64 2, [2 x ptr] [ptr bitcast(ptr @_bal_int_zero_filler_desc to ptr), ptr bitcast(ptr @_bal_boolean_false_filler_desc to ptr)]}
@.fillerDesc3 = global {ptr, ptr, i64, [1 x ptr]} {ptr @_bal_fixed_length_list_filler_create, ptr bitcast(ptr @.list5 to ptr), i64 1, [1 x ptr] [ptr bitcast(ptr @.fillerDesc4 to ptr)]}
@_Bi04root1 = alias {i32, i32, i64, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, i64, ptr, [2 x i64]}, ptr @.list2
@_Bi04root2 = alias {i32, i32, i64, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, i64, ptr, [0 x i64]}, ptr @.list1
@_Bi04root5 = alias {i32, i32, i64, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, i64, ptr, [1 x i64]}, ptr @.list5
