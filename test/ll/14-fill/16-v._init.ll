...
@.subtype0 = internal constant %Type0 {ptr @_bal_map_subtype_contains, i32 36}, align 8
@.member0 = internal constant {i32, i32, [1 x ptr]} {i32 0, i32 8192, [1 x ptr] [ptr bitcast(ptr @.subtype0 to ptr)]}
@.mapping0 = constant {i32, i32, i64, ptr, [0 x i64]} {i32 0, i32 0, i64 73, ptr null, [0 x i64] []}
