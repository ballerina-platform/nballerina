...
%Type0 = type {ptr, i32, i16, i16, [2 x ptr addrspace(1)]}
%FillerDesc = type {ptr}
...
@.subtype0 = internal constant %Type0 {ptr @_bal_string_subtype_contains, i32 2, i16 1, i16 1, [2 x ptr addrspace(1)] [ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261409), ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261410)]}, align 8
