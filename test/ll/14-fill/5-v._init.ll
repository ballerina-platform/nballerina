...
@.subtype0 = internal constant %Type0 {ptr @_bal_string_subtype_contains, i32 1, i16 1, i16 1, [1 x ptr addrspace(1)] [ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573432510840)]}, align 8
@.member0 = internal constant {i32, i32, [1 x ptr]} {i32 0, i32 32, [1 x ptr] [ptr bitcast(ptr @.subtype0 to ptr)]}
@.fillerDesc1 = global {ptr, ptr addrspace(1)} {ptr @_bal_generic_filler_create, ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573432510840)}
