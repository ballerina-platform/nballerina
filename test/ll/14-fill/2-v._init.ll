...
%Type0 = type {ptr, i32, i32, [1 x double]}
%FillerDesc = type {ptr}
...
@.subtype0 = internal constant %Type0 {ptr @_bal_float_subtype_contains, i32 1, i32 1, [1 x double] [double 1.3]}, align 8
@.member0 = internal constant {i32, i32, [1 x ptr]} {i32 0, i32 8, [1 x ptr] [ptr bitcast(ptr @.subtype0 to ptr)]}
@.fillerDesc1 = global {ptr, double} {ptr @_bal_float_filler_create, double 1.3}
...
declare ptr addrspace(1) @_bal_float_filler_create(ptr, ptr)
...
declare i1 @_bal_float_subtype_contains(ptr, ptr addrspace(1))
