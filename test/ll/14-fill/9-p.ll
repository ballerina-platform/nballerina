...
8:
  ...
  %20 = call i64 %19(ptr addrspace(1) %13, i64 1, ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261410))
  %21 = icmp eq i64 %20, 0
...
22:
  ...
  unreachable
24:
  %25 = call ptr addrspace(1) @_bal_panic_construct(i64 772), !dbg !7
...
!1 = !DIFile(filename:"../../../compiler/testSuite/14-fill/9-p.bal", directory:"")
