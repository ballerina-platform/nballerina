...
9:
  ...
  store i64 5, ptr addrspace(1) %18
  %19 = getelementptr inbounds [0 x i64], ptr addrspace(1) %17, i64 0, i64 1
  store i64 6, ptr addrspace(1) %19
  ...
  %31 = call i64 %30(ptr addrspace(1) %23, i64 3, ptr addrspace(1) %26)
  %32 = icmp eq i64 %31, 0
...
!1 = !DIFile(filename:"../../../compiler/testSuite/14-fill/6-v.bal", directory:"")
...
!15 = !DILocation(line: 6, column: 0, scope: !5)
