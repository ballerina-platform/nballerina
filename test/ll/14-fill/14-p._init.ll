...
%Type2 = type {ptr, i32, i16, i16, [2 x ptr addrspace(1)]}
%FillerDesc = type {ptr}
...
@_Bi04root1 = constant {i32, i32, i64, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, i64, ptr, [2 x i64]} {i32 1, i32 2, i64 2, ptr @_bal_list_generic_get_tagged, ptr @_bal_list_generic_set_tagged, ptr @_bal_list_generic_inexact_set_tagged, ptr @_bal_list_generic_get_int, ptr @_bal_list_generic_set_int, ptr @_bal_list_generic_inexact_set_int, ptr @_bal_list_generic_get_float, ptr @_bal_list_generic_set_float, ptr @_bal_list_generic_inexact_set_float, i64 1, ptr null, [2 x i64] [i64 ptrtoint(ptr @.member1 to i64), i64 ptrtoint(ptr @.member2 to i64)]}
@.subtype1 = internal constant %Type1 {ptr @_bal_string_subtype_contains, i32 1, i16 1, i16 1, [1 x ptr addrspace(1)] [ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261409)]}, align 8
@.member1 = internal constant {i32, i32, [1 x ptr]} {i32 0, i32 32, [1 x ptr] [ptr bitcast(ptr @.subtype1 to ptr)]}
@.subtype2 = internal constant %Type2 {ptr @_bal_string_subtype_contains, i32 2, i16 1, i16 1, [2 x ptr addrspace(1)] [ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261409), ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261410)]}, align 8
@.member2 = internal constant {i32, i32, [1 x ptr]} {i32 0, i32 32, [1 x ptr] [ptr bitcast(ptr @.subtype2 to ptr)]}
