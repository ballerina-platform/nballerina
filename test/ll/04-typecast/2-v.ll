...
21:
  ...
  unreachable
23:
  %24 = call i8 addrspace(1)* @_bal_mapping_exactify(i8 addrspace(1)* %15, {i32}* @_Bi04root0)
  store i8 addrspace(1)* %24, i8 addrspace(1)** %2
  %25 = load i8 addrspace(1)*, i8 addrspace(1)** %2
  %26 = call i8 addrspace(1)* @_bal_mapping_get(i8 addrspace(1)* %25, i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098475879881007478))
  store i8 addrspace(1)* %26, i8 addrspace(1)** %3
  %27 = load i8 addrspace(1)*, i8 addrspace(1)** %3, !dbg !8
  call void @_Bb02ioprintln(i8 addrspace(1)* %27), !dbg !8
  store i8 addrspace(1)* null, i8 addrspace(1)** %4, !dbg !8
  ret void
28:
  %29 = call i8 addrspace(1)* @_bal_panic_construct(i64 1795), !dbg !7
