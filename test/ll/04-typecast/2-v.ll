...
19:
  ...
  unreachable
21:
  %22 = call i8 addrspace(1)* @_bal_mapping_exactify(i8 addrspace(1)* %15, {i32, i32}* @_Bi04root0)
  ...
  %25 = load i8 addrspace(1)*, i8 addrspace(1)** %3, !dbg !8
  call void @_Bb02ioprintln(i8 addrspace(1)* %25), !dbg !8
  store i8 addrspace(1)* null, i8 addrspace(1)** %4, !dbg !8
  ret void
26:
  %27 = call i8 addrspace(1)* @_bal_panic_construct(i64 1795), !dbg !7
