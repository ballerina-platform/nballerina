...
@_Bi04root0 = constant {i32, i32, i64, {i32}*, [0 x i64]} {i32 0, i32 0, i64 16773119, {i32}* null, [0 x i64] []}
@_Be04root0 = constant i32 0
@.subtype0 = internal constant {i1(%UniformSubtype*, i8 addrspace(1)*)*, i32} {i1(%UniformSubtype*, i8 addrspace(1)*)* @_bal_map_subtype_contains, i32 8386559}, align 8
