...
%FillerDesc = type {ptr}
@_Bi04root0 = constant {i32, i32, i64, ptr, [0 x i64]} {i32 0, i32 0, i64 262015, ptr bitcast(ptr @_bal_nil_filler_desc to ptr), [0 x i64] []}
...
@.subtype0 = internal constant {ptr, i32} {ptr @_bal_map_subtype_contains, i32 131007}, align 8
