...
L1:
  %_55 = load i64, i64* %_14, align 8
  call void @_bal_panic (i64 %_55)
  unreachable
L2:
  %_17 = extractvalue {i64, i1} %_15, 0
  store i64 %_17, i64* %_0, align 8
  %_18 = load i64, i64* %_0, align 8
...
L4:
  ...
  store i64 %_21, i64* %_1, align 8
  %_22 = load i64, i64* %_1, align 8
...
L6:
  ...
  store i64 %_25, i64* %_3, align 8
  %_26 = load i64, i64* %_3, align 8
...
L12:
  ...
  store i64 %_37, i64* %_7, align 8
  %_38 = load i64, i64* %_7, align 8
...
L14:
  ...
  store i64 %_41, i64* %_8, align 8
  %_42 = load i64, i64* %_8, align 8
...
L18:
  ...
  store i64 %_49, i64* %_11, align 8
  %_50 = load i64, i64* %_11, align 8
