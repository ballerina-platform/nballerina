...
8:
  ...
  %12 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 88)
  ...
  store i8 addrspace(1)* %17, i8 addrspace(1)** %arr
  ...
  %20 = bitcast i8 addrspace(1)* %19 to {{i32, i32} addrspace(1)*, i64, i64, [0 x i8 addrspace(1)*] addrspace(1)*} addrspace(1)*
  %21 = getelementptr {{i32, i32} addrspace(1)*, i64, i64, [0 x i8 addrspace(1)*] addrspace(1)*}, {{i32, i32} addrspace(1)*, i64, i64, [0 x i8 addrspace(1)*] addrspace(1)*} addrspace(1)* %20, i64 0, i32 1
...
26:
  ...
  unreachable
28:
  %29 = getelementptr inbounds {{i32, i32} addrspace(1)*, i64, i64, [0 x i8 addrspace(1)*] addrspace(1)*}, {{i32, i32} addrspace(1)*, i64, i64, [0 x i8 addrspace(1)*] addrspace(1)*} addrspace(1)* %20, i64 0, i32 3
  %30 = load [0 x i8 addrspace(1)*] addrspace(1)*, [0 x i8 addrspace(1)*] addrspace(1)* addrspace(1)* %29, align 8
  %31 = getelementptr inbounds [0 x i8 addrspace(1)*], [0 x i8 addrspace(1)*] addrspace(1)* %30, i64 0, i64 0
  %32 = load i8 addrspace(1)*, i8 addrspace(1)* addrspace(1)* %31, align 8
  store i8 addrspace(1)* %32, i8 addrspace(1)** %2
  %33 = load i8 addrspace(1)*, i8 addrspace(1)** %2, !dbg !8
