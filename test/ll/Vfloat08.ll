...
37:
  %38 = call double @_B_floatAdd(double 1.0, double 2.0)
  ...
  %41 = call double @_B_floatAdd(double -1.0, double 1.0)
  ...
  %44 = call double @_B_floatAdd(double -0.0, double -0.0)
  ...
  %47 = call double @_B_floatAdd(double -0.0, double 0.0)
  ...
  %50 = call double @_B_floatAdd(double 0x7FF8000000000000, double 1.0)
  ...
  %53 = call double @_B_floatAdd(double 0x7FF8000000000000, double 0x7FF8000000000000)
  ...
  %56 = call double @_B_floatAdd(double 0x7FF0000000000000, double 20.0)
  ...
  %59 = call double @_B_floatAdd(double 0xFFF0000000000000, double 0x7FF0000000000000)
  ...
  %62 = call double @_B_floatAdd(double 0xFFF0000000000000, double 100.0)
  ...
  %65 = call i8 addrspace(1)* @_bal_float_to_tagged(double 3.0)
  ...
  %72 = call i8 addrspace(1)* @_bal_float_to_tagged(double 0x7FF8000000000000)
  call void @_Bio__println(i8 addrspace(1)* %72)
  store i8 addrspace(1)* null, i8 addrspace(1)** %26
  %73 = call i8 addrspace(1)* @_bal_float_to_tagged(double 0xFFF0000000000000)
  ...
  ret void
87:
  %88 = call i8 addrspace(1)* @_bal_panic_construct(i64 1028)
  call void @_bal_panic(i8 addrspace(1)* %88)
  unreachable
}
define internal double @_B_floatAdd(double %0, double %1) {
  %f1 = alloca double
  %f2 = alloca double
  %3 = alloca double
  %4 = alloca i8
...
7:
  ...
  ret double %11
12:
  %13 = call i8 addrspace(1)* @_bal_panic_construct(i64 8452)
