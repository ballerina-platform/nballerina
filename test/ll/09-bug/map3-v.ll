...
10:
  %11 = call i8 addrspace(1)* @_bal_mapping_construct({i32, i32}* @_Bi04root0, i64 1)
...
31:
  ...
  %33 = call i8 addrspace(1)* @_bal_mapping_exactify(i8 addrspace(1)* %32, {i32, i32}* @_Bi04root0)
