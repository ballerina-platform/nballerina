...
8:
  ...
  %14 = call i64 @_bal_mapping_set(i8 addrspace(1)* %12, i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098476543630901112), i8 addrspace(1)* %13)
  %15 = icmp eq i64 %14, 0
...
18:
  ...
  unreachable
20:
  %21 = load i8 addrspace(1)*, i8 addrspace(1)** %m1
