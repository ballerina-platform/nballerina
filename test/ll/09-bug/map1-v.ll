...
19:
  %20 = load i8 addrspace(1)*, i8 addrspace(1)** %m2
  %21 = call i8 addrspace(1)* @_bal_mapping_exactify(i8 addrspace(1)* %20, {i32}* @_Bi04root0)
  store i8 addrspace(1)* %21, i8 addrspace(1)** %m2.1
  %22 = load i8 addrspace(1)*, i8 addrspace(1)** %m2.1
  %23 = call i8 addrspace(1)* @_bal_mapping_get(i8 addrspace(1)* %22, i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098476543630901112))
  store i8 addrspace(1)* %23, i8 addrspace(1)** %3
  %24 = load i8 addrspace(1)*, i8 addrspace(1)** %3
  store i8 addrspace(1)* %24, i8 addrspace(1)** %i
  %25 = load i8 addrspace(1)*, i8 addrspace(1)** %i, !dbg !8
