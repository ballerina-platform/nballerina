...
36:
  ...
  unreachable
38:
  %39 = getelementptr {{i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i32}*, i64, i64, [0 x i8 addrspace(1)*] addrspace(1)*}, {{i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i32}*, i64, i64, [0 x i8 addrspace(1)*] addrspace(1)*} addrspace(1)* %29, i64 0, i32 0
  ...
  %44 = call i8 addrspace(1)* %42(i8 addrspace(1)* %43, i64 0)
  %45 = call i64 @_bal_tagged_to_int(i8 addrspace(1)* %44)
  store i64 %45, i64* %3
  %46 = load i64, i64* %3
  store i64 %46, i64* %i
  %47 = load i64, i64* %i, !dbg !8
  ...
  br label %33
49:
  %50 = call i8 addrspace(1)* @_bal_panic_construct(i64 2309), !dbg !7
