...
%FillerDesc = type {ptr}
@_Bi04root0 = constant {i32, i32, i64, ptr, [2 x i64]} {i32 0, i32 2, i64 ptrtoint(ptr @.member2 to i64), ptr bitcast(ptr @_bal_nil_filler_desc to ptr), [2 x i64] [i64 ptrtoint(ptr @.member0 to i64), i64 ptrtoint(ptr @.member1 to i64)]}
...
@.subtype1 = internal constant %Type1 {ptr @_bal_int_subtype_contains, i64 1, [1 x {i64, i64}] [{i64, i64} {i64 2, i64 2}]}, align 8
...
@.member2 = internal constant {i32, i32, [2 x ptr]} {i32 32831, i32 12288, [2 x ptr] [ptr bitcast(ptr @.subtype2 to ptr), ptr bitcast(ptr @.subtype3 to ptr)]}
