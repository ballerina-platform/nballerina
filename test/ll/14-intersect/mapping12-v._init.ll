...
%Type0 = type {ptr, i32, i16, i16, [1 x ptr addrspace(1)]}
%Type1 = type {ptr, i64, [1 x {i64, i64}]}
%FillerDesc = type {ptr}
@_Bi04root0 = constant {i32, i32, i64, ptr, [1 x i64]} {i32 0, i32 1, i64 ptrtoint(ptr @.member1 to i64), ptr bitcast(ptr @.fillerDesc1 to ptr), [1 x i64] [i64 ptrtoint(ptr @.member0 to i64)]}
@.subtype0 = internal constant %Type0 {ptr @_bal_string_subtype_contains, i32 1, i16 1, i16 1, [1 x ptr addrspace(1)] [ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261411)]}, align 8
@.member0 = internal constant {i32, i32, [1 x ptr]} {i32 0, i32 32, [1 x ptr] [ptr bitcast(ptr @.subtype0 to ptr)]}
...
@.fillerDesc1 = global {ptr, i64} {ptr @_bal_int_filler_create, i64 3}
...
declare ptr addrspace(1) @_bal_int_filler_create(ptr, ptr)
