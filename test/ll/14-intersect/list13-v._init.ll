...
%Type1 = type {ptr, i32, i16, i16, [3 x ptr addrspace(1)]}
%FillerDesc = type {ptr}
...
@.subtype1 = internal constant %Type1 {ptr @_bal_string_subtype_contains, i32 3, i16 1, i16 1, [3 x ptr addrspace(1)] [ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261409), ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261410), ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261411)]}, align 8
@.member0 = internal constant {i32, i32, [2 x ptr]} {i32 0, i32 36, [2 x ptr] [ptr bitcast(ptr @.subtype0 to ptr), ptr bitcast(ptr @.subtype1 to ptr)]}
