...
36:
  ...
  call void @_bal_panic(ptr addrspace(1) %37), !dbg !21
  unreachable
38:
...
40:
  ...
  %76 = call ptr addrspace(1) @_bal_int_to_tagged(i64 9223372036854775807), !dbg !19
  ...
  call void @_Bb02ioprintln(ptr addrspace(1) %81), !dbg !20
  store ptr addrspace(1) null, ptr %12
  ret void
82:
  %83 = call ptr addrspace(1) @_bal_panic_construct(i64 1793), !dbg !7
...
!1 = !DIFile(filename:"../../../compiler/testSuite/06-bitwise/shift3-v.bal", directory:"")
...
!21 = !DILocation(line: 15, column: 0, scope: !5)
