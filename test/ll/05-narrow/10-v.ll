...
29:
  ...
  %31 = load i8 addrspace(1)*, i8 addrspace(1)** %x, !dbg !12
  call void @_Bb02ioprintln(i8 addrspace(1)* %31), !dbg !12
  store i8 addrspace(1)* null, i8 addrspace(1)** %4, !dbg !12
  ret void
32:
  %33 = load i8 addrspace(1)*, i8 addrspace(1)** %5
  call void @_bal_panic(i8 addrspace(1)* %33)
  unreachable
34:
  %35 = call i8 addrspace(1)* @_bal_panic_construct(i64 2052), !dbg !11
...
36:
  ...
  br label %27
40:
  %41 = call i8 addrspace(1)* @_bal_panic_construct(i64 3585), !dbg !11
