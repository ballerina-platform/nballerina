...
75:
  %76 = call i1 @_B_lt(i64 9223372036854775806, i64 9223372036854775806)
  store i1 %76, i1* %1
  %77 = load i1, i1* %1
  call void @_B_printBoolean(i1 %77)
  store i8 addrspace(1)* null, i8 addrspace(1)** %2
  %78 = call i1 @_B_lt(i64 9223372036854775806, i64 1)
  store i1 %78, i1* %3
  %79 = load i1, i1* %3
  call void @_B_printBoolean(i1 %79)
  store i8 addrspace(1)* null, i8 addrspace(1)** %4
  %80 = call i1 @_B_lt(i64 9223372036854775806, i64 0)
  store i1 %80, i1* %5
  %81 = load i1, i1* %5
...
87:
  ...
  store i64 %88, i64* %7
  %89 = load i64, i64* %7
  %90 = call i1 @_B_lt(i64 9223372036854775806, i64 %89)
  store i1 %90, i1* %8
  %91 = load i1, i1* %8
...
95:
  ...
  store i64 %96, i64* %10
  %97 = load i64, i64* %10
  %98 = call i1 @_B_lt(i64 9223372036854775806, i64 %97)
  store i1 %98, i1* %11
  %99 = load i1, i1* %11
  call void @_B_printBoolean(i1 %99)
  store i8 addrspace(1)* null, i8 addrspace(1)** %12
  %100 = call i1 @_B_lt(i64 1, i64 9223372036854775806)
  store i1 %100, i1* %13
  %101 = load i1, i1* %13
  call void @_B_printBoolean(i1 %101)
  store i8 addrspace(1)* null, i8 addrspace(1)** %14
  %102 = call i1 @_B_lt(i64 1, i64 1)
  store i1 %102, i1* %15
  %103 = load i1, i1* %15
  call void @_B_printBoolean(i1 %103)
  store i8 addrspace(1)* null, i8 addrspace(1)** %16
  %104 = call i1 @_B_lt(i64 1, i64 0)
  store i1 %104, i1* %17
  %105 = load i1, i1* %17
...
109:
  ...
  %111 = load i64, i64* %19
  %112 = call i1 @_B_lt(i64 1, i64 %111)
  store i1 %112, i1* %20
  %113 = load i1, i1* %20
...
131:
  ...
  %133 = load i64, i64* %31
  %134 = call i1 @_B_lt(i64 0, i64 %133)
  store i1 %134, i1* %32
  %135 = load i1, i1* %32
...
139:
  ...
  %141 = load i64, i64* %34
  %142 = call i1 @_B_lt(i64 0, i64 %141)
  store i1 %142, i1* %35
  %143 = load i1, i1* %35
...
147:
  ...
  %149 = load i64, i64* %37
  %150 = call i1 @_B_lt(i64 %149, i64 9223372036854775806)
  store i1 %150, i1* %38
  %151 = load i1, i1* %38
...
155:
  ...
  %157 = load i64, i64* %40
  %158 = call i1 @_B_lt(i64 %157, i64 1)
  store i1 %158, i1* %41
  %159 = load i1, i1* %41
...
163:
  ...
  %165 = load i64, i64* %43
  %166 = call i1 @_B_lt(i64 %165, i64 0)
  store i1 %166, i1* %44
  %167 = load i1, i1* %44
...
176:
  ...
  %178 = load i64, i64* %46
  %179 = load i64, i64* %47
  %180 = call i1 @_B_lt(i64 %178, i64 %179)
  store i1 %180, i1* %48
  %181 = load i1, i1* %48
...
190:
  ...
  %192 = load i64, i64* %50
  %193 = load i64, i64* %51
  %194 = call i1 @_B_lt(i64 %192, i64 %193)
  store i1 %194, i1* %52
  %195 = load i1, i1* %52
...
199:
  ...
  %201 = load i64, i64* %54
  %202 = call i1 @_B_lt(i64 %201, i64 9223372036854775806)
  store i1 %202, i1* %55
  %203 = load i1, i1* %55
...
207:
  ...
  %209 = load i64, i64* %57
  %210 = call i1 @_B_lt(i64 %209, i64 1)
  store i1 %210, i1* %58
  %211 = load i1, i1* %58
...
215:
  ...
  %217 = load i64, i64* %60
  %218 = call i1 @_B_lt(i64 %217, i64 0)
  store i1 %218, i1* %61
  %219 = load i1, i1* %61
...
228:
  ...
  %230 = load i64, i64* %63
  %231 = load i64, i64* %64
  %232 = call i1 @_B_lt(i64 %230, i64 %231)
  store i1 %232, i1* %65
  %233 = load i1, i1* %65
...
242:
  ...
  %244 = load i64, i64* %67
  %245 = load i64, i64* %68
  %246 = call i1 @_B_lt(i64 %244, i64 %245)
  store i1 %246, i1* %69
  %247 = load i1, i1* %69
