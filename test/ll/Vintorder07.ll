...
L1:
  %_74 = call i1 @_B_lt (i64 9223372036854775806, i64 9223372036854775806)
  store i1 %_74, i1* %_0
  %_75 = load i1, i1* %_0
  ...
  store i8* null, i8** %_3
  %_78 = call i1 @_B_lt (i64 9223372036854775806, i64 0)
  store i1 %_78, i1* %_4
  %_79 = load i1, i1* %_4
...
L4:
  ...
  %_83 = load i64, i64* %_6
  %_84 = call i1 @_B_lt (i64 9223372036854775806, i64 %_83)
  store i1 %_84, i1* %_7
  %_85 = load i1, i1* %_7
...
L8:
  ...
  %_102 = call i1 @_B_lt (i64 1, i64 %_101)
...
L12:
  ...
  %_120 = call i1 @_B_lt (i64 0, i64 %_119)
...
L14:
  ...
  %_126 = call i1 @_B_lt (i64 0, i64 %_125)
...
L16:
  ...
  %_132 = call i1 @_B_lt (i64 %_131, i64 9223372036854775806)
...
L18:
  ...
  %_138 = call i1 @_B_lt (i64 %_137, i64 1)
...
L20:
  ...
  %_144 = call i1 @_B_lt (i64 %_143, i64 0)
...
L24:
  ...
  %_154 = call i1 @_B_lt (i64 %_152, i64 %_153)
...
L28:
  ...
  %_164 = call i1 @_B_lt (i64 %_162, i64 %_163)
...
L30:
  ...
  %_170 = call i1 @_B_lt (i64 %_169, i64 9223372036854775806)
...
L32:
  ...
  %_176 = call i1 @_B_lt (i64 %_175, i64 1)
...
L34:
  ...
  %_182 = call i1 @_B_lt (i64 %_181, i64 0)
...
L38:
  ...
  %_192 = call i1 @_B_lt (i64 %_190, i64 %_191)
...
L42:
  ...
  %_202 = call i1 @_B_lt (i64 %_200, i64 %_201)
