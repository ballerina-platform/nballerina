...
6:
  %7 = call i8 addrspace(1)* @_bal_error_construct(i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098476541222085992), i64 3), !dbg !9
  store i8 addrspace(1)* %7, i8 addrspace(1)** %1, !dbg !9
  %8 = load i8 addrspace(1)*, i8 addrspace(1)** %1, !dbg !10
  call void @_B_p(i8 addrspace(1)* %8), !dbg !10
  store i8 addrspace(1)* null, i8 addrspace(1)** %2, !dbg !10
  ret void
9:
  %10 = call i8 addrspace(1)* @_bal_panic_construct(i64 516), !dbg !9
...
8:
  ...
  unreachable
10:
  %11 = call i8 addrspace(1)* @_bal_panic_construct(i64 1540), !dbg !11
