...
6:
  %7 = call i8 addrspace(1)* @_bal_error_construct(i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098476541222085992), i64 2)
  ...
  ret void
9:
  %10 = call i8 addrspace(1)* @_bal_panic_construct(i64 260)
...
8:
  ...
  unreachable
10:
  %11 = call i8 addrspace(1)* @_bal_panic_construct(i64 1284)
