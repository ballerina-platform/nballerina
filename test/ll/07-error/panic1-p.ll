...
6:
  %7 = call i8 addrspace(1)* @_bal_error_construct(i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098321995397294199), i64 3)
...
9:
  ...
  unreachable
11:
  %12 = call i8 addrspace(1)* @_bal_panic_construct(i64 516)
