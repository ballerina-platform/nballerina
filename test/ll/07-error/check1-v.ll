...
8:
  %9 = call i8 addrspace(1)* @_B_div(i64 6, i64 2)
  ...
  %11 = call i8 addrspace(1)* @_B_div(i64 5, i64 0)
...
define internal i8 addrspace(1)* @_B_div(i64 %0, i64 %1) {
  %x = alloca i64
  %y = alloca i64
  %3 = alloca i8 addrspace(1)*
  %4 = alloca i1
...
30:
  ...
  unreachable
32:
  %33 = call i8 addrspace(1)* @_bal_panic_construct(i64 2052)
  call void @_bal_panic(i8 addrspace(1)* %33)
  unreachable
34:
  %35 = call i8 addrspace(1)* @_bal_panic_construct(i64 2306)
...
11:
  ...
  %13 = call i8 addrspace(1)* @_bal_error_construct(i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098476541205702010), i64 14)
...
18:
  %19 = call i8 addrspace(1)* @_bal_panic_construct(i64 3076)
