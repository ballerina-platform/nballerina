...
7:
  %8 = call ptr addrspace(1) @_bal_error_construct(ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738034025207654519), i64 5), !dbg !7
  store ptr addrspace(1) %8, ptr %1
  %9 = load ptr addrspace(1), ptr %1
  store ptr addrspace(1) %9, ptr %err
  ...
  %14 = load ptr addrspace(1), ptr %err
...
!1 = !DIFile(filename:"../../../compiler/testSuite/07-error/4-v.bal", directory:"")
