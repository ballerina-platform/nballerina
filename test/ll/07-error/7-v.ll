...
8:
  %9 = call i8 addrspace(1)* @_bal_error_construct(i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098475922679686504), i64 5)
...
20:
  ...
  ret void
23:
  %24 = call i8 addrspace(1)* @_bal_panic_construct(i64 1539)
