...
45:
  %46 = call i8 addrspace(1)* @_bal_panic_construct(i64 1027)
...
58:
  ...
  ret void
62:
  %63 = call i8 addrspace(1)* @_bal_panic_construct(i64 1283)
...
11:
  %12 = call i8 addrspace(1)* @_bal_panic_construct(i64 2052)
