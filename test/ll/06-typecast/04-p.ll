...
9:
  %10 = call ptr addrspace(1) @_B04rootg(), !dbg !11
...
18:
  ...
  unreachable
20:
  %21 = call double @_bal_tagged_to_float(ptr addrspace(1) %11), !dbg !12
  store double %21, ptr %2
  %22 = load double, ptr %2
  store double %22, ptr %f
  ...
  %27 = load double, ptr %f
  %28 = call ptr addrspace(1) @_bal_float_to_tagged(double %27), !dbg !14
...
define ptr addrspace(1) @_B04rootg() !dbg !7 {
  %1 = alloca i8
...
!1 = !DIFile(filename:"../../../compiler/testSuite/06-typecast/04-p.bal", directory:"")
!2 = distinct !DICompileUnit(language: DW_LANG_C99, file: !1, isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, splitDebugInlining: false)
!3 = !DISubroutineType(types: !4)
!4 = !{}
!5 = distinct !DISubprogram(name:"main", linkageName:"_B04rootmain", scope: !1, file: !1, line: 4, type: !3, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !6)
!6 = !{}
!7 = distinct !DISubprogram(name:"g", linkageName:"_B04rootg", scope: !1, file: !1, line: 9, type: !3, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !8)
!8 = !{}
