...
48:
  %49 = call i8 addrspace(1)* @_bal_panic_construct(i64 1539)
...
54:
  %55 = call i8 addrspace(1)* @_bal_panic_construct(i64 2051)
...
56:
  ...
  ret void
58:
  %59 = call i8 addrspace(1)* @_bal_panic_construct(i64 3075)
