...
%Type1 = type {ptr, i64, [1 x {i64, i64}]}
...
@.subtype0 = internal constant %Type0 {ptr @_bal_int_subtype_contains, i64 1, [1 x {i64, i64}] [{i64, i64} {i64 2, i64 2}]}, align 8
@.member0 = internal constant {i32, i32, [1 x ptr]} {i32 0, i32 4, [1 x ptr] [ptr bitcast(ptr @.subtype0 to ptr)]}
@.subtype1 = internal constant %Type1 {ptr @_bal_int_subtype_contains, i64 1, [1 x {i64, i64}] [{i64, i64} {i64 3, i64 3}]}, align 8
@.member1 = internal constant {i32, i32, [1 x ptr]} {i32 0, i32 4, [1 x ptr] [ptr bitcast(ptr @.subtype1 to ptr)]}
@_Be04root3 = constant i32 -1
@_Be04root5 = constant i32 -1
@_Be04root6 = constant i32 -1
@.subtype2 = internal constant {ptr, i32} {ptr @_bal_array_subtype_contains, i32 4}, align 8
@_Bt04root1 = constant {i32, i32, [1 x ptr]} {i32 0, i32 4096, [1 x ptr] [ptr bitcast(ptr @.subtype2 to ptr)]}
@.subtype3 = internal constant {ptr, i32, [1 x i32]} {ptr @_bal_precomputed_subtype_contains, i32 1, [1 x i32] [i32 2]}, align 8
@_Bt04root2 = constant {i32, i32, [1 x ptr]} {i32 0, i32 4096, [1 x ptr] [ptr bitcast(ptr @.subtype3 to ptr)]}
@.subtype4 = internal constant {ptr, i32, [1 x i32]} {ptr @_bal_precomputed_subtype_contains, i32 1, [1 x i32] [i32 2]}, align 8
@_Bt04root4 = constant {i32, i32, [1 x ptr]} {i32 0, i32 4096, [1 x ptr] [ptr bitcast(ptr @.subtype4 to ptr)]}
