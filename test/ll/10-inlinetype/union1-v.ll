...
5:
  %6 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 17)
  store i8 addrspace(1)* %6, i8 addrspace(1)** %x
  %7 = load i8 addrspace(1)*, i8 addrspace(1)** %x, !dbg !8
  call void @_Bb02ioprintln(i8 addrspace(1)* %7), !dbg !8
  store i8 addrspace(1)* null, i8 addrspace(1)** %1, !dbg !8
  ret void
8:
  %9 = call i8 addrspace(1)* @_bal_panic_construct(i64 1540), !dbg !7
...
!1 = !DIFile(filename:"../../../compiler/testSuite/10-inlinetype/union1-v.bal", directory:"")
