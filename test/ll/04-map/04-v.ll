...
7:
  ...
  call void @_bal_mapping_init_member(ptr addrspace(1) %8, ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573431787366), ptr addrspace(1) %11), !dbg !10
  call void @_bal_mapping_init_member(ptr addrspace(1) %8, ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573431980386), ptr addrspace(1) null), !dbg !11
