...
8:
  ...
  %24 = getelementptr i8, i8 addrspace(1)* %18, i64 1297036692682702848
  store i8 addrspace(1)* %24, i8 addrspace(1)** %1
  %25 = call i8 addrspace(1)* @_bal_mapping_construct(i64 8388607, i64 2)
  ...
  %28 = call i8 addrspace(1)* @_bal_mapping_construct(i64 8386559, i64 2)
  %29 = load i8 addrspace(1)*, i8 addrspace(1)** %1
  call void @_bal_mapping_init_member(i8 addrspace(1)* %28, i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098476541289654636), i8 addrspace(1)* %29)
  %30 = load i8 addrspace(1)*, i8 addrspace(1)** %2
  call void @_bal_mapping_init_member(i8 addrspace(1)* %28, i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3055532271331205485), i8 addrspace(1)* %30)
  store i8 addrspace(1)* %28, i8 addrspace(1)** %3
  %31 = load i8 addrspace(1)*, i8 addrspace(1)** %3
