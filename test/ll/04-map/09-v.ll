...
declare i64 @_Bb0m4lang3maplength(ptr addrspace(1))
...
8:
  ...
  call void @_bal_mapping_init_member(ptr addrspace(1) %9, ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261434), ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738187952490046824)), !dbg !12
  store ptr addrspace(1) %9, ptr %1
  %16 = load ptr addrspace(1), ptr %1
  store ptr addrspace(1) %16, ptr %m
  %17 = load ptr addrspace(1), ptr %m
  %18 = call ptr addrspace(1) @_bal_tagged_clear_exact_ptr(ptr addrspace(1) %17), !dbg !13
  %19 = call i64 @_Bb0m4lang3maplength(ptr addrspace(1) %18), !dbg !14
  store i64 %19, ptr %2
  %20 = call ptr addrspace(1) @_bal_list_construct_8(ptr @_Bi04root1, i64 1), !dbg !15
  ...
  %24 = load i64, ptr %2
  %25 = call ptr addrspace(1) @_bal_int_to_tagged(i64 %24), !dbg !16
