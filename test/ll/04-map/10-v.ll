...
71:
  %72 = call i8 addrspace(1)* @_bal_panic_construct(i64 1797)
...
77:
  %78 = call i8 addrspace(1)* @_bal_panic_construct(i64 1795)
...
87:
  %88 = call i8 addrspace(1)* @_bal_panic_construct(i64 1793)
