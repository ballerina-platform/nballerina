...
@.dec0 = internal unnamed_addr constant [2 x i64] [i64 -865536378825081601, i64 8646858456403230671], align 8
@.dec1 = internal unnamed_addr constant [2 x i64] [i64 2, i64 4899846025834921984], align 8
...
8:
  ...
  %15 = call {ptr addrspace(1), i64} @_bal_decimal_add(ptr addrspace(1) %13, ptr addrspace(1) %14), !dbg !9
...
!1 = !DIFile(filename:"../../../compiler/testSuite/12-decimal/add11-p.bal", directory:"")
...
!12 = !DILocation(line: 6, column: 0, scope: !5)
