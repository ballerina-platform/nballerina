...
35:
  %36 = call i8 addrspace(1)* @_bal_float_to_tagged(double 1.0), !dbg !8
  call void @_Bb02ioprintln(i8 addrspace(1)* %36), !dbg !8
  store i8 addrspace(1)* null, i8 addrspace(1)** %1, !dbg !8
  %37 = call i8 addrspace(1)* @_bal_float_to_tagged(double 1.0), !dbg !9
  call void @_Bb02ioprintln(i8 addrspace(1)* %37), !dbg !9
  store i8 addrspace(1)* null, i8 addrspace(1)** %2, !dbg !9
  %38 = call i8 addrspace(1)* @_bal_float_to_tagged(double 1.1), !dbg !10
  call void @_Bb02ioprintln(i8 addrspace(1)* %38), !dbg !10
  store i8 addrspace(1)* null, i8 addrspace(1)** %3, !dbg !10
  %39 = call i8 addrspace(1)* @_bal_float_to_tagged(double 9.1), !dbg !11
  call void @_Bb02ioprintln(i8 addrspace(1)* %39), !dbg !11
  store i8 addrspace(1)* null, i8 addrspace(1)** %4, !dbg !11
  %40 = call i8 addrspace(1)* @_bal_float_to_tagged(double 10.0), !dbg !12
  call void @_Bb02ioprintln(i8 addrspace(1)* %40), !dbg !12
  store i8 addrspace(1)* null, i8 addrspace(1)** %5, !dbg !12
  %41 = call i8 addrspace(1)* @_bal_float_to_tagged(double 10.0), !dbg !13
  call void @_Bb02ioprintln(i8 addrspace(1)* %41), !dbg !13
  store i8 addrspace(1)* null, i8 addrspace(1)** %6, !dbg !13
  %42 = call i8 addrspace(1)* @_bal_float_to_tagged(double 10.0), !dbg !14
  call void @_Bb02ioprintln(i8 addrspace(1)* %42), !dbg !14
  store i8 addrspace(1)* null, i8 addrspace(1)** %7, !dbg !14
  %43 = call i8 addrspace(1)* @_bal_float_to_tagged(double 10.0), !dbg !15
  call void @_Bb02ioprintln(i8 addrspace(1)* %43), !dbg !15
  store i8 addrspace(1)* null, i8 addrspace(1)** %8, !dbg !15
  %44 = call i8 addrspace(1)* @_bal_float_to_tagged(double 10.0), !dbg !16
  call void @_Bb02ioprintln(i8 addrspace(1)* %44), !dbg !16
  store i8 addrspace(1)* null, i8 addrspace(1)** %9, !dbg !16
  %45 = call i8 addrspace(1)* @_bal_float_to_tagged(double 10.0), !dbg !17
  call void @_Bb02ioprintln(i8 addrspace(1)* %45), !dbg !17
  store i8 addrspace(1)* null, i8 addrspace(1)** %10, !dbg !17
  %46 = call i8 addrspace(1)* @_bal_float_to_tagged(double 100.0), !dbg !18
  call void @_Bb02ioprintln(i8 addrspace(1)* %46), !dbg !18
  store i8 addrspace(1)* null, i8 addrspace(1)** %11, !dbg !18
  %47 = call i8 addrspace(1)* @_bal_float_to_tagged(double 100.0), !dbg !19
  call void @_Bb02ioprintln(i8 addrspace(1)* %47), !dbg !19
  store i8 addrspace(1)* null, i8 addrspace(1)** %12, !dbg !19
  %48 = call i8 addrspace(1)* @_bal_float_to_tagged(double 190.0), !dbg !20
  call void @_Bb02ioprintln(i8 addrspace(1)* %48), !dbg !20
  store i8 addrspace(1)* null, i8 addrspace(1)** %13, !dbg !20
  %49 = call i8 addrspace(1)* @_bal_float_to_tagged(double 1.0E101), !dbg !21
  call void @_Bb02ioprintln(i8 addrspace(1)* %49), !dbg !21
  store i8 addrspace(1)* null, i8 addrspace(1)** %14, !dbg !21
  %50 = call i8 addrspace(1)* @_bal_float_to_tagged(double 1.0E134), !dbg !22
  call void @_Bb02ioprintln(i8 addrspace(1)* %50), !dbg !22
  store i8 addrspace(1)* null, i8 addrspace(1)** %15, !dbg !22
  %51 = call i8 addrspace(1)* @_bal_float_to_tagged(double 1.0E308), !dbg !23
  call void @_Bb02ioprintln(i8 addrspace(1)* %51), !dbg !23
  store i8 addrspace(1)* null, i8 addrspace(1)** %16, !dbg !23
  %52 = call i8 addrspace(1)* @_bal_float_to_tagged(double 0x7FEFFFFFFFFFFFFF), !dbg !24
  call void @_Bb02ioprintln(i8 addrspace(1)* %52), !dbg !24
  store i8 addrspace(1)* null, i8 addrspace(1)** %17, !dbg !24
  %53 = call i8 addrspace(1)* @_bal_float_to_tagged(double 0.0), !dbg !25
  call void @_Bb02ioprintln(i8 addrspace(1)* %53), !dbg !25
  store i8 addrspace(1)* null, i8 addrspace(1)** %18, !dbg !25
  %54 = call i8 addrspace(1)* @_bal_float_to_tagged(double 0x14), !dbg !26
  call void @_Bb02ioprintln(i8 addrspace(1)* %54), !dbg !26
  store i8 addrspace(1)* null, i8 addrspace(1)** %19, !dbg !26
  %55 = call i8 addrspace(1)* @_bal_float_to_tagged(double 0x2), !dbg !27
  call void @_Bb02ioprintln(i8 addrspace(1)* %55), !dbg !27
  store i8 addrspace(1)* null, i8 addrspace(1)** %20, !dbg !27
  %56 = call i8 addrspace(1)* @_bal_float_to_tagged(double 0.0), !dbg !28
  call void @_Bb02ioprintln(i8 addrspace(1)* %56), !dbg !28
  store i8 addrspace(1)* null, i8 addrspace(1)** %21, !dbg !28
  %57 = call i8 addrspace(1)* @_bal_float_to_tagged(double -0.0), !dbg !29
  call void @_Bb02ioprintln(i8 addrspace(1)* %57), !dbg !29
  store i8 addrspace(1)* null, i8 addrspace(1)** %22, !dbg !29
  %58 = call i8 addrspace(1)* @_bal_float_to_tagged(double 0.0), !dbg !30
  call void @_Bb02ioprintln(i8 addrspace(1)* %58), !dbg !30
  store i8 addrspace(1)* null, i8 addrspace(1)** %23, !dbg !30
  %59 = call i8 addrspace(1)* @_bal_float_to_tagged(double -0.0), !dbg !31
  call void @_Bb02ioprintln(i8 addrspace(1)* %59), !dbg !31
  store i8 addrspace(1)* null, i8 addrspace(1)** %24, !dbg !31
  %60 = call i8 addrspace(1)* @_bal_float_to_tagged(double 0x7FF0000000000000), !dbg !32
  call void @_Bb02ioprintln(i8 addrspace(1)* %60), !dbg !32
  store i8 addrspace(1)* null, i8 addrspace(1)** %25, !dbg !32
  %61 = call i8 addrspace(1)* @_bal_float_to_tagged(double 0x7FF0000000000000), !dbg !33
  call void @_Bb02ioprintln(i8 addrspace(1)* %61), !dbg !33
  store i8 addrspace(1)* null, i8 addrspace(1)** %26, !dbg !33
  %62 = call i8 addrspace(1)* @_bal_float_to_tagged(double 0x7FF0000000000000), !dbg !34
  call void @_Bb02ioprintln(i8 addrspace(1)* %62), !dbg !34
  store i8 addrspace(1)* null, i8 addrspace(1)** %27, !dbg !34
  %63 = call i8 addrspace(1)* @_bal_float_to_tagged(double 0xFFF0000000000000), !dbg !35
  call void @_Bb02ioprintln(i8 addrspace(1)* %63), !dbg !35
  store i8 addrspace(1)* null, i8 addrspace(1)** %28, !dbg !35
  %64 = call i8 addrspace(1)* @_bal_float_to_tagged(double 0xFFF0000000000000), !dbg !36
  call void @_Bb02ioprintln(i8 addrspace(1)* %64), !dbg !36
  store i8 addrspace(1)* null, i8 addrspace(1)** %29, !dbg !36
  %65 = call i8 addrspace(1)* @_bal_float_to_tagged(double 0xFFF0000000000000), !dbg !37
  call void @_Bb02ioprintln(i8 addrspace(1)* %65), !dbg !37
  store i8 addrspace(1)* null, i8 addrspace(1)** %30, !dbg !37
  %66 = call i8 addrspace(1)* @_bal_float_to_tagged(double 0xFFF0000000000000), !dbg !38
  call void @_Bb02ioprintln(i8 addrspace(1)* %66), !dbg !38
  store i8 addrspace(1)* null, i8 addrspace(1)** %31, !dbg !38
  ret void
67:
  %68 = call i8 addrspace(1)* @_bal_panic_construct(i64 772), !dbg !7
...
!26 = !DILocation(line: 22, column: 4, scope: !5)
!27 = !DILocation(line: 23, column: 4, scope: !5)
!28 = !DILocation(line: 24, column: 4, scope: !5)
!29 = !DILocation(line: 25, column: 4, scope: !5)
!30 = !DILocation(line: 26, column: 4, scope: !5)
!31 = !DILocation(line: 27, column: 4, scope: !5)
!32 = !DILocation(line: 28, column: 4, scope: !5)
!33 = !DILocation(line: 29, column: 4, scope: !5)
!34 = !DILocation(line: 30, column: 4, scope: !5)
!35 = !DILocation(line: 31, column: 4, scope: !5)
!36 = !DILocation(line: 32, column: 4, scope: !5)
!37 = !DILocation(line: 33, column: 4, scope: !5)
!38 = !DILocation(line: 34, column: 4, scope: !5)
