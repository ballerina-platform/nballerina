%FillerDesc = type {ptr}
@_Bi04root0 = constant {i32, i32, i64, ptr, [0 x i64]} {i32 0, i32 0, i64 33, ptr bitcast(ptr bitcast(ptr @.fillerDesc1 to ptr) to ptr), [0 x i64] []}
...
@_Bi04root2 = constant {i32, i32, i64, ptr, [0 x i64]} {i32 1, i32 0, i64 41, ptr null, [0 x i64] []}
