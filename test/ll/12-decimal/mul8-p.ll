...
@.dec0 = internal unnamed_addr constant [8 x i8] c"1E+6144\00", align 8
@.dec1 = internal unnamed_addr constant [5 x i8] c"1E+1\00", align 8
...
7:
  ...
  %12 = call {i8 addrspace(1)*, i64} @_bal_decimal_mul(i8 addrspace(1)* %10, i8 addrspace(1)* %11)
