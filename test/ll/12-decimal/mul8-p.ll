...
@.dec0 = internal unnamed_addr constant [2 x i64] [i64 0, i64 5188076401986633728], align 8
@.dec1 = internal unnamed_addr constant [2 x i64] [i64 1, i64 2452280365847412736], align 8
...
8:
  ...
  %15 = call {ptr addrspace(1), i64} @_bal_decimal_mul(ptr addrspace(1) %13, ptr addrspace(1) %14), !dbg !9
...
!1 = !DIFile(filename:"../../../compiler/testSuite/12-decimal/mul8-p.bal", directory:"")
