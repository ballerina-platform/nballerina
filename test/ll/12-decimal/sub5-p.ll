...
@.dec0 = internal unnamed_addr constant [8 x i8] c"9E+6144\00", align 8
@.dec1 = internal unnamed_addr constant [9 x i8] c"-1E+6144\00", align 8
...
7:
  ...
  %9 = call i8 addrspace(1)* @_bal_decimal_const(i8* bitcast([9 x i8]* @.dec1 to i8*))
  store i8 addrspace(1)* %9, i8 addrspace(1)** %d2
  %10 = load i8 addrspace(1)*, i8 addrspace(1)** %d1
  %11 = load i8 addrspace(1)*, i8 addrspace(1)** %d2
  %12 = call {i8 addrspace(1)*, i64} @_bal_decimal_sub(i8 addrspace(1)* %10, i8 addrspace(1)* %11)
