...
@.dec0 = internal unnamed_addr constant [2 x i64] [i64 -865536378825081602, i64 8646858456403230671], align 8
@.dec1 = internal unnamed_addr constant [2 x i64] [i64 1, i64 2452069259614879744], align 8
...
8:
  ...
  %11 = addrspacecast ptr bitcast(ptr @.dec1 to ptr) to ptr addrspace(1)
  ...
  %15 = call {ptr addrspace(1), i64} @_bal_decimal_rem(ptr addrspace(1) %13, ptr addrspace(1) %14), !dbg !9
...
!1 = !DIFile(filename:"../../../compiler/testSuite/12-decimal/rem6-p.bal", directory:"")
...
!9 = !DILocation(line: 11, column: 18, scope: !5)
