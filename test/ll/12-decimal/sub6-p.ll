...
@.dec1 = internal unnamed_addr constant [2 x i64] [i64 1, i64 4899846025834921984], align 8
...
8:
  ...
  %15 = call {ptr addrspace(1), i64} @_bal_decimal_sub(ptr addrspace(1) %13, ptr addrspace(1) %14), !dbg !9
...
!1 = !DIFile(filename:"../../../compiler/testSuite/12-decimal/sub6-p.bal", directory:"")
