...
@.dec0 = internal unnamed_addr constant [43 x i8] c"-9.999999999999999999999999999999999E+6144\00", align 8
...
7:
  %8 = call i8 addrspace(1)* @_bal_decimal_const(i8* bitcast([43 x i8]* @.dec0 to i8*))
  store i8 addrspace(1)* %8, i8 addrspace(1)** %d1
  %9 = call i8 addrspace(1)* @_bal_decimal_const(i8* bitcast([2 x i8]* @.dec1 to i8*))
...
!1 = !DIFile(filename:"../../../compiler/testSuite/12-decimal/mul10-p.bal", directory:"")
