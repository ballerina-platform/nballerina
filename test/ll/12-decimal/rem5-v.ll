...
@.dec3 = internal unnamed_addr constant [2 x i64] [i64 16, i64 -6771162039751540736], align 8
@.dec4 = internal unnamed_addr constant [2 x i64] [i64 3, i64 2452209997103235072], align 8
@.dec5 = internal unnamed_addr constant [2 x i64] [i64 16, i64 2452209997103235072], align 8
@.dec6 = internal unnamed_addr constant [2 x i64] [i64 3, i64 -6771162039751540736], align 8
@.dec7 = internal unnamed_addr constant [2 x i64] [i64 227, i64 -6771232408495718400], align 8
@.dec8 = internal unnamed_addr constant [2 x i64] [i64 65, i64 2452139628359057408], align 8
@.dec9 = internal unnamed_addr constant [2 x i64] [i64 248, i64 2452139628359057408], align 8
@.dec10 = internal unnamed_addr constant [2 x i64] [i64 65, i64 -6771232408495718400], align 8
@.dec11 = internal unnamed_addr constant [2 x i64] [i64 248, i64 -6771232408495718400], align 8
@.dec12 = internal unnamed_addr constant [2 x i64] [i64 39, i64 2452209997103235072], align 8
@.dec13 = internal unnamed_addr constant [2 x i64] [i64 4, i64 2452209997103235072], align 8
@.dec14 = internal unnamed_addr constant [2 x i64] [i64 40, i64 2452209997103235072], align 8
@.dec15 = internal unnamed_addr constant [2 x i64] [i64 5, i64 2452209997103235072], align 8
@.dec16 = internal unnamed_addr constant [2 x i64] [i64 1, i64 2322168557862912], align 8
@.dec17 = internal unnamed_addr constant [2 x i64] [i64 1, i64 2392537302040576], align 8
@.dec18 = internal unnamed_addr constant [2 x i64] [i64 1, i64 -9220979499552735232], align 8
@.dec19 = internal unnamed_addr constant [2 x i64] [i64 1, i64 2451998890870702080], align 8
@.dec20 = internal unnamed_addr constant [2 x i64] [i64 1, i64 2452069259614879744], align 8
@.dec21 = internal unnamed_addr constant [2 x i64] [i64 653, i64 2452069259614879744], align 8
@.dec22 = internal unnamed_addr constant [2 x i64] [i64 1, i64 2452139628359057408], align 8
@.dec23 = internal unnamed_addr constant [2 x i64] [i64 26, i64 2454321059428564992], align 8
@.dec24 = internal unnamed_addr constant [2 x i64] [i64 143365, i64 2451858153382346752], align 8
@.dec25 = internal unnamed_addr constant [2 x i64] [i64 1, i64 2451928522126524416], align 8
declare ptr addrspace(1) @_bal_panic_construct(i64) cold
declare void @_bal_panic(ptr addrspace(1)) noreturn cold
declare {ptr addrspace(1), i64} @_bal_decimal_rem(ptr addrspace(1), ptr addrspace(1)) readonly
...
59:
  ...
  %66 = call {ptr addrspace(1), i64} @_bal_decimal_rem(ptr addrspace(1) %64, ptr addrspace(1) %65), !dbg !9
...
73:
  ...
  %85 = addrspacecast ptr bitcast(ptr @.dec0 to ptr) to ptr addrspace(1)
  ...
  %91 = call {ptr addrspace(1), i64} @_bal_decimal_rem(ptr addrspace(1) %89, ptr addrspace(1) %90), !dbg !12
...
97:
  ...
  %111 = addrspacecast ptr bitcast(ptr @.dec1 to ptr) to ptr addrspace(1)
  ...
  %115 = call {ptr addrspace(1), i64} @_bal_decimal_rem(ptr addrspace(1) %113, ptr addrspace(1) %114), !dbg !15
...
121:
  ...
  %139 = call {ptr addrspace(1), i64} @_bal_decimal_rem(ptr addrspace(1) %137, ptr addrspace(1) %138), !dbg !18
...
145:
  ...
  %163 = call {ptr addrspace(1), i64} @_bal_decimal_rem(ptr addrspace(1) %161, ptr addrspace(1) %162), !dbg !21
...
169:
  ...
  %183 = addrspacecast ptr bitcast(ptr @.dec8 to ptr) to ptr addrspace(1)
  ...
  %187 = call {ptr addrspace(1), i64} @_bal_decimal_rem(ptr addrspace(1) %185, ptr addrspace(1) %186), !dbg !24
...
193:
  ...
  %205 = addrspacecast ptr bitcast(ptr @.dec9 to ptr) to ptr addrspace(1)
  %206 = getelementptr i8, ptr addrspace(1) %205, i64 288230376151711744
  store ptr addrspace(1) %206, ptr %d1
  %207 = addrspacecast ptr bitcast(ptr @.dec10 to ptr) to ptr addrspace(1)
  ...
  %211 = call {ptr addrspace(1), i64} @_bal_decimal_rem(ptr addrspace(1) %209, ptr addrspace(1) %210), !dbg !27
...
217:
  ...
  %229 = addrspacecast ptr bitcast(ptr @.dec11 to ptr) to ptr addrspace(1)
  %230 = getelementptr i8, ptr addrspace(1) %229, i64 288230376151711744
  store ptr addrspace(1) %230, ptr %d1
  %231 = addrspacecast ptr bitcast(ptr @.dec10 to ptr) to ptr addrspace(1)
  ...
  %235 = call {ptr addrspace(1), i64} @_bal_decimal_rem(ptr addrspace(1) %233, ptr addrspace(1) %234), !dbg !30
...
241:
  ...
  %259 = call {ptr addrspace(1), i64} @_bal_decimal_rem(ptr addrspace(1) %257, ptr addrspace(1) %258), !dbg !33
...
265:
  ...
  %277 = addrspacecast ptr bitcast(ptr @.dec14 to ptr) to ptr addrspace(1)
  %278 = getelementptr i8, ptr addrspace(1) %277, i64 288230376151711744
  store ptr addrspace(1) %278, ptr %d1
  %279 = addrspacecast ptr bitcast(ptr @.dec15 to ptr) to ptr addrspace(1)
  ...
  %283 = call {ptr addrspace(1), i64} @_bal_decimal_rem(ptr addrspace(1) %281, ptr addrspace(1) %282), !dbg !36
...
289:
  ...
  %301 = addrspacecast ptr bitcast(ptr @.dec5 to ptr) to ptr addrspace(1)
  %302 = getelementptr i8, ptr addrspace(1) %301, i64 288230376151711744
  store ptr addrspace(1) %302, ptr %d1
  %303 = addrspacecast ptr bitcast(ptr @.dec4 to ptr) to ptr addrspace(1)
  ...
  %307 = call {ptr addrspace(1), i64} @_bal_decimal_rem(ptr addrspace(1) %305, ptr addrspace(1) %306), !dbg !39
...
313:
  ...
  %325 = addrspacecast ptr bitcast(ptr @.dec16 to ptr) to ptr addrspace(1)
  %326 = getelementptr i8, ptr addrspace(1) %325, i64 288230376151711744
  store ptr addrspace(1) %326, ptr %d1
  %327 = addrspacecast ptr bitcast(ptr @.dec16 to ptr) to ptr addrspace(1)
  ...
  %331 = call {ptr addrspace(1), i64} @_bal_decimal_rem(ptr addrspace(1) %329, ptr addrspace(1) %330), !dbg !42
...
337:
  ...
  %349 = addrspacecast ptr bitcast(ptr @.dec16 to ptr) to ptr addrspace(1)
  %350 = getelementptr i8, ptr addrspace(1) %349, i64 288230376151711744
  store ptr addrspace(1) %350, ptr %d1
  %351 = addrspacecast ptr bitcast(ptr @.dec17 to ptr) to ptr addrspace(1)
  ...
  %355 = call {ptr addrspace(1), i64} @_bal_decimal_rem(ptr addrspace(1) %353, ptr addrspace(1) %354), !dbg !45
...
361:
  ...
  %373 = addrspacecast ptr bitcast(ptr @.dec16 to ptr) to ptr addrspace(1)
  %374 = getelementptr i8, ptr addrspace(1) %373, i64 288230376151711744
  store ptr addrspace(1) %374, ptr %d1
  %375 = addrspacecast ptr bitcast(ptr @.dec18 to ptr) to ptr addrspace(1)
  ...
  %379 = call {ptr addrspace(1), i64} @_bal_decimal_rem(ptr addrspace(1) %377, ptr addrspace(1) %378), !dbg !48
...
385:
  ...
  %397 = addrspacecast ptr bitcast(ptr @.dec19 to ptr) to ptr addrspace(1)
  %398 = getelementptr i8, ptr addrspace(1) %397, i64 288230376151711744
  store ptr addrspace(1) %398, ptr %d1
  %399 = addrspacecast ptr bitcast(ptr @.dec20 to ptr) to ptr addrspace(1)
  ...
  %403 = call {ptr addrspace(1), i64} @_bal_decimal_rem(ptr addrspace(1) %401, ptr addrspace(1) %402), !dbg !51
...
409:
  ...
  %421 = addrspacecast ptr bitcast(ptr @.dec21 to ptr) to ptr addrspace(1)
  %422 = getelementptr i8, ptr addrspace(1) %421, i64 288230376151711744
  store ptr addrspace(1) %422, ptr %d1
  %423 = addrspacecast ptr bitcast(ptr @.dec22 to ptr) to ptr addrspace(1)
  ...
  %427 = call {ptr addrspace(1), i64} @_bal_decimal_rem(ptr addrspace(1) %425, ptr addrspace(1) %426), !dbg !54
...
433:
  ...
  %445 = addrspacecast ptr bitcast(ptr @.dec23 to ptr) to ptr addrspace(1)
  %446 = getelementptr i8, ptr addrspace(1) %445, i64 288230376151711744
  store ptr addrspace(1) %446, ptr %d1
  %447 = addrspacecast ptr bitcast(ptr @.dec20 to ptr) to ptr addrspace(1)
  ...
  %451 = call {ptr addrspace(1), i64} @_bal_decimal_rem(ptr addrspace(1) %449, ptr addrspace(1) %450), !dbg !57
...
457:
  ...
  %469 = addrspacecast ptr bitcast(ptr @.dec24 to ptr) to ptr addrspace(1)
  %470 = getelementptr i8, ptr addrspace(1) %469, i64 288230376151711744
  store ptr addrspace(1) %470, ptr %d1
  %471 = addrspacecast ptr bitcast(ptr @.dec25 to ptr) to ptr addrspace(1)
  ...
  %475 = call {ptr addrspace(1), i64} @_bal_decimal_rem(ptr addrspace(1) %473, ptr addrspace(1) %474), !dbg !60
