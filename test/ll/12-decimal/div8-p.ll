...
@.dec1 = internal unnamed_addr constant [4 x i8] c"0.1\00", align 8
...
7:
  ...
  %9 = call i8 addrspace(1)* @_bal_decimal_const(i8* bitcast([4 x i8]* @.dec1 to i8*))
  store i8 addrspace(1)* %9, i8 addrspace(1)** %d2
  %10 = load i8 addrspace(1)*, i8 addrspace(1)** %d1
  %11 = load i8 addrspace(1)*, i8 addrspace(1)** %d2
  %12 = call {i8 addrspace(1)*, i64} @_bal_decimal_div(i8 addrspace(1)* %10, i8 addrspace(1)* %11)
...
!1 = !DIFile(filename:"../../../compiler/testSuite/12-decimal/div8-p.bal", directory:"")
