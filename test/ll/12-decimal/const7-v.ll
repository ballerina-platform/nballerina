...
@.dec0 = internal unnamed_addr constant [2 x i64] [i64 17, i64 2452280365847412736], align 8
@.dec1 = internal unnamed_addr constant [2 x i64] [i64 95, i64 2453758109475143680], align 8
@.dec2 = internal unnamed_addr constant [2 x i64] [i64 17, i64 2452280365847418816], align 8
@.dec3 = internal unnamed_addr constant [2 x i64] [i64 -865536378825081617, i64 -6771091671007357041], align 8
@.dec4 = internal unnamed_addr constant [2 x i64] [i64 1103, i64 2453828478219321344], align 8
@.dec5 = internal unnamed_addr constant [2 x i64] [i64 9, i64 2453687740730966016], align 8
@.dec6 = internal unnamed_addr constant [2 x i64] [i64 0, i64 2452209997103235072], align 8
...
24:
  ...
  %40 = addrspacecast ptr bitcast(ptr @.dec0 to ptr) to ptr addrspace(1)
  ...
  %51 = addrspacecast ptr bitcast(ptr @.dec1 to ptr) to ptr addrspace(1)
  ...
  %62 = addrspacecast ptr bitcast(ptr @.dec2 to ptr) to ptr addrspace(1)
  ...
  %73 = addrspacecast ptr bitcast(ptr @.dec2 to ptr) to ptr addrspace(1)
  ...
  %84 = addrspacecast ptr bitcast(ptr @.dec3 to ptr) to ptr addrspace(1)
  ...
  %95 = addrspacecast ptr bitcast(ptr @.dec3 to ptr) to ptr addrspace(1)
  ...
  %106 = addrspacecast ptr bitcast(ptr @.dec4 to ptr) to ptr addrspace(1)
  ...
  %117 = addrspacecast ptr bitcast(ptr @.dec5 to ptr) to ptr addrspace(1)
  ...
  %128 = addrspacecast ptr bitcast(ptr @.dec6 to ptr) to ptr addrspace(1)
  ...
  ret void
135:
  %136 = call ptr addrspace(1) @_bal_panic_construct(i64 3588), !dbg !7
...
!13 = !DILocation(line: 17, column: 15, scope: !5)
!14 = !DILocation(line: 17, column: 4, scope: !5)
!15 = !DILocation(line: 18, column: 15, scope: !5)
!16 = !DILocation(line: 18, column: 4, scope: !5)
!17 = !DILocation(line: 19, column: 15, scope: !5)
!18 = !DILocation(line: 19, column: 4, scope: !5)
!19 = !DILocation(line: 20, column: 15, scope: !5)
!20 = !DILocation(line: 20, column: 4, scope: !5)
!21 = !DILocation(line: 21, column: 15, scope: !5)
!22 = !DILocation(line: 21, column: 4, scope: !5)
!23 = !DILocation(line: 22, column: 15, scope: !5)
!24 = !DILocation(line: 22, column: 4, scope: !5)
!25 = !DILocation(line: 23, column: 15, scope: !5)
!26 = !DILocation(line: 23, column: 4, scope: !5)
!27 = !DILocation(line: 24, column: 15, scope: !5)
