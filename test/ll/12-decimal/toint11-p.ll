...
@.dec0 = internal unnamed_addr constant [26 x i8] c"9.2233720368547758076E+20\00", align 8
...
7:
  %8 = call i8 addrspace(1)* @_bal_decimal_const(i8* bitcast([26 x i8]* @.dec0 to i8*))
...
!1 = !DIFile(filename:"../../../compiler/testSuite/12-decimal/toint11-p.bal", directory:"")
