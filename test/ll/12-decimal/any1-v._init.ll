...
@_Bi04root1 = constant {i32, i32, i64, ptr, [1 x i64]} {i32 0, i32 1, i64 1, ptr null, [1 x i64] [i64 262015]}
@_Bi04root2 = constant {i32, i32, i64, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, i64, ptr, [0 x i64]} {i32 1, i32 0, i64 0, ptr @_bal_list_generic_get_tagged, ptr @_bal_list_generic_set_tagged, ptr @_bal_list_generic_inexact_set_tagged, ptr @_bal_list_generic_get_int, ptr @_bal_list_generic_set_int, ptr @_bal_list_generic_inexact_set_int, ptr @_bal_list_generic_get_float, ptr @_bal_list_generic_set_float, ptr @_bal_list_generic_inexact_set_float, i64 262015, ptr bitcast(ptr @_bal_nil_filler_desc to ptr), [0 x i64] []}
@_Bi04root3 = constant {i32, i32, i64, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, ptr, i64, ptr, [0 x i64]} {i32 2, i32 0, i64 0, ptr @_bal_list_generic_get_tagged, ptr @_bal_list_generic_set_tagged, ptr @_bal_list_generic_inexact_set_tagged, ptr @_bal_list_generic_get_int, ptr @_bal_list_generic_set_int, ptr @_bal_list_generic_inexact_set_int, ptr @_bal_list_generic_get_float, ptr @_bal_list_generic_set_float, ptr @_bal_list_generic_inexact_set_float, i64 ptrtoint(ptr @.member0 to i64), ptr bitcast(ptr @.fillerDesc1 to ptr), [0 x i64] []}
@.subtype0 = internal constant %Type0 {ptr @_bal_array_subtype_contains, i32 131007}, align 8
@.member0 = internal constant {i32, i32, [1 x ptr]} {i32 0, i32 4096, [1 x ptr] [ptr bitcast(ptr @.subtype0 to ptr)]}
@.fillerDesc1 = global {ptr, ptr} {ptr @_bal_list_filler_create, ptr bitcast(ptr @_Bi04root2 to ptr)}
@_Bi04root4 = constant {i32, i32, i64, ptr, [0 x i64]} {i32 1, i32 0, i64 262015, ptr bitcast(ptr @_bal_nil_filler_desc to ptr), [0 x i64] []}
@_Bi04root5 = constant {i32, i32, i64, ptr, [0 x i64]} {i32 2, i32 0, i64 ptrtoint(ptr @.member0 to i64), ptr bitcast(ptr @.fillerDesc1 to ptr), [0 x i64] []}
