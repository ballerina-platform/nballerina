...
@.dec0 = internal unnamed_addr constant [8 x i8] c"9.0E+32\00", align 8
@.dec1 = internal unnamed_addr constant [5 x i8] c"0.01\00", align 8
...
7:
  %8 = call i8 addrspace(1)* @_bal_decimal_const(i8* bitcast([8 x i8]* @.dec0 to i8*))
  store i8 addrspace(1)* %8, i8 addrspace(1)** %d1
  %9 = call i8 addrspace(1)* @_bal_decimal_const(i8* bitcast([5 x i8]* @.dec1 to i8*))
