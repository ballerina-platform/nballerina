...
%FillerDesc = type {ptr}
@_Bi04root0 = constant {i32, i32, i64, ptr, [3 x i64]} {i32 0, i32 3, i64 1, ptr null, [3 x i64] [i64 9, i64 9, i64 9]}
...
@_Be04root1 = constant i32 -1
@.subtype0 = internal constant {ptr, i32, [3 x {ptr addrspace(1), i32}]} {ptr @_bal_record_subtype_contains, i32 3, [3 x {ptr addrspace(1), i32}] [{ptr addrspace(1), i32} {ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261432), i32 4}, {ptr addrspace(1), i32} {ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261433), i32 4}, {ptr addrspace(1), i32} {ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261434), i32 4}]}, align 8
