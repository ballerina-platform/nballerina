...
@.subtype0 = internal constant {i1(%UniformSubtype*, i8 addrspace(1)*)*, i32, [1 x i32]} {i1(%UniformSubtype*, i8 addrspace(1)*)* @_bal_precomputed_subtype_contains, i32 1, [1 x i32] [i32 0]}, align 8
@_Bt04root1 = constant {i32, i32, [1 x %UniformSubtype*]} {i32 0, i32 262144, [1 x %UniformSubtype*] [%UniformSubtype* bitcast({i1(%UniformSubtype*, i8 addrspace(1)*)*, i32, [1 x i32]}* @.subtype0 to %UniformSubtype*)]}
