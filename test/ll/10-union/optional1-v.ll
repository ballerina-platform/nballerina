...
9:
  ...
  %15 = getelementptr inbounds [0 x i64], [0 x i64] addrspace(1)* %13, i64 0, i64 1
  store i64 2, i64 addrspace(1)* %15
  %16 = getelementptr inbounds [0 x i64], [0 x i64] addrspace(1)* %13, i64 0, i64 2
  ...
  %18 = bitcast {{i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*}*, i64, i64, i8* addrspace(1)*} addrspace(1)* %10 to i8 addrspace(1)*
...
33:
  ...
  store i8 addrspace(1)* %34, i8 addrspace(1)** %y
  %35 = load i8 addrspace(1)*, i8 addrspace(1)** %y
...
41:
  %42 = call i8 addrspace(1)* @_bal_panic_construct(i64 1283), !dbg !7
  store i8 addrspace(1)* %42, i8 addrspace(1)** %5
  br label %29
43:
  %44 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %35, i64 4)
  %45 = icmp ne i8 addrspace(1)* %44, null
...
48:
  ...
  %52 = getelementptr inbounds [0 x i64], [0 x i64] addrspace(1)* %51, i64 0, i64 1
...
54:
  ...
  %56 = load {i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*}*, {i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*}* addrspace(1)* %55, align 8
  %57 = getelementptr {i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*}, {i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*}* %56, i64 0, i32 3
  %58 = load i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64)** %57, align 8
  %59 = call i64 %58(i8 addrspace(1)* %35, i64 1)
  store i64 %59, i64* %3
  br label %60
60:
  %61 = load i64, i64* %3, !dbg !8
