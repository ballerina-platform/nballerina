...
5:
  ...
  call void @_bal_mapping_init_member(ptr addrspace(1) %6, ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261433), ptr addrspace(1) %9), !dbg !10
  store ptr addrspace(1) %6, ptr %1
  %10 = load ptr addrspace(1), ptr %1
  %11 = call ptr addrspace(1) @_bal_tagged_clear_exact_ptr(ptr addrspace(1) %10), !dbg !11
  store ptr addrspace(1) %11, ptr %r
  %12 = load ptr addrspace(1), ptr %r
  %13 = call ptr addrspace(1) @_bal_tagged_clear_exact_ptr(ptr addrspace(1) %12), !dbg !12
  store ptr addrspace(1) %13, ptr %_
  ret void
14:
  %15 = call ptr addrspace(1) @_bal_panic_construct(i64 260), !dbg !7
...
!1 = !DIFile(filename:"../../../compiler/testSuite/10-union/construct5-v.bal", directory:"")
...
!9 = !DILocation(line: 4, column: 6, scope: !5)
!10 = !DILocation(line: 4, column: 6, scope: !5)
!11 = !DILocation(line: 3, column: 80, scope: !5)
