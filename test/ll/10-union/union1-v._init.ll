...
%FillerDesc = type {ptr}
@_Bi04root0 = constant {i32, i32, i64, ptr, [1 x i64]} {i32 0, i32 1, i64 1, ptr null, [1 x i64] [i64 5]}
...
@.subtype0 = internal constant {ptr, i32, [1 x {ptr addrspace(1), i32}]} {ptr @_bal_record_subtype_contains, i32 1, [1 x {ptr addrspace(1), i32}] [{ptr addrspace(1), i32} {ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261409), i32 2}]}, align 8
