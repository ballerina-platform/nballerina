...
32:
  ...
  %37 = call i64 %36(i8 addrspace(1)* %19, i64 2, i64 20)
  %38 = icmp eq i64 %37, 0
  br i1 %38, label %51, label %52
39:
  %40 = call i8 addrspace(1)* @_bal_mapping_construct({i32}* @_Bi04root1, i64 0)
  store i8 addrspace(1)* %40, i8 addrspace(1)** %2
  %41 = load i8 addrspace(1)*, i8 addrspace(1)** %2
  store i8 addrspace(1)* %41, i8 addrspace(1)** %m
  %42 = load i8 addrspace(1)*, i8 addrspace(1)** %m
  %43 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 1)
  %44 = call i64 @_bal_mapping_set(i8 addrspace(1)* %42, i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098476543620771439), i8 addrspace(1)* %43)
  %45 = icmp eq i64 %44, 0
...
46:
  ...
  %50 = getelementptr inbounds [0 x i64], [0 x i64] addrspace(1)* %49, i64 0, i64 2
  store i64 20, i64 addrspace(1)* %50
  br label %39
51:
  br label %39
52:
