...
15:
  ...
  ret i64 %17
18:
  %19 = call i8 addrspace(1)* @_bal_panic_construct(i64 3585)
...
26:
  ...
  unreachable
28:
  %29 = call i8 addrspace(1)* @_bal_panic_construct(i64 4356)
...
30:
  ...
  ret void
34:
  %35 = call i8 addrspace(1)* @_bal_panic_construct(i64 5633)
