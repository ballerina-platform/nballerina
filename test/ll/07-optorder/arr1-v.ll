...
47:
  ...
  %51 = bitcast i8* addrspace(1)* %50 to [0 x i64] addrspace(1)*
  %52 = getelementptr inbounds [0 x i64], [0 x i64] addrspace(1)* %51, i64 0, i64 0
  store i64 1, i64 addrspace(1)* %52
  %53 = getelementptr inbounds [0 x i64], [0 x i64] addrspace(1)* %51, i64 0, i64 1
  store i64 2, i64 addrspace(1)* %53
  %54 = getelementptr inbounds [0 x i64], [0 x i64] addrspace(1)* %51, i64 0, i64 2
  ...
  %66 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 3)
