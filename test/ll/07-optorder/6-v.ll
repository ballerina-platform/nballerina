...
28:
  ...
  %33 = call i64 @_bal_opt_boolean_compare(ptr addrspace(1) %32, ptr addrspace(1) null), !dbg !9
  ...
  %49 = call i64 @_bal_opt_boolean_compare(ptr addrspace(1) %48, ptr addrspace(1) null), !dbg !12
  %50 = icmp eq i64 %49, 0
  store i1 %50, ptr %4
  ...
  %65 = call i64 @_bal_opt_boolean_compare(ptr addrspace(1) %64, ptr addrspace(1) null), !dbg !15
  ...
  %81 = call i64 @_bal_opt_boolean_compare(ptr addrspace(1) %80, ptr addrspace(1) null), !dbg !18
  %82 = icmp eq i64 %81, 2
  store i1 %82, ptr %10
  ...
  %97 = call i64 @_bal_opt_boolean_compare(ptr addrspace(1) null, ptr addrspace(1) %96), !dbg !21
  ...
  %113 = call i64 @_bal_opt_boolean_compare(ptr addrspace(1) null, ptr addrspace(1) %112), !dbg !24
  ...
  %129 = call i64 @_bal_opt_boolean_compare(ptr addrspace(1) null, ptr addrspace(1) %128), !dbg !27
  ...
  %145 = call i64 @_bal_opt_boolean_compare(ptr addrspace(1) null, ptr addrspace(1) %144), !dbg !30
