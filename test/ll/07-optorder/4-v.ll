...
20:
  ...
  %23 = call i64 @_bal_float_compare(i8 addrspace(1)* %22, i8 addrspace(1)* null)
  ...
  %30 = call i64 @_bal_float_compare(i8 addrspace(1)* %29, i8 addrspace(1)* null)
  %31 = icmp eq i64 %30, 0
  store i1 %31, i1* %3
  %32 = load i1, i1* %3
  ...
  %37 = call i64 @_bal_float_compare(i8 addrspace(1)* %36, i8 addrspace(1)* null)
  ...
  %44 = call i64 @_bal_float_compare(i8 addrspace(1)* %43, i8 addrspace(1)* null)
  %45 = icmp eq i64 %44, 2
  store i1 %45, i1* %7
  %46 = load i1, i1* %7
  ...
  %51 = call i64 @_bal_float_compare(i8 addrspace(1)* null, i8 addrspace(1)* %50)
  ...
  %58 = call i64 @_bal_float_compare(i8 addrspace(1)* null, i8 addrspace(1)* %57)
  %59 = icmp eq i64 %58, 0
  store i1 %59, i1* %11
  %60 = load i1, i1* %11
  ...
  %65 = call i64 @_bal_float_compare(i8 addrspace(1)* null, i8 addrspace(1)* %64)
  ...
  %72 = call i64 @_bal_float_compare(i8 addrspace(1)* null, i8 addrspace(1)* %71)
  %73 = icmp eq i64 %72, 2
  store i1 %73, i1* %15
  %74 = load i1, i1* %15
