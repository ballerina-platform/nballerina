...
20:
  %21 = call i8 addrspace(1)* @_bal_float_to_tagged(double 5.0)
...
28:
  ...
  br label %34
30:
  %31 = call double @_bal_tagged_to_float(i8 addrspace(1)* %22)
  %32 = call double @_bal_tagged_to_float(i8 addrspace(1)* null)
...
43:
  ...
  br label %49
45:
  %46 = call double @_bal_tagged_to_float(i8 addrspace(1)* %39)
  %47 = call double @_bal_tagged_to_float(i8 addrspace(1)* null)
...
58:
  ...
  br label %64
60:
  %61 = call double @_bal_tagged_to_float(i8 addrspace(1)* %54)
  %62 = call double @_bal_tagged_to_float(i8 addrspace(1)* null)
...
73:
  ...
  br label %79
75:
  %76 = call double @_bal_tagged_to_float(i8 addrspace(1)* %69)
  %77 = call double @_bal_tagged_to_float(i8 addrspace(1)* null)
...
88:
  ...
  br label %94
90:
  %91 = call double @_bal_tagged_to_float(i8 addrspace(1)* null)
  %92 = call double @_bal_tagged_to_float(i8 addrspace(1)* %84)
...
103:
  ...
  br label %109
105:
  %106 = call double @_bal_tagged_to_float(i8 addrspace(1)* null)
  %107 = call double @_bal_tagged_to_float(i8 addrspace(1)* %99)
...
118:
  ...
  br label %124
120:
  %121 = call double @_bal_tagged_to_float(i8 addrspace(1)* null)
  %122 = call double @_bal_tagged_to_float(i8 addrspace(1)* %114)
...
133:
  ...
  br label %139
135:
  %136 = call double @_bal_tagged_to_float(i8 addrspace(1)* null)
  %137 = call double @_bal_tagged_to_float(i8 addrspace(1)* %129)
