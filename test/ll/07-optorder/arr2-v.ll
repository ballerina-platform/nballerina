...
47:
  ...
  %51 = bitcast i8* addrspace(1)* %50 to [0 x double] addrspace(1)*
  %52 = getelementptr inbounds [0 x double], [0 x double] addrspace(1)* %51, i64 0, i64 0
  store double 0.1, double addrspace(1)* %52
  %53 = getelementptr inbounds [0 x double], [0 x double] addrspace(1)* %51, i64 0, i64 1
  store double 2.0, double addrspace(1)* %53
  %54 = getelementptr inbounds [0 x double], [0 x double] addrspace(1)* %51, i64 0, i64 2
  store double 3.5, double addrspace(1)* %54
  ...
  %63 = call i8 addrspace(1)* @_bal_float_to_tagged(double 0.1)
  %64 = getelementptr inbounds [0 x i8 addrspace(1)*], [0 x i8 addrspace(1)*] addrspace(1)* %62, i64 0, i64 0
  store i8 addrspace(1)* %63, i8 addrspace(1)* addrspace(1)* %64
  %65 = getelementptr inbounds [0 x i8 addrspace(1)*], [0 x i8 addrspace(1)*] addrspace(1)* %62, i64 0, i64 1
  store i8 addrspace(1)* null, i8 addrspace(1)* addrspace(1)* %65
  %66 = call i8 addrspace(1)* @_bal_float_to_tagged(double 3.5)
  %67 = getelementptr inbounds [0 x i8 addrspace(1)*], [0 x i8 addrspace(1)*] addrspace(1)* %62, i64 0, i64 2
  ...
  store i64 3, i64 addrspace(1)* %68
  %69 = bitcast {{i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*}*, i64, i64, i8* addrspace(1)*} addrspace(1)* %59 to i8 addrspace(1)*
  %70 = getelementptr i8, i8 addrspace(1)* %69, i64 1297036692682702852
  store i8 addrspace(1)* %70, i8 addrspace(1)** %2
  %71 = load i8 addrspace(1)*, i8 addrspace(1)** %2
  store i8 addrspace(1)* %71, i8 addrspace(1)** %b
  %72 = call {{i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*}*, i64, i64, i8* addrspace(1)*} addrspace(1)* @_bal_list_construct({i32}* @_Bi04root1, i64 3)
  ...
  %82 = bitcast {{i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*}*, i64, i64, i8* addrspace(1)*} addrspace(1)* %72 to i8 addrspace(1)*
  ...
  %87 = call i64 @_bal_array_generic_compare(i8 addrspace(1)* %85, i8 addrspace(1)* %86)
  %88 = icmp eq i64 %87, 0
  store i1 %88, i1* %4
  ...
  %95 = call i64 @_bal_array_generic_compare(i8 addrspace(1)* %93, i8 addrspace(1)* %94)
  ...
  %103 = call i64 @_bal_array_generic_compare(i8 addrspace(1)* %101, i8 addrspace(1)* %102)
  ...
  %111 = call i64 @_bal_array_generic_compare(i8 addrspace(1)* %109, i8 addrspace(1)* %110)
  ...
  %119 = call i64 @_bal_array_generic_compare(i8 addrspace(1)* %117, i8 addrspace(1)* %118)
  ...
  %127 = call i64 @_bal_array_generic_compare(i8 addrspace(1)* %125, i8 addrspace(1)* %126)
  ...
  %135 = call i64 @_bal_array_generic_compare(i8 addrspace(1)* %133, i8 addrspace(1)* %134)
  ...
  %143 = call i64 @_bal_array_generic_compare(i8 addrspace(1)* %141, i8 addrspace(1)* %142)
  ...
  %151 = call i64 @_bal_array_generic_compare(i8 addrspace(1)* %149, i8 addrspace(1)* %150)
  ...
  %159 = call i64 @_bal_array_generic_compare(i8 addrspace(1)* %157, i8 addrspace(1)* %158)
  ...
  %167 = call i64 @_bal_array_generic_compare(i8 addrspace(1)* %165, i8 addrspace(1)* %166)
  ...
  %175 = call i64 @_bal_array_generic_compare(i8 addrspace(1)* %173, i8 addrspace(1)* %174)
  ...
  %183 = call i64 @_bal_array_generic_compare(i8 addrspace(1)* %181, i8 addrspace(1)* %182)
  ...
  %191 = call i64 @_bal_array_generic_compare(i8 addrspace(1)* %189, i8 addrspace(1)* %190)
  ...
  %199 = call i64 @_bal_array_generic_compare(i8 addrspace(1)* %197, i8 addrspace(1)* %198)
  ...
  %239 = call i64 @_bal_array_generic_compare(i8 addrspace(1)* %237, i8 addrspace(1)* %238)
