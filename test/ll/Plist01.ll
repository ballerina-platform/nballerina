...
L4:
  ...
  store i64 17, i64 addrspace (1)* %_15, align 8
  %_16 = getelementptr i8, i8 addrspace (1)* %_14, i64 504403158265495552
  %_17 = getelementptr inbounds [3 x i8 addrspace (1)*], [3 x i8 addrspace (1)*] addrspace (1)* %_13, i64 0, i64 0
  ...
  store i64 42, i64 addrspace (1)* %_19, align 8
  %_20 = getelementptr i8, i8 addrspace (1)* %_18, i64 504403158265495552
  %_21 = getelementptr inbounds [3 x i8 addrspace (1)*], [3 x i8 addrspace (1)*] addrspace (1)* %_13, i64 0, i64 1
  store i8 addrspace (1)* %_20, i8 addrspace (1)* addrspace (1)* %_21
  %_22 = load i64, i64* %_0
  %_23 = call i8 addrspace (1)* @_bal_alloc (i64 8)
  %_24 = bitcast i8 addrspace (1)* %_23 to i64 addrspace (1)*
  store i64 %_22, i64 addrspace (1)* %_24, align 8
  %_25 = getelementptr i8, i8 addrspace (1)* %_23, i64 504403158265495552
  %_26 = getelementptr inbounds [3 x i8 addrspace (1)*], [3 x i8 addrspace (1)*] addrspace (1)* %_13, i64 0, i64 2
  store i8 addrspace (1)* %_25, i8 addrspace (1)* addrspace (1)* %_26
  %_27 = bitcast [3 x i8 addrspace (1)*] addrspace (1)* %_13 to [0 x i8 addrspace (1)*] addrspace (1)*
  %_28 = call i8 addrspace (1)* @_bal_alloc (i64 24)
  %_29 = bitcast i8 addrspace (1)* %_28 to {i64, i64, [0 x i8 addrspace (1)*] addrspace (1)*} addrspace (1)*
  %_30 = getelementptr inbounds {i64, i64, [0 x i8 addrspace (1)*] addrspace (1)*}, {i64, i64, [0 x i8 addrspace (1)*] addrspace (1)*} addrspace (1)* %_29, i64 0, i32 0
  store i64 3, i64 addrspace (1)* %_30
  %_31 = getelementptr inbounds {i64, i64, [0 x i8 addrspace (1)*] addrspace (1)*}, {i64, i64, [0 x i8 addrspace (1)*] addrspace (1)*} addrspace (1)* %_29, i64 0, i32 1
  store i64 3, i64 addrspace (1)* %_31
  %_32 = getelementptr inbounds {i64, i64, [0 x i8 addrspace (1)*] addrspace (1)*}, {i64, i64, [0 x i8 addrspace (1)*] addrspace (1)*} addrspace (1)* %_29, i64 0, i32 2
  store [0 x i8 addrspace (1)*] addrspace (1)* %_27, [0 x i8 addrspace (1)*] addrspace (1)* addrspace (1)* %_32
  %_33 = getelementptr i8, i8 addrspace (1)* %_28, i64 1297036692682702848
  store i8 addrspace (1)* %_33, i8 addrspace (1)** %_1
  %_34 = load i8 addrspace (1)*, i8 addrspace (1)** %_1
  store i8 addrspace (1)* %_34, i8 addrspace (1)** %v
...
L8:
  ...
  %_48 = getelementptr inbounds [0 x i8 addrspace (1)*], [0 x i8 addrspace (1)*] addrspace (1)* %_47, i64 0, i64 %_39
