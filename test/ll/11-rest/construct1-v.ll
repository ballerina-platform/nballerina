...
7:
  %8 = call i8 addrspace(1)* @_bal_mapping_construct({i32}* @_Bi04root0, i64 1)
  ...
  %12 = call i8 addrspace(1)* @_bal_mapping_get(i8 addrspace(1)* %11, i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098476543630901112))
  %13 = call i64 @_bal_tagged_to_int(i8 addrspace(1)* %12)
  store i64 %13, i64* %2
  %14 = load i64, i64* %2, !dbg !8
  %15 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 %14), !dbg !8
  call void @_Bb02ioprintln(i8 addrspace(1)* %15), !dbg !8
  store i8 addrspace(1)* null, i8 addrspace(1)** %3, !dbg !8
  ret void
16:
  %17 = call i8 addrspace(1)* @_bal_panic_construct(i64 2052), !dbg !7
