...
8:
  ...
  %14 = call i64 @_bal_mapping_set(i8 addrspace(1)* %13, i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098476543630901114), i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098475922679686504))
  %15 = icmp eq i64 %14, 0
...
16:
  ...
  unreachable
18:
  %19 = call i8 addrspace(1)* @_bal_panic_construct(i64 3588), !dbg !7
  call void @_bal_panic(i8 addrspace(1)* %19)
  unreachable
20:
  %21 = load i8 addrspace(1)*, i8 addrspace(1)** %r
  %22 = call i8 addrspace(1)* @_bal_mapping_get(i8 addrspace(1)* %21, i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098476543630901114))
...
24:
  %25 = or i64 %14, 4096
  %26 = call i8 addrspace(1)* @_bal_panic_construct(i64 %25), !dbg !7
