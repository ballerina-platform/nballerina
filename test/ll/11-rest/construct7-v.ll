...
8:
  ...
  %16 = call ptr addrspace(1) @_bal_float_to_tagged(double 17.0), !dbg !12
  call void @_bal_mapping_init_member(ptr addrspace(1) %9, ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738187965257249903), ptr addrspace(1) %16), !dbg !13
  store ptr addrspace(1) %9, ptr %1
  %17 = load ptr addrspace(1), ptr %1
  %18 = call ptr addrspace(1) @_bal_tagged_clear_exact_ptr(ptr addrspace(1) %17), !dbg !14
  store ptr addrspace(1) %18, ptr %r
  %19 = load ptr addrspace(1), ptr %r
  %20 = call ptr addrspace(1) @_bal_mapping_get(ptr addrspace(1) %19, ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738187965257249903)), !dbg !15
  %21 = call ptr addrspace(1) @_bal_tagged_clear_exact_any(ptr addrspace(1) %20), !dbg !16
  store ptr addrspace(1) %21, ptr %2
  %22 = call ptr addrspace(1) @_bal_list_construct_8(ptr @_Bi04root1, i64 1), !dbg !17
  ...
  ret void
32:
  %33 = call ptr addrspace(1) @_bal_panic_construct(i64 3844), !dbg !7
...
!9 = !DILocation(line: 16, column: 14, scope: !5)
!10 = !DILocation(line: 16, column: 14, scope: !5)
!11 = !DILocation(line: 16, column: 14, scope: !5)
!12 = !DILocation(line: 16, column: 14, scope: !5)
!13 = !DILocation(line: 16, column: 14, scope: !5)
!14 = !DILocation(line: 16, column: 12, scope: !5)
!15 = !DILocation(line: 17, column: 16, scope: !5)
!16 = !DILocation(line: 17, column: 16, scope: !5)
