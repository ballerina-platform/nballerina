...
@_Bi04root2 = constant {i32, i32, i64, [1 x i64]} {i32 0, i32 1, i64 ptrtoint({i32, i32, [1 x %UniformSubtype*]}* @.member1 to i64), [1 x i64] [i64 ptrtoint({i32, i32, [1 x %UniformSubtype*]}* @.member0 to i64)]}
