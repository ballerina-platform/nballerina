...
@_Bi04root2 = constant {i32, i32, i64, ptr, [1 x i64]} {i32 0, i32 1, i64 ptrtoint(ptr @.member1 to i64), ptr bitcast(ptr @.fillerDesc1 to ptr), [1 x i64] [i64 ptrtoint(ptr @.member0 to i64)]}
@.subtype0 = internal constant %Type0 {ptr @_bal_array_subtype_contains, i32 5}, align 8
...
@.fillerDesc1 = global {ptr, ptr} {ptr @_bal_list_filler_create, ptr bitcast(ptr @_Bi04root1 to ptr)}
