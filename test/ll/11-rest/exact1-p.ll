...
9:
  ...
  store ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261433), ptr %k
...
!1 = !DIFile(filename:"../../../compiler/testSuite/11-rest/exact1-p.bal", directory:"")
