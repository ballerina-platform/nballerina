...
7:
  ...
  call void @_bal_mapping_init_member(ptr addrspace(1) %8, ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261409), ptr addrspace(1) null), !dbg !10
  %9 = and i64 72057594037927935, 10
  %10 = or i64 2449958197289549824, %9
  %11 = getelementptr i8, ptr addrspace(1) null, i64 %10
  call void @_bal_mapping_init_member(ptr addrspace(1) %8, ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261432), ptr addrspace(1) %11), !dbg !11
  ...
  ret void
24:
  %25 = call ptr addrspace(1) @_bal_panic_construct(i64 1796), !dbg !7
...
!1 = !DIFile(filename:"../../../compiler/testSuite/14-infinite/infiniteRecord-v.bal", directory:"")
