...
@.subtype0 = internal constant %Type0 {ptr @_bal_record_subtype_contains, i32 2, [2 x {ptr addrspace(1), i32}] [{ptr addrspace(1), i32} {ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261432), i32 8}, {ptr addrspace(1), i32} {ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573441261433), i32 8}]}, align 8
...
@_Bi04root2 = constant {i32, i32, i64, ptr, [2 x i64]} {i32 0, i32 2, i64 1, ptr null, [2 x i64] [i64 17, i64 17]}
