...
@.mapping0 = constant {i32, i32, i64, ptr, [0 x i64]} {i32 0, i32 0, i64 ptrtoint(ptr @.member1 to i64), ptr bitcast(ptr @.fillerDesc1 to ptr), [0 x i64] []}
@.subtype1 = internal constant %Type1 {ptr @_bal_array_subtype_contains, i32 4}, align 8
...
@.fillerDesc1 = global {ptr, ptr} {ptr @_bal_list_filler_create, ptr bitcast(ptr @.list1 to ptr)}
@.fillerDesc2 = global {ptr, ptr} {ptr @_bal_mapping_filler_create, ptr bitcast(ptr @.mapping0 to ptr)}
