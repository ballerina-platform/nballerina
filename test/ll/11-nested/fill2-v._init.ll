...
@.subtype0 = internal constant %Type0 {i1(%UniformSubtype*, i8 addrspace(1)*)* @_bal_precomputed_subtype_contains, i32 1, [1 x i32] [i32 1]}, align 8
...
@.mapping0 = internal constant {i32, i32, i64, {i32}*, [0 x i64]} {i32 0, i32 0, i64 ptrtoint({i32, i32, [1 x %UniformSubtype*]}* @.member1 to i64), {i32}* bitcast({i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*}* @.list1 to {i32}*), [0 x i64] []}
@.subtype1 = internal constant %Type1 {i1(%UniformSubtype*, i8 addrspace(1)*)* @_bal_array_subtype_contains, i32 128}, align 8
