...
@_Bi04root1 = constant {i32, i32, i64, ptr, [4 x i64]} {i32 0, i32 4, i64 1, ptr null, [4 x i64] [i64 9, i64 ptrtoint(ptr @.member0 to i64), i64 ptrtoint(ptr @.member0 to i64), i64 ptrtoint(ptr @.member0 to i64)]}
@.subtype0 = internal constant %Type0 {ptr @_bal_precomputed_subtype_contains, i32 1, [1 x i32] [i32 0]}, align 8
@.member0 = internal constant {i32, i32, [1 x ptr]} {i32 2, i32 8192, [1 x ptr] [ptr bitcast(ptr @.subtype0 to ptr)]}
@.subtype1 = internal constant {ptr} {ptr @_bal_true_subtype_contains}, align 8
@_Bt04root2 = constant {i32, i32, [1 x ptr]} {i32 0, i32 2, [1 x ptr] [ptr bitcast(ptr @.subtype1 to ptr)]}
