...
@_Bi04root2 = constant {i32, i32, i64, ptr, [3 x i64]} {i32 0, i32 3, i64 1, ptr null, [3 x i64] [i64 ptrtoint(ptr @.member0 to i64), i64 ptrtoint(ptr @.member1 to i64), i64 ptrtoint(ptr @.member0 to i64)]}
