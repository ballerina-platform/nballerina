...
@_Bi04root1 = constant {i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*} {i32 1, i8 addrspace(1)*(i8 addrspace(1)*, i64)* @_bal_list_float_array_get_tagged, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)* @_bal_list_float_array_set_tagged, i64(i8 addrspace(1)*, i64)* null, i64(i8 addrspace(1)*, i64, i64)* @_bal_list_float_array_set_int, double(i8 addrspace(1)*, i64)* @_bal_list_float_array_get_float, i64(i8 addrspace(1)*, i64, double)* @_bal_list_float_array_set_float, i64 513, {i32}* null}
@_Bi04root2 = constant {i32, i32, i64, {i32}*, [3 x i64]} {i32 0, i32 3, i64 1, {i32}* null, [3 x i64] [i64 ptrtoint({i32, i32, [1 x %UniformSubtype*]}* @.member0 to i64), i64 ptrtoint({i32, i32, [1 x %UniformSubtype*]}* @.member1 to i64), i64 ptrtoint({i32, i32, [1 x %UniformSubtype*]}* @.member0 to i64)]}
...
@.subtype1 = internal constant %Type1 {i1(%UniformSubtype*, i8 addrspace(1)*)* @_bal_array_subtype_contains, i32 256}, align 8
...
@_Bt04root3 = alias {i32, i32, [1 x %UniformSubtype*]}, {i32, i32, [1 x %UniformSubtype*]}* @.member0
...
declare i8 addrspace(1)* @_bal_list_float_array_get_tagged(i8 addrspace(1)*, i64)
declare i64 @_bal_list_float_array_set_tagged(i8 addrspace(1)*, i64, i8 addrspace(1)*)
declare i64 @_bal_list_float_array_set_int(i8 addrspace(1)*, i64, i64)
declare double @_bal_list_float_array_get_float(i8 addrspace(1)*, i64)
declare i64 @_bal_list_float_array_set_float(i8 addrspace(1)*, i64, double)
