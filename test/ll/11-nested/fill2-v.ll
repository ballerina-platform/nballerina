...
13:
  ...
  %18 = call i8 addrspace(1)* @_bal_mapping_construct({i32}* @_Bi04root1, i64 0)
  ...
  %27 = call i64 %25(i8 addrspace(1)* %19, i64 1, i8 addrspace(1)* %26)
  %28 = icmp eq i64 %27, 0
  br i1 %28, label %42, label %49
29:
  %30 = load i8 addrspace(1)*, i8 addrspace(1)** %iv
  store i8 addrspace(1)* %30, i8 addrspace(1)** %iv.1
  %31 = load i8 addrspace(1)*, i8 addrspace(1)** %iv.1
...
52:
  ...
  %54 = load {i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*}*, {i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*}* addrspace(1)* %53, align 8
  %55 = getelementptr {i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*}, {i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*}* %54, i64 0, i32 1
  %56 = load i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i8 addrspace(1)*(i8 addrspace(1)*, i64)** %55, align 8
  %57 = call i8 addrspace(1)* %56(i8 addrspace(1)* %43, i64 0)
  %58 = call i8 addrspace(1)* @_bal_tagged_member_clear_exact_ptr(i8 addrspace(1)* %43, i8 addrspace(1)* %57)
  store i8 addrspace(1)* %58, i8 addrspace(1)** %3
  %59 = load i8 addrspace(1)*, i8 addrspace(1)** %3
  store i8 addrspace(1)* %59, i8 addrspace(1)** %v0
  %60 = call {{i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*}*, i64, i64, i8* addrspace(1)*} addrspace(1)* @_bal_list_construct({i32}* @_Bi04root2, i64 2)
  ...
  store i64 17, i64 addrspace(1)* %64
  %65 = getelementptr inbounds [0 x i64], [0 x i64] addrspace(1)* %63, i64 0, i64 1
  store i64 73, i64 addrspace(1)* %65
  ...
  store i64 2, i64 addrspace(1)* %66
  %67 = bitcast {{i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*}*, i64, i64, i8* addrspace(1)*} addrspace(1)* %60 to i8 addrspace(1)*
  %68 = getelementptr i8, i8 addrspace(1)* %67, i64 1297036692682702852
  store i8 addrspace(1)* %68, i8 addrspace(1)** %4
  %69 = load i8 addrspace(1)*, i8 addrspace(1)** %v0
  %70 = load i8 addrspace(1)*, i8 addrspace(1)** %4
  %71 = call i64 @_bal_mapping_set(i8 addrspace(1)* %69, i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098476543630901112), i8 addrspace(1)* %70)
  %72 = icmp eq i64 %71, 0
...
73:
  ...
  br label %38
75:
  %76 = load i8 addrspace(1)*, i8 addrspace(1)** %v0
  %77 = call i8 addrspace(1)* @_bal_mapping_get(i8 addrspace(1)* %76, i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098476543630901112))
  %78 = call i8 addrspace(1)* @_bal_tagged_member_clear_exact_ptr(i8 addrspace(1)* %76, i8 addrspace(1)* %77)
  store i8 addrspace(1)* %78, i8 addrspace(1)** %5
  %79 = load i8 addrspace(1)*, i8 addrspace(1)** %5
  store i8 addrspace(1)* %79, i8 addrspace(1)** %iv
  %80 = load i8 addrspace(1)*, i8 addrspace(1)** %iv
  %81 = icmp ne i8 addrspace(1)* %80, null
  store i1 %81, i1* %6
  %82 = load i1, i1* %6
  br i1 %82, label %29, label %37
83:
  %84 = or i64 %71, 1792
  ...
  br label %38
86:
  %87 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %31, i64 4)
  %88 = icmp ne i8 addrspace(1)* %87, null
  br i1 %88, label %91, label %97
89:
  %90 = call i8 addrspace(1)* @_bal_panic_construct(i64 2565), !dbg !7
...
91:
  ...
  %94 = bitcast i8* addrspace(1)* %93 to [0 x i64] addrspace(1)*
  %95 = getelementptr inbounds [0 x i64], [0 x i64] addrspace(1)* %94, i64 0, i64 1
...
97:
  ...
  %99 = load {i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*}*, {i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*}* addrspace(1)* %98, align 8
  %100 = getelementptr {i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*}, {i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*}* %99, i64 0, i32 3
  %101 = load i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64)** %100, align 8
  %102 = call i64 %101(i8 addrspace(1)* %31, i64 1)
  store i64 %102, i64* %7
  br label %103
103:
  %104 = load i64, i64* %7
  store i64 %104, i64* %n
  %105 = load i64, i64* %n, !dbg !8
  %106 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 %105), !dbg !8
