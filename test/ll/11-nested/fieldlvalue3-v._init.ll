...
@_Bi04root0 = constant {i32, i32, i64, {i32}*, [1 x i64]} {i32 0, i32 1, i64 1, {i32}* null, [1 x i64] [i64 257]}
@_Bi04root1 = constant {i32, i32, i64, {i32}*, [1 x i64]} {i32 1, i32 1, i64 1, {i32}* null, [1 x i64] [i64 ptrtoint({i32, i32, [1 x %UniformSubtype*]}* @.member0 to i64)]}
...
@_Bi04root2 = constant {i32, i32, i64, {i32}*, [1 x i64]} {i32 2, i32 1, i64 1, {i32}* null, [1 x i64] [i64 ptrtoint({i32, i32, [1 x %UniformSubtype*]}* @.member1 to i64)]}
@.subtype1 = internal constant %Type1 {i1(%UniformSubtype*, i8 addrspace(1)*)* @_bal_precomputed_subtype_contains, i32 1, [1 x i32] [i32 1]}, align 8
