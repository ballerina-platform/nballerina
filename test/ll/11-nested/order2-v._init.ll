...
@.subtype1 = internal constant %Type1 {ptr @_bal_array_subtype_contains, i32 1}, align 8
@.member1 = internal constant {i32, i32, [1 x ptr]} {i32 0, i32 4096, [1 x ptr] [ptr bitcast(ptr @.subtype1 to ptr)]}
@.fillerDesc1 = global {ptr, ptr} {ptr @_bal_list_filler_create, ptr bitcast(ptr @_Bi04root4 to ptr)}
