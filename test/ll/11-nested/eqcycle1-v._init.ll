...
@_Bi04root0 = constant {i32, i32, i64, {i32}*, [0 x i64]} {i32 0, i32 0, i64 ptrtoint({i32, i32, [2 x %UniformSubtype*]}* @.member0 to i64), {i32}* null, [0 x i64] []}
...
@_Bi04root1 = constant {i32, i32, i64, {i32}*, [0 x i64]} {i32 1, i32 0, i64 ptrtoint({i32, i32, [2 x %UniformSubtype*]}* @.member0 to i64), {i32}* null, [0 x i64] []}
