...
%FillerDesc = type {ptr}
@_Bi04root0 = constant {i32, i32, i64, ptr, [2 x i64]} {i32 0, i32 2, i64 1, ptr null, [2 x i64] [i64 65, i64 65]}
@_Bi04root1 = constant {i32, i32, i64, ptr, [2 x i64]} {i32 1, i32 2, i64 1, ptr null, [2 x i64] [i64 9, i64 ptrtoint(ptr @.member0 to i64)]}
@.subtype0 = internal constant %Type0 {ptr @_bal_record_subtype_contains, i32 2, [2 x {ptr addrspace(1), i32}] [{ptr addrspace(1), i32} {ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738187974082718054), i32 32}, {ptr addrspace(1), i32} {ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188571100012908), i32 32}]}, align 8
