...
8:
  ...
  %12 = call {{i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*}*, i64, i64, i8* addrspace(1)*} addrspace(1)* @_bal_list_construct({i32}* @_Bi04root1, i64 1)
  ...
  store i8 addrspace(1)* %21, i8 addrspace(1)** %r
  %22 = load i8 addrspace(1)*, i8 addrspace(1)** %r
  %23 = call i8 addrspace(1)* @_bal_tagged_clear_exact_ptr(i8 addrspace(1)* %22)
  store i8 addrspace(1)* %23, i8 addrspace(1)** %w
  %24 = load i8 addrspace(1)*, i8 addrspace(1)** %w
...
34:
  ...
  %39 = call i8 addrspace(1)* %38(i8 addrspace(1)* %24, i64 0)
  %40 = call i8 addrspace(1)* @_bal_tagged_member_clear_exact_ptr(i8 addrspace(1)* %24, i8 addrspace(1)* %39)
  store i8 addrspace(1)* %40, i8 addrspace(1)** %3
  %41 = load i8 addrspace(1)*, i8 addrspace(1)** %3
  store i8 addrspace(1)* %41, i8 addrspace(1)** %w0
  %42 = load i8 addrspace(1)*, i8 addrspace(1)** %w0
  ...
  %49 = call i64 %48(i8 addrspace(1)* %42, i64 0, i8 addrspace(1)* null)
  %50 = icmp eq i64 %49, 0
