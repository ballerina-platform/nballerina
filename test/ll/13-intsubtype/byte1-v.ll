...
6:
  ...
  %11 = load i64, ptr %x
  %12 = and i64 72057594037927935, %11
  %13 = or i64 2449958197289549824, %12
  %14 = getelementptr i8, ptr addrspace(1) null, i64 %13
  %15 = getelementptr inbounds [0 x ptr addrspace(1)], ptr addrspace(1) %10, i64 0, i64 0
  store ptr addrspace(1) %14, ptr addrspace(1) %15
  %16 = getelementptr inbounds {ptr, i64, i64, ptr addrspace(1)}, ptr addrspace(1) %7, i64 0, i32 1
  store i64 1, ptr addrspace(1) %16
  %17 = bitcast ptr addrspace(1) %7 to ptr addrspace(1)
  ...
  ret void
20:
  %21 = call ptr addrspace(1) @_bal_panic_construct(i64 1284), !dbg !7
...
!1 = !DIFile(filename:"../../../compiler/testSuite/13-intsubtype/byte1-v.bal", directory:"")
...
!9 = !DILocation(line: 7, column: 14, scope: !5)
