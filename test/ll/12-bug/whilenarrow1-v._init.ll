...
%Type1 = type {ptr, i32, [0 x i32]}
%Type2 = type {ptr, i32, [1 x i32]}
%FillerDesc = type {ptr}
@_Bi04root0 = constant {i32, i32, i64, ptr, [2 x i64]} {i32 0, i32 2, i64 ptrtoint(ptr @.member1 to i64), ptr bitcast(ptr @_bal_nil_filler_desc to ptr), [2 x i64] [i64 9, i64 ptrtoint(ptr @.member0 to i64)]}
@.subtype0 = internal constant %Type0 {ptr @_bal_precomputed_subtype_contains, i32 1, [1 x i32] [i32 0]}, align 8
@.member0 = internal constant {i32, i32, [1 x ptr]} {i32 1, i32 8192, [1 x ptr] [ptr bitcast(ptr @.subtype0 to ptr)]}
@.subtype1 = internal constant %Type1 {ptr @_bal_precomputed_subtype_contains, i32 0, [0 x i32] []}, align 8
@.subtype2 = internal constant %Type2 {ptr @_bal_precomputed_subtype_contains, i32 1, [1 x i32] [i32 0]}, align 8
@.member1 = internal constant {i32, i32, [2 x ptr]} {i32 32831, i32 12288, [2 x ptr] [ptr bitcast(ptr @.subtype1 to ptr), ptr bitcast(ptr @.subtype2 to ptr)]}
