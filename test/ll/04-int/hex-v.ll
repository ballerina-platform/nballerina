...
8:
  ...
  %12 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 11324106)
  ...
  %14 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 229354698)
  ...
  %16 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 2898971338)
  ...
  store i8 addrspace(1)* %21, i8 addrspace(1)** %answers
  %22 = load i8 addrspace(1)*, i8 addrspace(1)** %answers
...
32:
  ...
  %37 = load i8 addrspace(1)*, i8 addrspace(1)** %answers
  %38 = call i8 addrspace(1)* %36(i8 addrspace(1)* %37, i64 1)
  store i8 addrspace(1)* %38, i8 addrspace(1)** %2
  %39 = load i8 addrspace(1)*, i8 addrspace(1)** %2, !dbg !8
