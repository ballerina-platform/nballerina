...
20:
  ...
  %27 = call i8 addrspace(1)* @_bal_mapping_construct({i32, i32}* @_Bi04root0, i64 1)
  ...
  %31 = call i8 addrspace(1)* @_bal_mapping_construct({i32, i32}* @_Bi04root0, i64 1)
  ...
  %33 = call {{i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i32}*, i64, i64, [0 x i8 addrspace(1)*] addrspace(1)*} addrspace(1)* @_bal_list_construct({i32, i32}* @_Bi04root1, i64 1)
  %34 = getelementptr inbounds {{i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i32}*, i64, i64, [0 x i8 addrspace(1)*] addrspace(1)*}, {{i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i32}*, i64, i64, [0 x i8 addrspace(1)*] addrspace(1)*} addrspace(1)* %33, i64 0, i32 3
  ...
  %38 = getelementptr inbounds {{i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i32}*, i64, i64, [0 x i8 addrspace(1)*] addrspace(1)*}, {{i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i32}*, i64, i64, [0 x i8 addrspace(1)*] addrspace(1)*} addrspace(1)* %33, i64 0, i32 1
  store i64 1, i64 addrspace(1)* %38
  %39 = bitcast {{i32, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i32}*, i64, i64, [0 x i8 addrspace(1)*] addrspace(1)*} addrspace(1)* %33 to i8 addrspace(1)*
  %40 = getelementptr i8, i8 addrspace(1)* %39, i64 1297036692682702852
  store i8 addrspace(1)* %40, i8 addrspace(1)** %6
  %41 = load i8 addrspace(1)*, i8 addrspace(1)** %5, !dbg !12
  %42 = load i8 addrspace(1)*, i8 addrspace(1)** %6, !dbg !12
  call void @_B_printEq(i8 addrspace(1)* %41, i8 addrspace(1)* %42), !dbg !12
  store i8 addrspace(1)* null, i8 addrspace(1)** %7, !dbg !12
  %43 = call i8 addrspace(1)* @_bal_mapping_construct({i32, i32}* @_Bi04root0, i64 1)
  %44 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 1)
  call void @_bal_mapping_init_member(i8 addrspace(1)* %43, i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098476543630901110), i8 addrspace(1)* %44)
  store i8 addrspace(1)* %43, i8 addrspace(1)** %8
  %45 = call i8 addrspace(1)* @_bal_mapping_construct({i32, i32}* @_Bi04root0, i64 1)
  %46 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 1)
  call void @_bal_mapping_init_member(i8 addrspace(1)* %45, i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098476543630901110), i8 addrspace(1)* %46)
  store i8 addrspace(1)* %45, i8 addrspace(1)** %9
  %47 = load i8 addrspace(1)*, i8 addrspace(1)** %8, !dbg !13
  %48 = load i8 addrspace(1)*, i8 addrspace(1)** %9, !dbg !13
  call void @_B_printEq(i8 addrspace(1)* %47, i8 addrspace(1)* %48), !dbg !13
  store i8 addrspace(1)* null, i8 addrspace(1)** %10, !dbg !13
  %49 = call i8 addrspace(1)* @_bal_mapping_construct({i32, i32}* @_Bi04root0, i64 0)
  store i8 addrspace(1)* %49, i8 addrspace(1)** %11
  %50 = call i8 addrspace(1)* @_bal_mapping_construct({i32, i32}* @_Bi04root0, i64 0)
  store i8 addrspace(1)* %50, i8 addrspace(1)** %12
  %51 = load i8 addrspace(1)*, i8 addrspace(1)** %11, !dbg !14
  %52 = load i8 addrspace(1)*, i8 addrspace(1)** %12, !dbg !14
  call void @_B_printEq(i8 addrspace(1)* %51, i8 addrspace(1)* %52), !dbg !14
  store i8 addrspace(1)* null, i8 addrspace(1)** %13, !dbg !14
  %53 = call i8 addrspace(1)* @_bal_mapping_construct({i32, i32}* @_Bi04root0, i64 1)
  ...
  %55 = call i8 addrspace(1)* @_bal_mapping_construct({i32, i32}* @_Bi04root0, i64 1)
  %56 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 2)
  call void @_bal_mapping_init_member(i8 addrspace(1)* %55, i8 addrspace(1)* getelementptr(i8, i8 addrspace(1)* null, i64 3098476543630901110), i8 addrspace(1)* %56)
  store i8 addrspace(1)* %55, i8 addrspace(1)** %15
  %57 = load i8 addrspace(1)*, i8 addrspace(1)** %14, !dbg !15
  %58 = load i8 addrspace(1)*, i8 addrspace(1)** %15, !dbg !15
  call void @_B_printEq(i8 addrspace(1)* %57, i8 addrspace(1)* %58), !dbg !15
  store i8 addrspace(1)* null, i8 addrspace(1)** %16, !dbg !15
  ret void
59:
  %60 = call i8 addrspace(1)* @_bal_panic_construct(i64 772), !dbg !9
