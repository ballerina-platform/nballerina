...
@.subtype0 = internal constant {ptr, i32, [0 x i32]} {ptr @_bal_precomputed_subtype_contains, i32 0, [0 x i32] []}, align 8
@_Bt04root1 = constant {i32, i32, [1 x ptr]} {i32 0, i32 4096, [1 x ptr] [ptr bitcast(ptr @.subtype0 to ptr)]}
...
@.subtype2 = internal constant {ptr, i32, [0 x i32]} {ptr @_bal_precomputed_subtype_contains, i32 0, [0 x i32] []}, align 8
