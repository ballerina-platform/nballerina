...
7:
  %8 = call i64 @_Bb0m4lang6stringlength(ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188571303780336)), !dbg !9
  store i64 %8, ptr %1
  ...
  %13 = load i64, ptr %1
  %14 = call ptr addrspace(1) @_bal_int_to_tagged(i64 %13), !dbg !11
...
!9 = !DILocation(line: 5, column: 27, scope: !5)
