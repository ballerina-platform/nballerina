...
8:
  ...
  store ptr addrspace(1) getelementptr(i8, ptr addrspace(1) null, i64 2738188573431134562), ptr %s
...
!1 = !DIFile(filename:"../../../compiler/testSuite/04-string/08-v.bal", directory:"")
