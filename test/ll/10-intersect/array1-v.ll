...
8:
  ...
  store i64 42, i64 addrspace(1)* %13
  ...
  %18 = load i8 addrspace(1)*, i8 addrspace(1)** %v1
  store i8 addrspace(1)* %18, i8 addrspace(1)** %v2
  %19 = load i8 addrspace(1)*, i8 addrspace(1)** %v2
  store i8 addrspace(1)* %19, i8 addrspace(1)** %v1
  %20 = load i8 addrspace(1)*, i8 addrspace(1)** %v2
