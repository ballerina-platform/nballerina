...
26:
  ...
  unreachable
28:
  %29 = call i8 addrspace(1)* @llvm.ptrmask.p1i8.i64(i8 addrspace(1)* %18, i64 4)
  %30 = icmp ne i8 addrspace(1)* %29, null
  br i1 %30, label %33, label %39
31:
  %32 = call i8 addrspace(1)* @_bal_panic_construct(i64 1541), !dbg !7
...
33:
  ...
  %36 = bitcast i8* addrspace(1)* %35 to [0 x i64] addrspace(1)*
  %37 = getelementptr inbounds [0 x i64], [0 x i64] addrspace(1)* %36, i64 0, i64 0
...
!8 = !DILocation(line: 5, column: 7, scope: !5)
