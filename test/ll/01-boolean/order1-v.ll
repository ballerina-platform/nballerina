...
18:
  %19 = call i1 @_B_greaterThan(i1 1, i1 0), !dbg !15
  store i1 %19, ptr %1
  %20 = load i1, ptr %1
  call void @_B_printBoolean(i1 %20), !dbg !16
  store ptr addrspace(1) null, ptr %2
  %21 = call i1 @_B_greaterThan(i1 1, i1 1), !dbg !17
  store i1 %21, ptr %3
  %22 = load i1, ptr %3
  call void @_B_printBoolean(i1 %22), !dbg !18
  store ptr addrspace(1) null, ptr %4
  %23 = call i1 @_B_greaterThan(i1 0, i1 0), !dbg !19
  store i1 %23, ptr %5
  %24 = load i1, ptr %5
  call void @_B_printBoolean(i1 %24), !dbg !20
  store ptr addrspace(1) null, ptr %6
  %25 = call i1 @_B_lessThan(i1 1, i1 0), !dbg !21
  store i1 %25, ptr %7
  %26 = load i1, ptr %7
  call void @_B_printBoolean(i1 %26), !dbg !22
  store ptr addrspace(1) null, ptr %8
  %27 = call i1 @_B_lessThan(i1 0, i1 1), !dbg !23
  store i1 %27, ptr %9
  %28 = load i1, ptr %9
  call void @_B_printBoolean(i1 %28), !dbg !24
  store ptr addrspace(1) null, ptr %10
  %29 = call i1 @_B_lessThan(i1 1, i1 1), !dbg !25
  store i1 %29, ptr %11
  %30 = load i1, ptr %11
  call void @_B_printBoolean(i1 %30), !dbg !26
  store ptr addrspace(1) null, ptr %12
  %31 = call i1 @_B_lessThan(i1 0, i1 0), !dbg !27
  store i1 %31, ptr %13
  %32 = load i1, ptr %13
