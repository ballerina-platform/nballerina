...
38:
  ...
  unreachable
40:
  %41 = call i8 addrspace(1)* @_bal_panic_construct(i64 516)
...
54:
  %55 = call i8 addrspace(1)* @_bal_panic_construct(i64 1029)
...
70:
  ...
  ret void
88:
  %89 = call i8 addrspace(1)* @_bal_panic_construct(i64 1541)
