...
@.dec0 = internal unnamed_addr constant [3 x i8] c"12\00", align 8
...
5:
  %6 = call i8 addrspace(1)* @_bal_decimal_const(i8* bitcast([3 x i8]* @.dec0 to i8*))
  store i8 addrspace(1)* %6, i8 addrspace(1)** %d
  %7 = load i8 addrspace(1)*, i8 addrspace(1)** %d, !dbg !8
