...
10:
  ...
  %15 = load double, ptr %f
  %16 = call ptr addrspace(1) @_bal_float_to_tagged(double %15), !dbg !10
  ...
  %26 = load double, ptr %f2
  %27 = call ptr addrspace(1) @_bal_float_to_tagged(double %26), !dbg !13
  ...
  ret void
44:
  %45 = call ptr addrspace(1) @_bal_panic_construct(i64 772), !dbg !7
