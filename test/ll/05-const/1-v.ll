...
5:
  %6 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 123), !dbg !8
  call void @_Bb02ioprintln(i8 addrspace(1)* %6), !dbg !8
  store i8 addrspace(1)* null, i8 addrspace(1)** %1, !dbg !8
  ret void
7:
  %8 = call i8 addrspace(1)* @_bal_panic_construct(i64 1540), !dbg !7
...
!1 = !DIFile(filename:"../../../compiler/testSuite/05-const/1-v.bal", directory:"")
