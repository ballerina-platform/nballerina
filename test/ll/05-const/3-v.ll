...
@.str0 = internal unnamed_addr constant {i16, i16, [12 x i8]} {i16 12, i16 12, [12 x i8] c"Hello, there"}, align 8
...
6:
  ...
  store ptr addrspace(1) getelementptr(i8, ptr addrspace(1) addrspacecast(ptr bitcast(ptr @.str0 to ptr) to ptr addrspace(1)), i64 360287970189639680), ptr addrspace(1) %11
  ...
  ret void
16:
  %17 = call ptr addrspace(1) @_bal_panic_construct(i64 2308), !dbg !7
...
!1 = !DIFile(filename:"../../../compiler/testSuite/05-const/3-v.bal", directory:"")
