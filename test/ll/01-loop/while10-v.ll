...
31:
  ...
  call void @_bal_panic(ptr addrspace(1) %32), !dbg !12
  unreachable
33:
...
35:
  ...
  br label %10
38:
  %39 = call ptr addrspace(1) @_bal_panic_construct(i64 3585), !dbg !7
...
!9 = !DILocation(line: 13, column: 19, scope: !5)
!10 = !DILocation(line: 13, column: 19, scope: !5)
!11 = !DILocation(line: 13, column: 8, scope: !5)
