...
6:
  ...
  call void @_bal_mapping_set(i8 addrspace(1)* %7, i8 addrspace(1)* %10, i8 addrspace(1)* %11)
  ...
  call void @_bal_mapping_set(i8 addrspace(1)* %7, i8 addrspace(1)* %14, i8 addrspace(1)* %15)
