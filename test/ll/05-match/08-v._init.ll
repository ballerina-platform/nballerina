...
@.subtype0 = internal constant {ptr, i64, [1 x {i64, i64}]} {ptr @_bal_int_subtype_contains, i64 1, [1 x {i64, i64}] [{i64, i64} {i64 1, i64 1}]}, align 8
@_Bt04root0 = constant {i32, i32, [1 x ptr]} {i32 0, i32 4, [1 x ptr] [ptr bitcast(ptr @.subtype0 to ptr)]}
@.subtype1 = internal constant {ptr, i64, [1 x {i64, i64}]} {ptr @_bal_int_subtype_contains, i64 1, [1 x {i64, i64}] [{i64, i64} {i64 -1, i64 -1}]}, align 8
