...
21:
  ...
  %49 = call i8 addrspace(1)* @_B_foo(i8 addrspace(1)* %48), !dbg !22
  store i8 addrspace(1)* %49, i8 addrspace(1)** %14, !dbg !22
  %50 = load i8 addrspace(1)*, i8 addrspace(1)** %14, !dbg !23
  call void @_Bb02ioprintln(i8 addrspace(1)* %50), !dbg !23
  store i8 addrspace(1)* null, i8 addrspace(1)** %15, !dbg !23
  %51 = zext i1 0 to i64, !dbg !24
  %52 = or i64 %51, 72057594037927936, !dbg !24
  %53 = getelementptr i8, i8 addrspace(1)* null, i64 %52, !dbg !24
  %54 = call i8 addrspace(1)* @_B_foo(i8 addrspace(1)* %53), !dbg !24
  store i8 addrspace(1)* %54, i8 addrspace(1)** %16, !dbg !24
  %55 = load i8 addrspace(1)*, i8 addrspace(1)** %16, !dbg !25
  call void @_Bb02ioprintln(i8 addrspace(1)* %55), !dbg !25
  store i8 addrspace(1)* null, i8 addrspace(1)** %17, !dbg !25
  ret void
56:
  %57 = call i8 addrspace(1)* @_bal_panic_construct(i64 1028), !dbg !9
