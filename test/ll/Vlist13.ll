...
6:
  ...
  store [0 x i8 addrspace(1)*] addrspace(1)* %15, [0 x i8 addrspace(1)*] addrspace(1)* addrspace(1)* %20
  ...
  call void @_B_foo(i8 addrspace(1)* %22)
...
6:
  ...
  ret void
8:
  %9 = call i8 addrspace(1)* @_bal_panic_construct(i64 1540)
