...
5:
  %6 = call i8 addrspace(1)* @_bal_decimal_const(i8* bitcast([2 x i8]* @.dec0 to i8*)), !dbg !8
  call void @_Bb02ioprintln(i8 addrspace(1)* %6), !dbg !8
  store i8 addrspace(1)* null, i8 addrspace(1)** %1, !dbg !8
  ret void
7:
  %8 = call i8 addrspace(1)* @_bal_panic_construct(i64 516), !dbg !7
...
!1 = !DIFile(filename:"../../../compiler/testSuite/13-const/decimal1-v.bal", directory:"")
