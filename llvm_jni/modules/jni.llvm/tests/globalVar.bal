...
function globalVar() returns Module {
    ...
    PointerValue _ = m.addGlobal(const1Ty, "g3", isConstant=true, align=8, unnamedAddr=true, addressSpace=3, initializer=const1, linkage="internal");
    PointerValue _ = m.addGlobal("i64", "g4", isConstant=true, align=8, unnamedAddr=true, addressSpace=3, linkage="internal");
    PointerValue _ = m.addGlobal("i64", "g5", isConstant=true, addressSpace=3);
    PointerValue _ = m.addGlobal("i64", "g6", addressSpace=3, align=8);
