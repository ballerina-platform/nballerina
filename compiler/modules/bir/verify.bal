...
function verifyListGet(VerifyContext vc, ListGetInsn insn) returns Error? {
    ...
    t:SemType memberType = t:listMemberTypeDeref(vc.typeContext(), insn.operands[0].semType, indexOperand.semType);
...
function verifyListSet(VerifyContext vc, ListSetInsn insn) returns Error? {
    ...
    t:SemType memberType = t:listMemberTypeDeref(vc.typeContext(), insn.operands[0].semType, insn.operands[1].semType);
