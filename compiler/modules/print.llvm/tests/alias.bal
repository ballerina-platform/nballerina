...
function alias() returns Module {
    ...
    ConstPointerValue b = m.addAlias("i64", g, "b", linkage="internal", addressSpace=1);
    ConstPointerValue c = m.addAlias("i64", g, "c", linkage="internal", unnamedAddr=true, addressSpace=1);
    ConstPointerValue d = m.addAlias("i64", g, "d", unnamedAddr=true, addressSpace=1);
