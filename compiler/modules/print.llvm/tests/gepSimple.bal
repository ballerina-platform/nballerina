...
function gepSimple() returns Module {
    ...
    Value third = builder.getElementPtr(<PointerValue>arg, [constInt("i64", 3)]);
    builder.ret(third);
    ...
    third = builder.getElementPtr(<PointerValue>arg_1, [constInt("i64", 3)]);
    builder.ret(third);
    ...
    third = builder.getElementPtr(<PointerValue>arg_2, [constInt("i64", 3)]);
    builder.ret(third);
    return m;
}
