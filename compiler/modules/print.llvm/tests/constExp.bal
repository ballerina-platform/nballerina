...
function constExp() returns Module {
    ...
    ConstValue init = context.constGetElementPtr(g1.toConstValue(), [constInt("i32", 0), constInt("i32", 0)], "inbounds");
    PointerValue g2 = m.addGlobal(pointerType("i64", 0), "g2", initializer=init);
    ConstValue init2 = context.constBitCast(g2.toConstValue(), pointerType("i32", 0));
    ...
    ConstValue init3 = context.costAddrSpaceCast(g4.toConstValue(), pointerType("i32", 1));
