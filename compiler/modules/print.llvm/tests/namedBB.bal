...
function namedBB() returns Module {
    ...
    Value a = builder.iArithmeticWrap("add", p1, p2);
    ...
    Value b_1 = builder.iArithmeticWrap("sub", a, context.constInt("i64", 5));
    builder.store(b_1, v);
    BasicBlock common = mainFunction.appendBasicBlock();
    builder.br(common);
    builder.positionAtEnd(less);
    Value b_2 = builder.iArithmeticWrap("add", a, context.constInt("i64", 5));
    builder.store(b_2, v);
    builder.br(common);
