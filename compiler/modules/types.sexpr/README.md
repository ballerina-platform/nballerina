...
| Ballerina Syntax                      | Sexpr                                                                                                                                                                                         |
|---------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `table<record {\| int k; int v; \|}>` | `(table MT.9)` where `(MT.9 (mapping (("k" int) ("v" int))))`                                                                                                                                 |
| `table<record {\| int a; \|}> & !table<record {\| int b; \|}>` | `(& table (table MT.9) (! (table MT.12)))` where `(MT.9 (mapping (("a" int))))(MT.12 (mapping (("b" int))))`                                                         |
| `table<record {\| int a; \|} \| record {\| int b; \|}> \| table<record {\| int c; \|}>` | `(\| (table (\| MT.9 MT.10)) (table MT.13))` where `(MT.9 (mapping (("a" int))))(MT.10 (mapping (("b" int))))(MT.13 (mapping (("c" int))))` |
| `table<map<any\|error>> & !table<record {\| int a; \|}>` | `(& table (! (table MT.9)))` where `(MT.9 (mapping (("a" int))))`                                                                                                          |
