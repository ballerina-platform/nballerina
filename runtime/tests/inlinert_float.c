...
void testFloatNilCmp() {
    ...
    assert(_bal_opt_float_compare(a, nil) == COMPARE_UN);
    assert(_bal_opt_float_compare(b, nil) == COMPARE_UN);
    assert(_bal_opt_float_compare(c, nil) == COMPARE_UN);
    assert(_bal_opt_float_compare(nil, a) == COMPARE_UN);
    assert(_bal_opt_float_compare(nil, b) == COMPARE_UN);
    assert(_bal_opt_float_compare(nil, c) == COMPARE_UN);
    assert(_bal_opt_float_compare(nil, nil) == COMPARE_EQ);
}
...
void testFloatFloatCmp() {
    ...
    assert(_bal_opt_float_compare(a, a) == COMPARE_EQ);
    assert(_bal_opt_float_compare(a, b) == COMPARE_GT);
    assert(_bal_opt_float_compare(a, c) == COMPARE_LT);
    assert(_bal_opt_float_compare(a, d) == COMPARE_GT);

    assert(_bal_opt_float_compare(b, a) == COMPARE_LT);
    assert(_bal_opt_float_compare(b, b) == COMPARE_EQ);
    assert(_bal_opt_float_compare(b, c) == COMPARE_LT);
    assert(_bal_opt_float_compare(b, d) == COMPARE_GT);

    assert(_bal_opt_float_compare(c, a) == COMPARE_GT);
    assert(_bal_opt_float_compare(c, b) == COMPARE_GT);
    assert(_bal_opt_float_compare(c, c) == COMPARE_EQ);
    assert(_bal_opt_float_compare(c, d) == COMPARE_GT);

    assert(_bal_opt_float_compare(d, a) == COMPARE_LT);
    assert(_bal_opt_float_compare(d, b) == COMPARE_LT);
    assert(_bal_opt_float_compare(d, c) == COMPARE_LT);
    assert(_bal_opt_float_compare(d, d) == COMPARE_EQ);
}
